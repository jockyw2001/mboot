...
///
/// @file   apiDMX.h
/// @brief  MStar Demux Driver Interface
/// @author MStar Semiconductor Inc.
/// @version 1.0
///////////////////////////////////////////////////////////////////////////////

//-------------------------------------------------
/*! \defgroup DMX DMX modules
...
//-------------------------------------------------------------------------------------------------
/// Enable/Disable to remove TEI audio or video error packets.
/// @ingroup TSP_General
...
/// @ingroup TSP_FIQ
/// @param u32FQEng        \b IN: FQ engine id
/// @param pstFqCfg        \b IN: Pointer of storing configure data
/// @return DMX_FILTER_STATUS_OK - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
/// @note 
...
//-------------------------------------------------------------------------------------------------
/// Set MMFI time stamp clock.
/// @ingroup TSP_MM
/// @param ePath           \b IN: MM File-in Path
/// @param  eClk           \b IN: 90K or 27M
/// @return DMX_FILTER_STATUS_OK - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
/// @note only support on MMFI 2.0
//-------------------------------------------------------------------------------------------------
...
/// @note E_DMX_TSO_OUTCLK_62M/E_DMX_TSO_OUTCLK_54M/E_DMX_TSO_OUTCLK_27M/E_DMX_TSO_OUTCLK_Dmd are constant values of output clock.
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
///TSO configuration
/// @param u32TsoEng                \b IN: DMX TSO engine
/// @param u32TsoCfgDataSize   \b IN: Total size of DMX_TSO_Cfg data structure
///
...
#define DMX_CMD_SET_PESCPY_CONT_MODE                    0x00000010 //u32Config0: 0 ->  disable, 1 ->  enable
