...
DLL_PUBLIC extern GFX_Result MApi_GFX_GetFrameBufferInfo(MS_U32 *width, MS_U32 *height, MS_U32 *pitch, MS_U32 *fbFmt, MS_PHYADDR *addr);
...
DLL_PUBLIC extern GFX_Result MApi_GFX_SetConfig(EN_GFX_CONFIG_TYPE enType, void *plist,MS_U32 u32Len);
