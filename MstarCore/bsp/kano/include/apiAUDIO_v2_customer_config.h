...
//--------------------------------------------------------------------------------------
#define CUSTOMIZED_PATCH_ES_PASSTHROUGH     1

//--------------------------------------------------------------------------------------
//config for different customized internal patch
//--------------------------------------------------------------------------------------
//---ADEC set gain, mute---
#define CUSTOMIZED_INTERNAL_PATCH_ADEC_SET_GAIN 1
#define CUSTOMIZED_INTERNAL_PATCH_ADEC_SET_MUTE 1

//---MS12 HDMI PCM ouput (for sync with NPCM)---
#define CUSTOMIZED_INTERNAL_PATCH_MS12_HDMI_TX_PCM_AUTO_AUDIO_DELAY_ENABLE    1
...
//---General Buffer Dump---
#define CUSTOMIZED_INTERNAL_PATCH_GENERAL_BUFFER_DUMP  0
