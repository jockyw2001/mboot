...
//#define VDEC_CAP_HEVC_HDR_V2 //enable HDR
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
...
typedef enum
{
    ...
    E_VDEC_EX_USER_CMD_VDEC_SET_DISPLAY_MODE,
...
//VDEC_EX_Result MApi_VDEC_EX_SetFrmBuff2(VDEC_StreamId *pStreamId, MS_VIRT u32FrmBuffAddr, MS_U32 u32FrmBuffSize);
