...
#define _MODULE_GOP_U1_U2_RELATION \
        URELATION(fpGOP_Init,(void *)Ioctl_GOP_Init, MApi_GOP_Init) \
        URELATION(fpGOP_GetCaps,(void *)Ioctl_GOP_GetCaps ,MApi_GOP_GetChipCaps ) \
        URELATION(fpGOP_SetConfig,(void *)Ioctl_GOP_SetConfig ,MApi_GOP_SetConfig ) \
        URELATION(fpGOP_GetConfig,(void *)Ioctl_GOP_GetConfig , MApi_GOP_GetConfigEx) \
        URELATION(fpGOP_SetProperty,(void *)Ioctl_GOP_SetProperty , MApi_GOP_SetConfigEx) \
        URELATION(fpGOP_GetProperty,(void *)Ioctl_GOP_GetProperty ,MApi_GOP_GetConfigEx) \
        URELATION(fpGOP_SetDst,(void *)Ioctl_GOP_SetDst ,MApi_GOP_GWIN_SetGOPDst ) \
        URELATION(fpGOP_GetDst,(void *)Ioctl_GOP_GetDst ,MApi_GOP_GWIN_CheckOpmodeIsOn_EX ) \
        URELATION(fpGOP_SetMux,(void *)Ioctl_GOP_SetMux ,MApi_GOP_GWIN_SetMux ) \
        URELATION(fpGOP_SetMirror,(void *)Ioctl_GOP_SetMirror ,MApi_GOP_GWIN_SetVMirror_EX ) \
        URELATION(fpGOP_GetMirror,(void *)Ioctl_GOP_GetMirror ,MApi_GOP_GWIN_IsMirrorOn_EX ) \
        URELATION(fpGOP_GetStatus,(void *)Ioctl_GOP_GetStatus , MApi_GOP_GWIN_GetCurrentGOP) \
        URELATION(fpGOP_TestPattern,(void *)Ioctl_GOP_TestPattern , MApi_GOP_TestPattern) \
        URELATION(fpGOP_Set_Stretch,(void *)Ioctl_GOP_Set_Stretch , MApi_GOP_GWIN_Set_HSCALE_EX) \
        URELATION(fpGOP_Get_Stretch,(void *)Ioctl_GOP_Get_Stretch , MApi_GOP_GetInfo) \
        URELATION(fpGOP_GWin_SetProperty,(void *)Ioctl_GOP_GWin_SetProperty , MApi_GOP_GWIN_Enable) \
        URELATION(fpGOP_GWin_GetProperty,(void *)Ioctl_GOP_GWin_GetProperty , MApi_GOP_GWIN_IsGwinExist) \
        URELATION(fpGOP_MapFB2Win,(void *)Ioctl_GOP_MapFB2Win , MApi_GOP_GWIN_Map32FB2Win) \
        URELATION(fpGOP_SetWinInfo,(void *)Ioctl_GOP_SetWinInfo , MApi_GOP_GWIN_SetWinInfo) \
        URELATION(fpGOP_GetWinInfo,(void *)Ioctl_GOP_GetWinInfo , MApi_GOP_GWIN_GetWinInfo) \
        URELATION(fpGOP_SetDisplay,(void *)Ioctl_GOP_SetDisplay , MApi_GOP_GWIN_SetResolution_32FB) \
        URELATION(fpGOP_Win_Destroy,(void *)Ioctl_GOP_Win_Destroy , MApi_GOP_GWIN_DeleteWin) \
        URELATION(fpGFlip_ClearFlipQueue,(void *)Ioctl_GFlip_ClearFlipQueue , MApi_GOP_GWIN_ClearFlipQueue) \
        URELATION(fpGFlip_SwitchGwin,(void *)Ioctl_GFlip_SwitchGwin , MApi_GOP_Switch_GWIN_2_32FB) \
        URELATION(fpGFlip_SwitchMultiGwin,(void *)Ioctl_GFlip_SwitchMultiGwin , MApi_GOP_Switch_Multi_GWIN_2_FB_BY_ADDR) \
        URELATION(fpGOP_FBCreate,(void *)Ioctl_GOP_FBCreate , MApi_GOP_GWIN_Create32FB) \
        URELATION(fpGOP_FBDestroy,(void *)Ioctl_GOP_FBDestroy , MApi_GOP_GWIN_Destroy32FB) \
        URELATION(fpGOP_SetFBInfo,(void *)Ioctl_GOP_SetFBInfo , MApi_GOP_GWIN_Set32FBInfo) \
        URELATION(fpGOP_GetFBInfo,(void *)Ioctl_GOP_GetFBInfo , MApi_GOP_GWIN_Get32FBInfo) \
        URELATION(fpGOP_FB_SetProperty,(void *)Ioctl_GOP_FB_SetProperty , MApi_GOP_FB_SEL) \
        URELATION(fpGOP_FB_GetProperty,(void *)Ioctl_GOP_FB_GetProperty , MApi_GOP_FB_Get) \
        URELATION(fpGOP_Palette_Set_Config,(void *) Ioctl_GOP_Palette_Set_Config, MApi_GOP_GWIN_SetPaletteRead_EX) \
        URELATION(fpGOP_Palette_EntrySet,(void *) Ioctl_GOP_Palette_EntrySet, MApi_GOP_GWIN_SetPaletteOpt_EX) \
        URELATION(fpGOP_Palette_EntryGet,(void *) Ioctl_GOP_Palette_EntryGet, MApi_GOP_GWIN_ReadPalette_EX) \
        URELATION(fpGOP_Fade,(void *) Ioctl_GOP_Fade, MApi_GOP_GWIN_SetFadeInOut) \
        URELATION(fpGOP_Scroll,(void *) Ioctl_GOP_Scroll, MApi_GOP_GWIN_SetScrollRate) \
        URELATION(fpGOP_PINPON,(void *) Ioctl_GOP_PINPON, MApi_GOP_SetPINPON) \
        URELATION(fpGOP_DWIN_Init,(void *) Ioctl_GOP_DWIN_Init, MApi_GOP_DWIN_Init) \
        URELATION(fpGOP_Dwin_Capture,(void *) Ioctl_GOP_Dwin_Capture, MApi_GOP_DWIN_CaptureOneFrame) \
        URELATION(fpGOP_DWIN_SetProperty,(void *) Ioctl_GOP_DWIN_SetProperty, MApi_GOP_DWIN_SetAlphaValue) \
        URELATION(fpGOP_DWIN_GetProperty,(void *) Ioctl_GOP_DWIN_GetProperty, MApi_GOP_GetInfo) \
        URELATION(fpGOP_Dwin_Intr,(void *) Ioctl_GOP_Dwin_Intr, MApi_GOP_DWIN_EnableIntr) \
        URELATION(fpGOP_TriggerRegWriteIn,(void *) Ioctl_GOP_TriggerRegWriteIn, MApi_GOP_TriggerRegWriteIn_Ex) \
        URELATION(fpGOP_Select,(void *) Ioctl_GOP_Select, MApi_GOP_GWIN_SwitchGOP) \
        URELATION(fpGOP_Register_CB,(void *) Ioctl_GOP_Register_CB, MApi_GOP_RegisterFBFmtCB) \
        URELATION(fpGOP_MIXER_SetProperty,(void *) Ioctl_GOP_MIXER_SetProperty, MApi_GOP_MIXER_SetOutputTiming) \
        URELATION(fpGOP_MIXER_GetProperty,(void *) Ioctl_GOP_MIXER_GetProperty, MApi_GOP_GetInfo) \
        URELATION(fpGOP_VE_SetProperty,(void *) Ioctl_GOP_VE_SetProperty, MApi_GOP_VE_SetOutputTiming) \
        URELATION(fpGOP_MISC,(void *) Ioctl_GOP_MISC, MApi_GOP_SetClkForCapture) \
        URELATION(fpGOP_PowerState,(void *) Ioctl_GOP_PowerState, MApi_GOP_SetPowerState)
#endif

typedef int (*FPtr_Ioctl_GOP_Init)(void* pInstance,MS_U8 u8GOP,GOP_InitInfo *pGopInit);
typedef int (*FPtr_Ioctl_GOP_GetCaps)(void* pInstance,EN_GOP_CAPS eCapType, MS_U32* pRet, MS_U32 ret_size);
typedef int (*FPtr_Ioctl_GOP_SetConfig)(void* pInstance,EN_GOP_CONFIG_TYPE cfg_type,MS_U32* pCfg,MS_U32 u32Size);
typedef MS_U32 (*FPtr_Ioctl_GOP_GetConfig)(void* pInstance,EN_GOP_CONFIG_TYPE cfg_type,MS_U32* pCfg,MS_U32 u32Size);
typedef MS_U32 (*FPtr_Ioctl_GOP_SetProperty)(void* pInstance,EN_GOP_PROPERTY type,MS_U32 gop, MS_U32* pSet, MS_U32 u32Size);
typedef MS_U32 (*FPtr_Ioctl_GOP_GetProperty)(void* pInstance,EN_GOP_PROPERTY type,MS_U32 gop, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_SetDst)(void* pInstance,MS_U8 u8GOP, EN_GOP_DST_TYPE dsttype);
typedef int (*FPtr_Ioctl_GOP_GetDst)(void* pInstance,MS_U32 gop, MS_U32* pDst);
typedef int (*FPtr_Ioctl_GOP_SetMux)(void* pInstance,PGOP_SETMUX pGopMuxConfig, MS_U32 u32SizeOfMuxInfo);
typedef int (*FPtr_Ioctl_GOP_SetMirror)(void* pInstance,MS_U32 gop, EN_GOP_MIRROR_TYPE mirror);
typedef int (*FPtr_Ioctl_GOP_GetMirror)(void* pInstance,MS_U32 gop, EN_GOP_MIRROR_TYPE* mirror);
typedef int (*FPtr_Ioctl_GOP_GetStatus)(void* pInstance,EN_GOP_STATUS type, MS_U32* pStatus, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_TestPattern)(void* pInstance,EN_GOP_TST_PATTERN eTstPatternType, MS_U32 u32ARGB);
typedef int (*FPtr_Ioctl_GOP_Set_Stretch)(void* pInstance,EN_GOP_STRETCH_TYPE enStretchType,MS_U32 gop ,PGOP_STRETCH_INFO pStretchInfo);
typedef int (*FPtr_Ioctl_GOP_Get_Stretch)(void* pInstance,EN_GOP_STRETCH_TYPE enStretchType,MS_U32 gop ,PGOP_STRETCH_INFO pStretchInfo);
typedef int (*FPtr_Ioctl_GOP_GWin_SetProperty)(void* pInstance,EN_GOP_GWIN_PROPERTY type,MS_U32 gwin, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_GWin_GetProperty)(void* pInstance,EN_GOP_GWIN_PROPERTY type,MS_U32 gwin, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_MapFB2Win)(void* pInstance,MS_U32 fbid, MS_U32 gwin);
typedef int (*FPtr_Ioctl_GOP_SetWinInfo)(void* pInstance,MS_U32 gwinId,PGOP_BUFFER_INFO pInfo);
typedef int (*FPtr_Ioctl_GOP_GetWinInfo)(void* pInstance,MS_U32 gwinId,PGOP_BUFFER_INFO pInfo);
typedef int (*FPtr_Ioctl_GOP_SetDisplay)(void* pInstance,PGOP_GWINDISPLAY_INFO pInfo);
typedef int (*FPtr_Ioctl_GOP_Win_Destroy)(void* pInstance,MS_U32 gId);
typedef int (*FPtr_Ioctl_GFlip_ClearFlipQueue)(void* pInstance,MS_U32 gwin);
typedef int (*FPtr_Ioctl_GFlip_SwitchGwin)(void* pInstance,PGOP_GWIN_FLIP_WIN_INFO pflip);
typedef int (*FPtr_Ioctl_GFlip_SwitchMultiGwin)(void* pInstance,PGOP_GWIN_FLIP_MULTI_WIN_INFO pMultiflip);
typedef int (*FPtr_Ioctl_GOP_FBCreate)(void* pInstance,EN_GOP_CREATEBUFFER_TYPE fbtype,PGOP_BUFFER_INFO  pBuff,MS_U32 fbId);
typedef int (*FPtr_Ioctl_GOP_FBDestroy)(void* pInstance,MS_U32* pId);
typedef int (*FPtr_Ioctl_GOP_SetFBInfo)(void* pInstance,MS_U32 u32fbId, PGOP_BUFFER_INFO pBuff);
typedef int (*FPtr_Ioctl_GOP_GetFBInfo)(void* pInstance,MS_U32 u32fbId, PGOP_BUFFER_INFO pBuff);
typedef int (*FPtr_Ioctl_GOP_FB_SetProperty)(void* pInstance,EN_GOP_FB_PROPERTY type,MS_U32 FBId, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_FB_GetProperty)(void* pInstance,EN_GOP_FB_PROPERTY type,MS_U32 FBId, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_Palette_Set_Config)(void* pInstance,MS_U32 gop, DRV_GopPalReadType type,EN_GOP_PALETTE src);
typedef int (*FPtr_Ioctl_GOP_Palette_EntrySet)(void* pInstance,PGOP_PALETTE_ENTRY pClutEntry);
typedef int (*FPtr_Ioctl_GOP_Palette_EntryGet)(void* pInstance,PGOP_PALETTE_ENTRY pClutEntry);
typedef int (*FPtr_Ioctl_GOP_Fade)(void* pInstance,EN_GOP_FADE_SET_TYPE type, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_Scroll)(void* pInstance,EN_GOP_SCROLL_TYPE type, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_PINPON)(void* pInstance,EN_GOP_PINPON_PROPERTY en_pro, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_DWIN_Init)(void* pInstance);
typedef int (*FPtr_Ioctl_GOP_Dwin_Capture)(void* pInstance,PGOP_CAPTURE_INFO pinfo);
typedef int (*FPtr_Ioctl_GOP_DWIN_SetProperty)(void* pInstance,EN_GOP_DWIN_PROPERTY type,MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_DWIN_GetProperty)(void* pInstance,EN_GOP_DWIN_PROPERTY type,MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_Dwin_Intr)(void* pInstance,EN_GOP_DWIN_INTR intr_type, MS_U32* pIntr ,MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_TriggerRegWriteIn)(void* pInstance,MS_U32 gop, EN_GOP_UPDATE_TYPE update_type, MS_BOOL bEn, MS_BOOL bSync);
typedef int (*FPtr_Ioctl_GOP_Select)(void* pInstance,EN_GOP_SELECT_TYPE sel, MS_U32 id, MS_U32* pSet);
typedef int (*FPtr_Ioctl_GOP_Register_CB)(void* pInstance,GOP_CB_TYPE cb_type, void* pCB, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_MIXER_SetProperty)(void* pInstance,EN_GOP_MIXER_PROPERTY type,MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_MIXER_GetProperty)(void* pInstance,EN_GOP_MIXER_PROPERTY type,MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_VE_SetProperty)(void* pInstance,EN_GOP_VE_PROPERTY type,MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_MISC)(void* pInstance,EN_GOP_MISC_TYPE type, MS_U32* pSet, MS_U32 u32Size);
typedef int (*FPtr_Ioctl_GOP_PowerState)(void* pInstance, MS_U32 u32PowerState, void* pModule);
