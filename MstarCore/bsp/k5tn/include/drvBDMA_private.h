...
#define _MODULE_BDMA_U1_U2_RELATION \
        URELATION(fpBDMAMemCpy,(IOCTL_BDMA_MEMCPY)_MDrv_BDMA_MemCopy, MDrv_BDMA_MemCopy) \
        URELATION(fpBDMASearch,(IOCTL_BDMA_SEARCH)_MDrv_BDMA_Search ,MDrv_BDMA_Search ) \
        URELATION(fpBDMACRC32,(IOCTL_BDMA_CRC32)_MDrv_BDMA_CRC32 ,MDrv_BDMA_CRC32 ) \
        URELATION(fpBDMAPatternFill,(IOCTL_BDMA_PATTERN_FILL)_MDrv_BDMA_PatternFill , MDrv_BDMA_PatternFill) \
        URELATION(fpBDMAFlashCopy2Dram,(IOCTL_BDMA_FLASHCOPY2DRAM)_MDrv_BDMA_FlashCopy2Dram , MDrv_BDMA_FlashCopy2Dram) \
        URELATION(fpBDMAGetStatus,(IOCTL_BDMA_GETSTATUS)_MDrv_BDMA_GetStatus ,MDrv_BDMA_GetStatus ) \
        URELATION(fpBDMAGetInfo,(IOCTL_BDMA_GETINFO)MDrv_BDMA_GetInfo ,MDrv_BDMA_GetInfo ) \
        URELATION(fpBDMAGetLibVer,(IOCTL_BDMA_GETLIBVER)MDrv_BDMA_GetLibVer ,MDrv_BDMA_GetLibVer ) \
        URELATION(fpBDMAGetMinSize,(IOCTL_BDMA_GETMINSIZE)MDrv_BDMA_GetMinSize ,MDrv_BDMA_GetMinSize ) \
        URELATION(fpBDMASetDbgLevel,(IOCTL_BDMA_SETDBGLEVEL)MDrv_BDMA_SetDbgLevel ,MDrv_BDMA_SetDbgLevel ) \
        URELATION(fpBDMASetSPIOffsetForMCU,(IOCTL_BDMA_SETSPIOFFSETFORMCU)_MDrv_BDMA_SetSPIOffsetForMCU ,MDrv_BDMA_SetSPIOffsetForMCU ) \
        URELATION(fpBDMAWaitFlashDone,(IOCTL_BDMA_WAITFLASHDONE)_MDrv_BDMA_WaitFlashDone , MDrv_BDMA_WaitFlashDone)
