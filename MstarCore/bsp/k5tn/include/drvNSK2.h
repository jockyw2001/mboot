...
MS_U32 MDrv_NSK2_WriteTransportKeyPatch(MS_U8 SCB, MS_U8 ForceSCB, void *pLabel, MS_U8 pid_no );
...
MS_BOOL MDrv_NSK2_EnableCWEPatch(void);
MS_BOOL MDrv_NSK2_CWESetKeySlotIndex(MS_U32 OriPidSlotId, MS_U32 PatchPidSlotId, MS_U32 Type);
MS_BOOL MDrv_NSK2_CWEClearKeySlotIndex(MS_U32 PatchPidSlotId);
#ifdef __cplusplus
}
#endif
#endif//_DRVNSK2_H_
