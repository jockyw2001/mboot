...
typedef enum
{
    ...
    E_INT_IRQ_AESDMA                    = E_INT_IRQ_0x120_START + 15,   //kiwi
    E_INT_IRQ_0x120_END                 = 0x12F,

    E_INT_IRQ_0x130_START               = 0x130,
    E_INT_IRQ_GPIO12_INT_INV            = E_INT_IRQ_0x130_START + 1,    //kiwi
    E_INT_IRQ_GPIO12_INT              	= E_INT_IRQ_0x130_START + 2,    //kiwi
    E_INT_IRQ_GPIO22_INT_INV            = E_INT_IRQ_0x130_START + 3,    //kiwi
    E_INT_IRQ_GPIO22_INT              	= E_INT_IRQ_0x130_START + 4,    //kiwi
    E_INT_IRQ_AUDMA_V2_INT              = E_INT_IRQ_0x130_START + 5,    //kiwi
    E_INT_IRQ_PAS_PTS_INT_COMBINE       = E_INT_IRQ_0x130_START + 6,    //kiwi
    E_INT_FIQ_LAN_ESD_INT       		= E_INT_IRQ_0x130_START + 7,    //kiwi
    E_INT_FIQ_GPIO12_INT_INV            = E_INT_IRQ_0x130_START + 8,    //kiwi
    E_INT_FIQ_GPIO12_INT              	= E_INT_IRQ_0x130_START + 9,    //kiwi
    E_INT_FIQ_GPIO22_INT_INV            = E_INT_IRQ_0x130_START + 10,   //kiwi
    E_INT_FIQ_GPIO22_INT              	= E_INT_IRQ_0x130_START + 11,   //kiwi
    E_INT_FIQ_SEC_TIMER0                = E_INT_IRQ_0x130_START + 12,   //kayla
    E_INT_FIQ_SEC_TIMER1                = E_INT_IRQ_0x130_START + 13,   //kayla
    E_INT_IRQ_TS0_VLD                   = E_INT_IRQ_0x130_START + 14,   //k5tn
    E_INT_IRQ_TS1_VLD                   = E_INT_IRQ_0x130_START + 15,   //k5tn
    E_INT_IRQ_0x130_END                 = 0x13F,

    E_INT_IRQ_0x140_START               = 0x140,
    E_INT_IRQ_TSIO                      = E_INT_IRQ_0x140_START + 1,    //k5tn
    E_INT_IRQ_GPIO_TRIGGER              = E_INT_IRQ_0x140_START + 2,    //k5tn
    E_INT_IRQ_RTC2                      = E_INT_IRQ_0x140_START + 3,    //k5tn
    E_INT_IRQ_VDR2_ADDR_LIMIT           = E_INT_IRQ_0x140_START + 4,    //k5tn
    E_INT_IRQ_VIVALDI_AL_L              = E_INT_IRQ_0x140_START + 5,    //k5tn
    E_INT_FIQ_SEC_GUARD                 = E_INT_IRQ_0x140_START + 6,    //k5tn
