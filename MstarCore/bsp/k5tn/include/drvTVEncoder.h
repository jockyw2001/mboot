...
/// @return None
//-------------------------------------------------------------------------------------------------
void SYMBOL_WEAK MDrv_VE_OnOffWSS(MS_BOOL ben);
...
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MDrv_VE_GetWSSStatus(void);
...
/// @return None
//-------------------------------------------------------------------------------------------------
void SYMBOL_WEAK MDrv_VE_OnOffMV(MS_BOOL ben);
...
/// @return TRUE: Enable,  FALSE: Disable
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MDrv_VE_GetMVStatus(void);
...
/// @return None
//-------------------------------------------------------------------------------------------------
void SYMBOL_WEAK MDrv_VE_OnOffDCS(MS_BOOL ben);
...
/// @return TRUE: Enable,  FALSE: Disable
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MDrv_VE_GetDCSStatus(void);
