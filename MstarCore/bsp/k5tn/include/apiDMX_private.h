...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_TSIO_Service_PidOpen)(MS_U16 u16Handle, DMX_TSIF eTSOInSrc, MS_U16 u16Pid, MS_U16* pu16DmxId);
typedef DMX_FILTER_STATUS (*IOCTL_DMX_TSIO_Service_PidClose)(MS_U16 u16Handle, MS_U16 u16DmxId);
