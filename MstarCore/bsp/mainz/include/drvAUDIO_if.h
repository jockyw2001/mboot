...
#define AUDIO_BIFROST_TEST_SUPPORT_VERSION  (2 | 4) // 2:  Some first basic module test cases supported. 4: SonicEmotion ABS3D supported.
...
typedef enum
{
  /*********  New Interface ********/
    ...
    Audio_Comm_infoType_ADEC1_Get_PCM_WPTR,        // DEC1 -> DEC1_PCM1 wptr
    ...
    Audio_Comm_infoType_Get_Dra_SampleRate,
...
typedef enum
{   //info Type name                    //Attibtue      //Parameter
    Audio_DRA_infoType_SampleRate,              //R             //
    Audio_DRA_infoType_NumCh,         //RW            //
} Audio_DRA_infoType;
...
typedef struct
{
    MS_U8 u8StrCmd[AUDIO_STRCMD_LENGTH];
    void *pData;
} AUDIO_COMMON_CMD_t;
