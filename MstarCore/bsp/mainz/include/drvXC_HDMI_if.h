...
#define HDMI_EXTEND_PACKET_RECEIVE_VERSION            1
...
typedef struct __attribute__((packed))
{
    ...
    MS_BOOL bPKT_MPEG_RECEIVE;       ///< MPEG packet enable
    MS_BOOL bPKT_AUI_RECEIVE;         ///< AUI packet enable
    MS_BOOL bPKT_SPD_RECEIVE;         ///< SPD packet enable
    MS_BOOL bPKT_AVI_RECEIVE;         ///< AVI packet enable
    MS_BOOL bPKT_GC_RECEIVE;         ///< GC packet enable
    MS_BOOL bPKT_ASAMPLE_RECEIVE;    ///< ASAMPLE packet enable
    MS_BOOL bPKT_ACR_RECEIVE;        ///< ACR packet enable
    MS_BOOL bPKT_VS_RECEIVE;          ///< VS packet enable
    MS_BOOL bPKT_NULL_RECEIVE;       ///< NULL packet enable
    MS_BOOL bPKT_ISRC2_RECEIVE;      ///< ISRC2 packet enable
    MS_BOOL bPKT_ISRC1_RECEIVE;      ///< ISRC1 packet enable
    MS_BOOL bPKT_ACP_RECEIVE;         ///< ACP packet enable
    MS_BOOL bPKT_ONEBIT_AUD_RECEIVE;    ///< ONE bit AUD packet enable
    MS_BOOL bPKT_GM_RECEIVE;     /// <GM packet enable
    MS_BOOL bPKT_HBR_RECEIVE;    /// <HBR packet enable
    MS_BOOL bPKT_VBI_RECEIVE;     /// <VBIpacket enable
    MS_BOOL bPKT_HDR_RECEIVE;    ///< HDR packet enable
    MS_BOOL bPKT_RSV_RECEIVE;    ///< RSV packet enable
