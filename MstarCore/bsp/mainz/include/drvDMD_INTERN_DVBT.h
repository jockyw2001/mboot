 ...
 *! \defgroup DVBT DVBT interface (drvDMD_INTERN_DVBT.h)
 *  \ingroup Demod
    
    \brief 
    
    DVBT driver is a driver for control the operation of the DVB-T system. Some important 
   ...
   - Set Config               
   - Set Config HPLP               
   - Set Config HPLP Set IF          
   - Set Active               
   - Get Lock               
   - Get Signal Strength           
   - Get Signal Strength With RF Power
   - Get Signal Quality            
   - Get Signal Quality With RF Power 
   - Get SNR               
   ...
   - Get Cell ID               
   - Get Freq Offset               
   - NORDIG SSI Table Write      
   - NORDIG SSI Table Read       
   - Set Power State               
    

    <b> DVBT Block Diagram: </b> \n
    \image html DVBT.png
 ...
 * *! \defgroup DVBT_BASIC DMD Module basic
 *  \ingroup DVBT
     
 *! \defgroup DVBT_To_Be_Removed DVBT to be removed
 *  \ingroup DVBT
    
 *! \defgroup DVBT_To_Be_Modified DVBT to be modified
 *  \ingroup DVBT
    
 *! \defgroup DVBT_REG To set/get register
 *  \ingroup DVBT
    
 *! \defgroup DVBT_CONFIG DVBT config
 *  \ingroup DVBT

 *! \defgroup DVBT_LOCK DVBT get lock
 *  \ingroup DVBT
   
 *! \defgroup DVBT_INFO To get DVBT information
 *  \ingroup DVBT
...
/// Initialize DVBT 
/// @ingroup DVBT_BASIC   
/// @param  pDMD_DVBT_InitData     \b IN: Initial data
...
/// Get the information of DVBT driver
/// @ingroup DVBT_INFO  
/// @param  eInfoType   			 \b IN: DVBT information type
/// @return : the pointer to the driver information 
//-------------------------------------------------------------------------------------------------
...
/// To set config data
/// @ingroup DVBT_CONFIG  
/// @param  BW   			 								\b IN: RF channel bandwidth
/// @param  bSerialTS   			 				\b IN: 1=>serial, 0=>parallel
/// @param  bPalBG   			 						\b IN: For Analog CCI 0:PAL B/G (Nordig), 1:PAL I (D-Book)
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
/// @param  bSerialTS   			 				\b IN: 1=>serial, 0=>parallel
/// @param  bPalBG   			 						\b IN: For Analog CCI 0:PAL B/G (Nordig), 1:PAL I (D-Book)
/// @param  bLPSel   			 						\b IN: Hierarchy mode
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
/// @param  bPalBG   			 						\b IN: For Analog CCI 0:PAL B/G (Nordig), 1:PAL I (D-Book)
/// @param  bLPSel   			 						\b IN: Hierarchy mode
/// @param  u32IFFreq   			 				\b IN: IF frequency
/// @param  u32FSFreq   			 				\b IN: FS frequency
/// @param  u8IQSwap   			 					\b IN: IQ swap
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
/// DVBT get lock flow
/// @ingroup DVBT_LOCK  
/// @param  eType   			 			 \b IN: DVBT get lock
/// @param  eLockStatus   			 \b IN: DVBT lock status
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////
//-------------------------------------------------------------------------------------------------
/// To get TPS information
/// @ingroup DVBT_INFO  
/// @param  u16Info   			 		 \b IN: TPS information
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////
//-------------------------------------------------------------------------------------------------
/// To write DVBT nordig SSI table
/// @ingroup DVBT_REG  
/// @param  constel   			 		\b IN: constel
/// @param  code_rate   			 	\b IN: code rate
/// @param  write_value   			\b IN: write value
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////
//-------------------------------------------------------------------------------------------------
/// To read DVBT nordig SSI table
/// @ingroup DVBT_REG  
/// @param  constel   			 		\b IN: constel
/// @param  code_rate   			 	\b IN: code rate
/// @param  read_value   				\b IN: read value
/// @return TRUE : succeed
/// @return FALSE : fail
//-------------------------------------------------------------------------------------------------
