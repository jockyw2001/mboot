...
typedef enum
{
    DMX_BURSTSINGLE                = 0x00, ///< Single byte
    DMX_BURST2BYTE                 = 0x01, ///< 2 bytes
    DMX_BURST4BYTE                 = 0x02, ///< 4 bytes
    DMX_BURST8BYTE                 = 0x03, ///< 8 bytes
} DMX_BURSTTYPE;
...
///Get dis-continue count by ts source and specific FIFO.
/// @ingroup TSP_Debug
/// @param DmxInfo           \b IN: set control parameter to get related source packet count.
