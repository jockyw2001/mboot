...
typedef enum
{
    ...
    E_VDEC_EX_V2_USER_CMD_SET_TIME_INC_PREDICT_PARA,       // Param: Arg0(enable), Arg1( 1 for predict once), Arg2(0 for follow vol_header)
    ...
    E_VDEC_EX_V2_USER_CMD_SET_SLOW_SYNC,              //Param: VDEC_EX_Slow_Sync, u8RepeatPeriod: 0(disable), 1~0xFF(Repeat Period, repeat one every u8RepeatPeriod display),  u8DropPeriod: 0(disable), 1~0xFF(Drop Period, Drop one every u8DropPeriod display)
    ...
    E_VDEC_EX_V2_USER_CMD_VDEC_FEATURE,                 //AP control VDEC features
    ...
    E_VDEC_EX_V2_USER_CMD_CAL_FRAMERATE,               // Param: 0(Disable), 1(Enable)
