...
typedef struct __attribute__((packed))
{
    ...
    EN_HDMITX_QUANT_RANGE     input_range;
    EN_HDMITX_QUANT_RANGE     output_range;
    MS_BOOL                   result;
...
MS_BOOL MApi_HDMITx_GeneralCtrl(MS_U32 u32Cmd, void* pBuf, MS_U32 u32BufSize);
#ifdef __cplusplus
}
#endif
