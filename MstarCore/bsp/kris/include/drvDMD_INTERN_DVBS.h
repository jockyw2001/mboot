...
/*
    ...
    */
	...
	E_DMD_S2_FW_VERSION_L,           	//0x04
	E_DMD_S2_FW_VERSION_H,           	//0x05
	E_DMD_S2_CHIP_VERSION,
	E_DMD_S2_FS_L,		 				//Frequency
	E_DMD_S2_FS_H,						//Frequency
	E_DMD_S2_MANUAL_TUNE_SYMBOLRATE_L,	//0x09
	E_DMD_S2_MANUAL_TUNE_SYMBOLRATE_H,	//0x0a
...
/// For demod init
#ifdef UFO_DEMOD_SUPPORT_DMD_INT
/*typedef enum
{
    E_DMD_DVBS_INT_UNKNOWN=0,
    E_DMD_DVBS_INT_LOCK,
    E_DMD_DVBS_INT_UNLOCK,
    E_DMD_DVBS_INT_TS
} DMD_DVBS_INT_TYPE;*/
...
extern DLL_PUBLIC MS_BOOL MDrv_DMD_DVBS_BlindScan_GetTunerFreq(MS_U16 *u16TunerCenterFreq, MS_U16 *u16TunerCutOffFreq);
