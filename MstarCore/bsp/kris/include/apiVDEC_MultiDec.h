...
typedef enum
{
    ...
    E_VDEC_EX_HVD_ERR_CODE_BASE = 0x03000000,
        ...
        // VP8
        E_VDEC_EX_HVD_ERR_CODE_VP8_BASE = (0x4000|E_VDEC_EX_HVD_ERR_CODE_BASE),
        E_VDEC_EX_HVD_ERR_CODE_VP8_RES,
        // HEVC
        E_VDEC_EX_HVD_ERR_CODE_HEVC_BASE = (0x5000|E_VDEC_EX_HVD_ERR_CODE_BASE),
        E_VDEC_EX_HVD_ERR_CODE_HEVC_RES,
        // VP9
        E_VDEC_EX_HVD_ERR_CODE_VP9_BASE = (0x6000|E_VDEC_EX_HVD_ERR_CODE_BASE),
        E_VDEC_EX_HVD_ERR_CODE_VP9_RES,
...
typedef enum
{
    ...
    E_VDEC_EX_USER_CMD_SET_TIME_INC_PREDICT_PARA,       // Param: Arg0(enable), Arg1( 1 for predict once), Arg2(0 for follow vol_header)
    ...
    E_VDEC_EX_USER_CMD_SET_ERROR_TOLERANCE,             // Param: VDEC_EX_Err_Tolerance; bEnable: enable or disable; u8Tolerance: err_rate(0%~100%)
    ...
    /***/E_VDEC_EX_USER_CMD_RM_FORCE_MCU_MODE_ES,            // Param: 0(Disable), 1(Enable) //johnny.ko
