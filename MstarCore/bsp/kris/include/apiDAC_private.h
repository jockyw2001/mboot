...
typedef MS_U32                     (*IOCTL_DAC_SET_POWER_STATE)              (E_DAC_POWER_MODE);
...
typedef struct
{
    ...
    E_OUTPUT_VIDEO_TIMING_TYPE OutputVideoTimingType;
...
MS_U32 Mapi_DAC_SetPowerState_U2(E_DAC_POWER_MODE PowerState);
