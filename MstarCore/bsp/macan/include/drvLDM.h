...
#ifdef ROLLS_ROYCE
#define MDRV_LDM_IOC_SET_LOWLIMIT           _IOW(MDRV_LDM_IOC_MAGIC, 13, MS_U32)
#define MDRV_LDM_IOC_SET_CONFIG_NAME        _IOW(MDRV_LDM_IOC_MAGIC, 14, MS_U32)
#endif
...
{
  E_LDMFILE_INI =0x0,
  E_LDMFILE_BACKLIGHT_GAMMA = 0x1,
  E_LDMFILE_COMPENSATION = 0x2,
  E_LDMFILE_EDGE2D = 3,
  E_LDMFILE_MAX,
}EN_LDMFILETYPE;
...
{
    EN_LDMFILETYPE enLdmFileType;
    MS_U8 aLdmIniPath[64];
    MS_U8 aLdmGammaPath[64];
    MS_U8 aLdmCompenPath[64];
    MS_U8 aLdmEdgePath[64];
}ST_DRV_LD_CONFIG_Name;
#endif 
...
#ifdef ROLLS_ROYCE
//----------------------------------------------------------------
// MDrv_LDM_SetLowLimit - Set back light lowlimit value
/// @ingroup G_LDM_CONTROL
// @param: u8Percent: the percent ranged from 10 to 255
// @return: E_LDM_RET_SUCCESS is setted
//----------------------------------------------------------------
MDRV_INTERFACE MS_U8 MDrv_LDM_SetLowLimit(MS_U8 u8LowLimit);


//----------------------------------------------------------------
// MDrv_LDM_SetConfName - Set config files name
/// @ingroup G_LDM_CONTROL
// @param: stConfName: rename config files name
// @return: E_LDM_RET_SUCCESS is setted
//----------------------------------------------------------------
MDRV_INTERFACE MS_U8 MDrv_LDM_SetConfName(ST_DRV_LD_CONFIG_Name stConfName);
#endif
