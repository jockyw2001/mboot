...
typedef enum
{
    ...
    E_VDEC_EX_BUFFERTYPE_FB_MAIN,                   /*0x0001*/
    E_VDEC_EX_BUFFERTYPE_FB_SUB,                    /*0x0002*/
    E_VDEC_EX_BUFFERTYPE_FB_BW,                     /*0x0003*/
    E_VDEC_EX_BUFFERTYPE_FB_NUM,

    E_VDEC_EX_BUFFERTYPE_BS_BASE = 0x0100,
    E_VDEC_EX_BUFFERTYPE_BS_MAIN,                   /*0x0101*/
    E_VDEC_EX_BUFFERTYPE_BS_SUB,                    /*0x0102*/
    E_VDEC_EX_BUFFERTYPE_BS_NUM,

    E_VDEC_EX_BUFFERTYPE_HDRSHM_BASE = 0x0200,
    E_VDEC_EX_BUFFERTYPE_HDRSHM_MAIN,               /*0x0201*/
    E_VDEC_EX_BUFFERTYPE_HDRSHM_SUB,                /*0x0202*/
...
typedef enum
{
    ...
    E_VDEC_EX_GET_BUFFERTYPE_ALLOC_BS,              /*0x0001*/
    E_VDEC_EX_GET_BUFFERTYPE_ALLOC_DRVPROC,         /*0x0002*/
