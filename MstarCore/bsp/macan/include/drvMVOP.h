...
typedef enum
{
    ...
    E_MVOP_CMD_SET_STREAM_INFO,          ////<0x11D Set stream infomation before inputcfg and outputcfg, clear in the end of outputcfg.
    ...
    E_MVOP_CMD_GET_IS_XC_GEN_TIMING,            ///< 0x413 Get if timing is from xc (or from mvop).
    E_MVOP_CMD_GET_IS_MVOP_AUTO_GEN_BLACK,      ///< 0x414 Get if mvop support auto bk background.
} MVOP_Command;
