...
typedef enum
{
    E_GOP_LOCK,
    E_GOP_UNLOCK,
    E_GOP_LOCK_FOR_FORCE_WRITE,
    E_GOP_UNLOCK_FOR_FORCE_WRITE,
}EN_GOP_MUTEX;
...
typedef struct _GOP_SETFUNS_PARAM
{
    MS_U32 eFuns;                       //EN_GOP_FUNTION
    void* pInfo;                        //Funs info
    MS_U32 u32Size;                     //Corresponding to the require caps structure size
}GOP_SETFUNS_PARAM, *PGOP_SETFUNS_PARAM;
