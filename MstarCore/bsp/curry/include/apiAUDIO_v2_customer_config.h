...
#define UTPA_SUPPORT_HDMI_TX_OUT_BYPASS         1
#define UTPA_SUPPORT_DOLBY_DAP                  0
#define UTPA_SUPPORT_COMMON_CMD_API             0
#define UTPA_SUPPORT_XPCM_PARAM_CHANNEL_MASK    0
#define UTPA_SUPPORT_HDMI_TX_STATUS             1
#define UTPA_SUPPORT_SET_POWER_ON               0
#define UTPA_SUPPORT_AVC_R_MODE                 1
#define UTPA_SUPPORT_SND_INTERNAL_DELAY         0

//---DDPE Control by MCU---
#define UTPA_SUPPORT_M2S_MBOX_DDPE_ENCODE_CTRL  1
#define M2S_MBOX_DDPE_ENCODE_CTRL               0x112DC2

//---HDMI NPCM Control by MCU---
#define UTPA_SUPPORT_M2S_MBOX_MCU_HDMI_NONPCM_CTRL  1
#define M2S_MBOX_MCU_HDMI_NONPCM_CTRL               0x112DC4
        /*
...
#define MBOX_BYTE_STATUS_SELECT     0x112E9C

//---g_DDPBypassenable_1, g_DDPBypassenable_2 in halMAD.c---
#define UTPA_SUPPORT_AC3P_INFOTYPE_HDMITX_BYPASS_ENABLE 0
...
#define R2_SUPPORT_R2DMA_READER2                    0
#define R2_SUPPORT_R2_DEC_ISR2_EN                   1

//--------------------------------------------------------------------------------------
//config for different Chip.
//--------------------------------------------------------------------------------------
#define UTPA_AUDIO_CHIP_TYPE_2R1D           0
#define UTPA_AUDIO_CHIP_TYPE_1R1D           1
...
//---HDMI RX BYPASS---
#define CUSTOMIZED_PATCH_PARAM_HDMI_RX_BYPASS       0
#define REG_AUDIO_SPDIF_OUT_CFG                     0x112C8A
#define REG_AUDIO_SPDIF2_OUT_CFG                    0x112C5E

//---Low Latency Limiter---
#define CUSTOMIZED_PATCH_PARAM_LOW_LATENCY          1

//---DNSE---
#define CUSTOMIZED_PATCH_PARAM_DNSE                 0

//---DOLBY_ATMOS_CONTROL---
#define CUSTOMIZED_PATCH_PARAM_DOLBY_ATMOS_CTRL     1

//---MCU dump R2 log---
#define CUSTOMIZED_PATCH_PARAM_MCU_DUMP_R2_LOG      1
#define CUSTOMIZED_PATCH_INFO_MCU_DUMP_R2_LOG       1

//---ES Repeat Play---
#define CUSTOMIZED_PATCH_PARAM_ES_REPEAT_PLAY       1

//---ASND DSP DDR size---
#define ASND_DSP_DDR_SIZE                           0x2C0000

//---DEC PCM1 buffer info---
#define CUSTOMIZED_PATCH_INFO_DEC_PCM1_BUFFER       1
...
#define OFFSET_HDMI_NONPCM_DRAM_BASE                0x0138000
...
#define CUSTOMIZED_PATCH_INFO_MS12_DDPE_METADATA_BUFFER 1
...
//---DEC ES1 buffer info---
#define CUSTOMIZED_PATCH_INFO_DEC_ES1_BUFFER    0
#define ES1_DRAM_SIZE                           0x20000

//---SE-DSP Force MS12 DD/DDP Encode without main sound---
#define CUSTOMIZED_PATCH_PARAM_SEDSP_MS12_ENC_WO_MAIN_SND   1

//---SND-R2 Force MS12 DD/DDP Encode without main sound---
#define CUSTOMIZED_PATCH_PARAM_SNDR2_MS12_ENC_WO_MAIN_SND   0

#define MBOX_BYTE_DEC_SPDIF_SEL                             0x112E96
        /*
        1R1D:
...
#define CUSTOMIZED_PATCH_PARAM_HDMI_RX_SWITCH_TO_PCM_DEBOUNCE    0

//---HDMI RX Monitor Event CallBack---
#define CUSTOMIZED_PATCH_PARAM_HDMI_RX_MONITOR_EVENT_CALLBACK    0
...
#define CUSTOMIZED_INTERNAL_PATCH_PARAM_MS12_HDMI_TX_PCM_AUTO_AUDIO_DELAY_ENABLE    1
...
#define CUSTOMIZED_INTERNAL_PATCH_PARAM_SNDR2_MS12_PCMR_METADATA_SELECT 0
...
#define CUSTOMIZED_INTERNAL_PATCH_DDP_71_AUTO_BYPASS_STB_HDMI_TX    1
#define CUSTOMIZED_INTERNAL_PATCH_DDP_71_AUTO_BYPASS_TV_HDMI_ARC    0
...
#define CUSTOMIZED_INTERNAL_PATCH_SET_PLAY_CMD_BY_ADEC_SOURCE_DELAY 0
#define CUSTOMIZED_INTERNAL_PATCH_PAUSE_DECODING_DELAY              0

//---DDP SRS Auto Bypass---
#define CUSTOMIZED_INTERNAL_PATCH_DDP_SRS_AUTO_BYPASS_ENABLE    0

//---LIMITED AUDIO_DELAY for DDPE--- [SE-DSP] AUDIO_DELAY_LOWER_BOUND in audio_comm2.h
#define CUSTOMIZED_INTERNAL_PATCH_LIMITED_AUDIO_DELAY_ENABLE    0
#define AUDIO_DELAY_LOWER_BOUND                                 0x30

//---R2_Active_Monitor---
#define CUSTOMIZED_INTERNAL_PATCH_R2_ACTIVE_MONITOR_ENABLE  1
#define REG_DECR2_ACK1                                      0x112EAE
#define REG_DECR2_ACK1_RESPONSE                             0xF2

//---Initial Codec to AC3---
#define CUSTOMIZED_INTERNAL_PATCH_ADEC0_INITIAL_CODEC_TYPE_AC3_ENABLE   0
