...
typedef MS_U32                 DRVSEM_RESULT;
#define DRVSEM_OK              0x00000000
#define DRVSEM_FAIL            0x00000001
...
typedef MS_BOOL (*IOCTL_SEM_GETRESOURCE)(MS_U8, MS_U16, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_FREERESOURCE)(MS_U8, MS_U16, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_RESETRESOURCE)(MS_U8, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_GETRESOURCEID)(MS_U8, MS_U16*, MS_BOOL*);
typedef MS_U32 (*IOCTL_SEM_GETNUM)(MS_U32*);
typedef MS_BOOL (*IOCTL_SEM_GETLIBVER)(const MSIF_Version **, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_LOCK)(MS_U32, MS_U32, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_UNLOCK)(MS_U32, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_DELETE)(MS_U32, MS_BOOL*);
typedef MS_BOOL (*IOCTL_SEM_INIT)(void);
