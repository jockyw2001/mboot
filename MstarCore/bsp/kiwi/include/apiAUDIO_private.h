...
typedef MS_S32              (*IOCTL_AUDIO_PCM_OPEN)(VOID *pData);
typedef MS_S32              (*IOCTL_AUDIO_PCM_ClOSE)(MS_S32 s32DeviceId);
typedef MS_S32              (*IOCTL_AUDIO_PCM_START)(MS_S32 s32DeviceId);
typedef MS_S32              (*IOCTL_AUDIO_PCM_STOP)(MS_S32 s32DeviceId);
typedef MS_S32              (*IOCTL_AUDIO_PCM_SET)(MS_S32 s32DeviceId, MS_U32 u32Cmd, const VOID *pData);
typedef MS_S32              (*IOCTL_AUDIO_PCM_GET)(MS_S32 s32DeviceId, MS_U32 u32Cmd, VOID *pData);
typedef MS_U32              (*IOCTL_AUDIO_PCM_READ)(MS_S32 s32DeviceId, const VOID *pBuf, MS_U32 u32Size);
typedef MS_U32              (*IOCTL_AUDIO_PCM_WRITE)(MS_S32 s32DeviceId, const VOID *pBuf, MS_U32 u32Size);
typedef MS_S32              (*IOCTL_AUDIO_PCM_FLUSH)(MS_S32 s32DeviceId);
...
MS_U32              _MApi_AUDIO_PCM_Read(MS_S32 s32DeviceId, const VOID *pBuf, MS_U32 u32Size);
