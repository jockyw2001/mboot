...
typedef enum {
    ...
    MApi_CMD_AUDIO_PCM_Open,                                    // pointer to (VOID *pData)
    MApi_CMD_AUDIO_PCM_Close,                                   // pointer to (MS_S32)
    MApi_CMD_AUDIO_PCM_Start,                                   // pointer to (MS_S32)
    MApi_CMD_AUDIO_PCM_Stop,                                    // pointer to (MS_S32)
    MApi_CMD_AUDIO_PCM_Set,                                     // pointer to (MS_S32 s32DeviceId, MS_U32 u32Cmd, const VOID *pData);
    MApi_CMD_AUDIO_PCM_Get,                                     // pointer to (MS_S32 s32DeviceId, MS_U32 u32Cmd, VOID *pData)
    MApi_CMD_AUDIO_PCM_Read,                                    // pointer to (MS_S32 s32DeviceId, const VOID *pBuf, MS_U32 u32Size)
    MApi_CMD_AUDIO_PCM_Write,                                   // pointer to (MS_S32 s32DeviceId, const VOID *pBuf, MS_U32 u32Size)
    MApi_CMD_AUDIO_PCM_Flush,                                   // pointer to (MS_S32 s32DeviceId)
} eAudioIoctlOpt;
...
typedef struct _AUDIO_ST_PCM_READ_WRITE
{
    MS_U32                      u32Status;
    MS_S32                      s32DeviceId;
    const VOID                  *pBuf;
    MS_U32                      u32Size;
}AUDIO_ST_PCM_READ_WRITE, *PAUDIO_ST_PCM_READ_WRITE;
