...
//================================================================
#define AUDIO_PCM_INFO_VERSION    1
...
typedef struct
{
    ...
    MS_VIRT u32Buffer; /* PCM buffer address */
#else
    MS_U32 u32Buffer; /* PCM buffer address */
#endif

    MS_U32 u32BufferDuration; /* PCM buffer size in mini-second unit, and up to a maximun size */

#if defined (CONFIG_UTOPIA_ANDROID_L)
    MS_VIRT u32ReadPtr; /* PCM read pointer */
#else
    MS_U32 u32ReadPtr; /* PCM read pointer */
#endif

#if defined (CONFIG_UTOPIA_ANDROID_L)
    MS_VIRT u32WritePtr; /* PCM write pointer */
#else
    MS_U32 u32WritePtr; /* PCM write pointer */
#endif
     ...
     * Note!!!
     *
     * 1. No matter what kind of modification in this structure, "AUDIO_PCM_INFO_t" must be updated as well!!!
     *
