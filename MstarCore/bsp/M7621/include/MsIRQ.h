...
typedef enum
{
    ...
    E_INT_IRQ_TSIO_INT                  = E_INT_IRQ_0x160_START + 7,    //K6
    E_INT_IRQ_SATA_PHY                  = E_INT_IRQ_0x160_START + 8,    //K6
    E_INT_IRQ_TSIO_LOC_DEC              = E_INT_IRQ_0x160_START + 9,    //K6
    E_INT_IRQ_PKA_ALL_INT               = E_INT_IRQ_0x160_START + 10,   //K6
    E_INT_IRQ_VIVALDI_V9_MIU_AL         = E_INT_IRQ_0x160_START + 11,   //K6
    E_INT_IRQ_PWD_STATUS_INT            = E_INT_IRQ_0x160_START + 12,   //K6
        E_INT_IRQ_0x160_END                 = 0x16F,

        E_INT_IRQ_0x170_START               = 0x170,
        E_INT_IRQ_GMAC                      = E_INT_IRQ_0x170_START + 0,    //Curry
    E_INT_FIQ_SEC_TIMER0            = E_INT_IRQ_0x170_START + 1,    //K6
    E_INT_FIQ_SEC_TIMER1            = E_INT_IRQ_0x170_START + 2,    //K6
    E_INT_FIQ_SEC_GUARD_INT         = E_INT_IRQ_0x170_START + 3,    //K6
    E_INT_FIQ_USB_INT_P0            = E_INT_IRQ_0x170_START + 4,    //K6
    E_INT_FIQ_UHC_INT_P0            = E_INT_IRQ_0x170_START + 5,    //K6
    E_INT_FIQ_USB30_SS_INT            = E_INT_IRQ_0x170_START + 6,    //K6
    E_INT_FIQ_OTG_INT_P0            = E_INT_IRQ_0x170_START + 7,    //K6
    E_INT_FIQ_USB_INT_P1            = E_INT_IRQ_0x170_START + 8,    //K6
    E_INT_FIQ_UHC_INT_P1            = E_INT_IRQ_0x170_START + 9,    //K6
    E_INT_FIQ_USB31_HS_USB_INT        = E_INT_IRQ_0x170_START + 10,   //K6
    E_INT_FIQ_USB30_HS_UHC_INT        = E_INT_IRQ_0x170_START + 11,   //K6
    E_INT_FIQ_MIU_CMA_CLR                = E_INT_IRQ_0x170_START + 12,    //K6
    E_INT_FIQ_TSP_SPARE_CA2PM_8         = E_INT_IRQ_0x170_START + 13,   //K6
    E_INT_FIQ_MIU_NS                    = E_INT_IRQ_0x170_START + 14,   //K6
    E_INT_IRQ_0x170_END                 = 0x17F,


    E_INT_IRQ_0x180_START           = 0x180,
    E_INT_FIQ_TS0_VLD               = E_INT_IRQ_0x180_START + 0,    //K6Lite
    E_INT_FIQ_TS1_VLD                = E_INT_IRQ_0x180_START + 1,    //K6Lite
    E_INT_FIQ_TS2_VLD                = E_INT_IRQ_0x180_START + 2,    //K6Lite
    E_INT_FIQ_TS3_VLD                 = E_INT_IRQ_0x180_START + 3,    //K6Lite
    E_INT_FIQ_TS4_VLD                = E_INT_IRQ_0x180_START + 4,    //K6Lite
    E_INT_FIQ_TS5_VLD                = E_INT_IRQ_0x180_START + 5,    //K6Lite
    E_INT_FIQ_TS3_CLK                = E_INT_IRQ_0x180_START + 6,    //K6Lite
    E_INT_FIQ_TS4_CLK                = E_INT_IRQ_0x180_START + 7,    //K6Lite
    E_INT_FIQ_TS5_CLK                = E_INT_IRQ_0x180_START + 8,    //K6Lite
    E_INT_FIQ_TS6_CLK                = E_INT_IRQ_0x180_START + 9,    //K6Lite
    E_INT_IRQ_0x180_END             = 0x18a,
