...
/// @param  u8MapMode     \b IN: Mapping type and Mapping world (0:MSOS_CACHE_BOTH ,1:MSOS_NON_CACHE_BOTH ,2:MSOS_CACHE_USERSPACE , 3: MSOS_NON_CACHE_USERSPACE, 4:MSOS_CACHE_KERNEL, 5:MSOS_NON_CACHE_KERNEL)
/// @return TRUE : succeed
/// @return FALSE : fail due to invalide parameter
//-------------------------------------------------------------------------------------------------
