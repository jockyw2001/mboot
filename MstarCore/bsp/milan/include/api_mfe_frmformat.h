...
{
    unsigned int Cur_PhyY0;
    unsigned char* Cur_VirY0;
    unsigned int Cur_PhyC0;
    unsigned char* Cur_VirC0;
    unsigned int Cur_PhyY1;
    unsigned char* Cur_VirY1;
    unsigned int Cur_PhyC1;
    unsigned char* Cur_VirC1;
...
typedef struct _MS_MfeAdvInfo
{
    ...
    unsigned int has_exif;
    unsigned int framerate_change;
...
{
    unsigned char starcode[5]; //must be 0x00,0x00,0x00,0x01,0x47
