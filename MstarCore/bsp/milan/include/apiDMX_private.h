...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_LIVEAB_EN)(MS_BOOL);
typedef MS_BOOL           (*IOCTL_DMX_IS_LIVEAB_EN)(void);
...
typedef struct _MMFI_INSTANT_PRIVATE
{
    ...
    IOCTL_DMX_LIVEAB_EN                     fpDMXLiveABEn;
    IOCTL_DMX_IS_LIVEAB_EN                  fpDMXIsLiveABEn;
...
DMX_FILTER_STATUS _MApi_DMX_LiveAB_En(MS_BOOL bPF_EN);
MS_BOOL           _MApi_DMX_IsLiveAB_Enable(void);
