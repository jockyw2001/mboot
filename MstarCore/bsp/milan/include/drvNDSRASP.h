...
typedef enum //_DrvRASP_RecMode
{
    ...
    // Record Payload
    E_DRVRASP_REC_MODE_PAYLOAD  = 0x00000002,
    // Record ECM
    E_DRVRASP_REC_MODE_ECM  = 0x00000003,
} DrvRASP_RecMode;
...
#endif
MS_U32 NDS_RASP_CtrlConfig(MS_U32 u32RASPEng, DrvRASP_RecMode eRecMode, MS_BOOL bEnable);
...
MS_U32 NDS_RASP_AllocFlt(MS_U32 u32RASPEng, MS_U32 *pu32PidFltId);
MS_U32 NDS_RASP_FreeFlt(MS_U32 u32RASPEng, MS_U32 u32PidFltId);
MS_U32 NDS_RASP_AllocECMFlt(MS_U32 u32RASPEng, MS_U32 *pu32ECMFltId);
MS_U32 NDS_RASP_FreeECMFlt(MS_U32 u32RASPEng, MS_U32 u32ECMFltId);
...
MS_U32 NDS_RASP_SetPayload(MS_U32 u32RASPEng, MS_U16 u16Flt, MS_U32 u32Payload);
