...
#ifdef UFO_SWI2C_CONFIG
///Define SWI2C configuration commands
...
#ifdef UFO_SWI2C_CONFIG
////////////////////////////////////////////////////////////////////////////////
/// Configure SWI2C parameters including transaction delay, sendbyte delay, or else
/// @ cfg : \b IN, configured parameter structure
/// @return MS_BOOL: 
/// - TRUE: Success
/// - FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
MS_BOOL MApi_SWI2C_Configure(SWI2C_Config cfg);
#endif
