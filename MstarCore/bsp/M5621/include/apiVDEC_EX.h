...
#define VDEC_CAP_HEVC_HDR_V3//for old DV display path(by vsync bridge ext)
#define VDEC_CAP_FRAME_INFO_EXT_V4//V4: for new DV display path(by XC shm)
#define VDEC_CAP_FRAME_INFO_EXT_V5//V5: for new DV display path(by XC shm)
...
#define VDEC_CAP_SYSTEM_PREGET_API//PREGET_API: support preget control api
#define VDEC_CAP_DV_OTT_API //DV OTT API: set/get DV informaiton
#define VDEC_CAP_DV_OTT_API_V2 //DV OTT API2: set/get DV informaiton
...
typedef enum
{
    ...
    E_VDEC_EX_USER_CMD_SET_DV_INFO,  //Set DV information
#endif
    ...
    E_VDEC_EX_USER_CMD_SET_CODEC_CONFIG,                // VP9 HDR info, or other config data for video decoder
    ...
    E_VDEC_EX_USER_CMD_GET_DISP_QUEUE_EMPTY, //Get Display queue status
    E_VDEC_EX_USER_CMD_GET_NOT_SUPPORT_INFO,  // Get detail information when check  error code for out of spec or resolution not support
    ...
    E_VDEC_EX_USER_CMD_SET_BUFFER_INFO,                 //Param: VDEC_EX_BufferInfo
...
#ifdef VDEC_CAP_SYSTEM_PREGET_API///Support Preget command api
#ifdef VDEC_CAP_DV_OTT_API///Support Preget command to get DV profile
    E_VDEC_EX_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_PROFILE,///preget DV support profile
    E_VDEC_EX_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_LEVEL,///preget DV support level
#endif
#endif
...
#ifdef VDEC_CAP_DV_OTT_API
///DV meta data reorder info
typedef enum
{
    E_VDEC_EX_DV_META_REORDER_DEFAULT,///dv meta data reorder use default
    E_VDEC_EX_DV_META_REORDER_FOLLOW_BL, ///dv meta data reorder follow BL
    E_VDEC_EX_DV_META_REORDER_FOLLOW_EL, ///dv meta data reorder follow EL
} VDEC_EX_DV_METADATA_REORDER;
///DV related cmd enum
typedef enum
{
    E_VDEC_EX_GET_DV_SUPPORT_PROFILE = 0,///Get support profile
    E_VDEC_EX_GET_DV_SUPPORT_LEVEL, ///Get support level
    E_VDEC_EX_SET_DV_INFO,///set profile and level
} VDEC_EX_DV_CMD_TYPE;
///DV profile ID
typedef enum
{
    /// Profile ID not support
...
typedef enum
{
    /// Stream Level ID unsupported
    E_VDEC_EX_DV_STREAM_LEVEL_ID_UNSUPPORTED = 0,
     /// Stream Level ID HD Frame Rate 24
    E_VDEC_EX_DV_STREAM_LEVEL_ID_HD24,
     /// Stream Level ID HD Frame Rate 30
    E_VDEC_EX_DV_STREAM_LEVEL_ID_HD30,
     /// Stream Level ID FHD Frame Rate 24
    E_VDEC_EX_DV_STREAM_LEVEL_ID_FHD24,
     /// Stream Level ID FHD Frame Rate 30
    E_VDEC_EX_DV_STREAM_LEVEL_ID_FHD30,
     /// Stream Level ID FHD Frame Rate 60
    E_VDEC_EX_DV_STREAM_LEVEL_ID_FHD60,
     /// Stream Level ID UHD Frame Rate 24
    E_VDEC_EX_DV_STREAM_LEVEL_ID_UHD24,
     /// Stream Level ID UHD Frame Rate 30
    E_VDEC_EX_DV_STREAM_LEVEL_ID_UHD30,
     /// Stream Level ID UHD Frame Rate 48
    E_VDEC_EX_DV_STREAM_LEVEL_ID_UHD48,
     /// Stream Level ID UHD Frame Rate 60
...
typedef enum
{
    E_VDEC_EX_STC0=0, ///STC 0
    E_VDEC_EX_STC1, // /STC 1
}VDEC_EX_STCMode;
...
typedef struct
{
    MS_U32 u32DVSupportProfiles; ///DV Suppor profiles
    VDEC_EX_DV_Stream_Profile eDVProfile; ///DV profile
    VDEC_EX_DV_Stream_Highest_Level eDVLevel; ///DV level
#ifdef VDEC_CAP_DV_OTT_API_V2
    VDEC_EX_DV_METADATA_REORDER eDVMetaReorder; ///DV meta data reorder
#else
    VDEC_EX_DV_CMD_TYPE eDVCmdType; /// DV cmd type
#endif
}VDEC_EX_DV_Info;
#endif
...
//for old DV display path(by vsync bridge ext)
typedef struct DLL_PACKED
{
    /// FrameInfo structure
    VDEC_EX_FrameInfoExt sFrameInfoExt;
...
///V4: for new DV display path(by XC srm)
typedef struct DLL_PACKED
{
    /// FrameInfo structure
    VDEC_EX_FrameInfoExt_v3 sFrameInfoExt_v3;
    //// Dolby Vision HDR ////////////
    /// Dolby Vision current Index
...
///V5: for new DV display path(by XC srm)
typedef struct DLL_PACKED
{
     /// FrameInfo structure
...
///V6: for new DV display path(by XC srm)
typedef struct DLL_PACKED
{
    /// FrameInfo structure
...
//------------------------------------------------------------------------------
/// Set mstar VDEC frame buffer
/// @param u32FrmBufAddr \b IN : Frame Buffer Addr ,
/// @param u32FrmBufSize \b IN :Frame Buffer Size ,
/// @ingroup VDEC_ES_buffer_manage VDEC ES buffer manage
/// @return VDEC_EX_Result
///     - E_VDEC_EX_OK: Success
///     - E_VDEC_EX_FAIL: Failed
//------------------------------------------------------------------------------
void MApi_VDEC_EX_SetFrameBuffer(MS_U32 u32FrmBufAddr,MS_U32 u32FrmBufSize);///Set all of frame buffer to vdec
/// Get mstar VDEC
/// @param u8TaskId \b IN : Task ID
/// @param bUHD \b IN :IsUHD ,
/// @param bFileMode \b IN : File mode ,
/// @param u32FrmBufAddr \b out :Frame Buffer Addr ,
/// @param u32FrmBufSize \b out :Frame Buffer Size ,
/// @ingroup VDEC_ES_buffer_manage VDEC ES buffer manage
/// @return VDEC_EX_Result
///     - E_VDEC_EX_OK: Success
///     - E_VDEC_EX_FAIL: Failed
//------------------------------------------------------------------------------
void MApi_VDEC_EX_GetFrmInfoByTask(MS_U8 u8TaskId,MS_BOOL bUHD,MS_BOOL bFileMode,MS_U32* u32FrmBufAddr,MS_U32* u32FrmBufSize);///Get Frame info by task
#endif
