...
//-------------------------------------------------------------------------------------------------
/// Allocate resource of TSP
/// @ingroup TSP_General
/// @param  eResType      \b IN: Resource select: STC engine
/// @param  pRes          \b IN: Pointer to returned resource
/// @return DMX_FILTER_STATUS_OK - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
//-------------------------------------------------------------------------------------------------
DMX_FILTER_STATUS SYMBOL_WEAK MApi_DMX_ResAllocate(DMX_RES_TYPE eResType, void *pRes);
//-------------------------------------------------------------------------------------------------
/// Free resource of TSP
/// @ingroup TSP_General
/// @param  eResType      \b IN: Resource select: STC engine
/// @param  pRes          \b IN: Pointer to returned resource
/// @return DMX_FILTER_STATUS_OK - Success
...
//-------------------------------------------------------------------------------------------------
/// Get STC engine ID from PCR filter ID
/// @ingroup TSP_General
/// @param  u32PcrFltId      \b IN: PCR filter ID
/// @param  pu32StcEng       \b IN: Pointer to returned STC engine ID
/// @return DMX_FILTER_STATUS_OK - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
//-------------------------------------------------------------------------------------------------
