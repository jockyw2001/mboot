...
/// @param  pXC_EX_InitData                  \b IN: the Initialized Data
/// @return @ref XC_EX_RETURN_VALUE
//-------------------------------------------------------------------------------------------------
XC_EX_RETURN_VALUE SYMBOL_WEAK MApi_XC_EX_GetConfig(XC_DEVICE_ID *pDeviceId, XC_EX_INITDATA *pXC_EX_InitData);
