...
typedef enum
{
    ...
    VDEC_USER_CMD_SET_DV_INFO, // set DV information
#endif
    ...
    VDEC_USER_CMD_GET_DISP_QUEUE_EMPTY,  // Get display queue status
    VDEC_USER_CMD_GET_NOT_SUPPORT_INFO,  // Get detail information when check  error code for out of spec or resolution not support
    ...
    VDEC_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_PROFILE, ///preget DV support profile
    VDEC_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_LEVEL, ///preget DV support level
#endif
#endif
} VDEC_User_Cmd;
