...
typedef enum
{
    ...
    API_AUDIO_CUSTOMER_HDMI_TX_OUTPUT_EAC3_BYPASS,               ///< HDMI OUTPUT DDP Bypass
...
typedef enum
{
    ...
    //---Delay---
    API_AUDIO_CUSTOMER_COMMON_INFO_AUDIO_DELAY                      = 17, //<--MAX is here!!!

    //---MAX---
    API_AUDIO_CUSTOMER_INFO_MAX = API_AUDIO_CUSTOMER_COMMON_INFO_AUDIO_DELAY + 1,
...
{                                                                                                           // |        |        |DTS_StudioSound_3D |Default               Range                               Description
    ...
    API_AUDIO_CUSTOMER_DTS_SE_PARAM_PURESOUND_HL_LIMITERBOOST_FXP24                     = 41,               // |        |        |        V          |2.5                   0x7FFFFF ~ 0xFFFFFE0 (1.0 ~ 32.0)   HardLimiter BoostGain. Modifies the signal level within the context of the HardLimiter, so that the signal will not exceed the Hard Limit Level parameter
