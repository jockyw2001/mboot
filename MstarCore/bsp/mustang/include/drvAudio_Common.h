...
typedef struct
{
    ...
    MS_U32 u32Volume;
} AUDIO_PCM_SWMIXER_SERVER_INTERNAL_INFO_t;

typedef struct
{
    AUDIO_PCM_SWMIXER_SERVER_INTERNAL_INFO_t tInternelInfo[AUDIO_PCM_MAXIMUM];
    void *pRsrcElement[AUDIO_PCM_MAXIMUM];
    MS_S16 s16RsrcBuffer[AUDIO_PCM_MAXIMUM][AUDIO_PCM_SWMIXER_OUTPUT_SIZE_MAXIMUM*2]; // 2 ch per element
    MS_S32 s32YL[AUDIO_PCM_MAXIMUM][2];
    MS_S32 s32GL[AUDIO_PCM_MAXIMUM][2];
    MS_S32 s32MaxDelay;
    MS_S32 s32MaxOutSize;
} AUDIO_PCM_SWMIXER_SERVER_INTERNAL_HANDLE_t;
...
//================================================================
// Audio SW Mixer Relational Function
//================================================================
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Get_SramSize(void);
void * MDrv_AUDIO_SwMixer_Kernel_Init(void *pHeap);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Process(void *pHandle, MS_S32 s32MixerServerId, MS_S16 *pOutputBuffer);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Get_InputSize(void *pHandle, MS_S32 s32DeviceId, MS_S32 s32OutputSize);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Get_OutputSize(void *pHandle, MS_S32 s32DeviceId, MS_S32 s32InputSize);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Samplerate2Index(MS_U32 u32SampleRate);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Get_MaxOutputSize(void *pHandle, MS_S32 s32MixerServerId);
void MDrv_AUDIO_SwMixer_Kernel_Set_MaxOutputSize(void *pHandle, MS_S32 s32Size);
MS_S32 MDrv_AUDIO_SwMixer_Kernel_Get_MaxFrameTime(MS_U32 s32MixerServerId);
