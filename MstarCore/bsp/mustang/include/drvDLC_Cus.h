...
#if defined(UFO_PUBLIC_HEADER_700) || defined(UFO_PUBLIC_HEADER_500) || defined(UFO_PUBLIC_HEADER_500_3)
...
} DLC_HDRMetadataSeiContentLightLevel;
...
typedef struct __attribute__((packed))
{
    ...
    DLC_HDRMetadataSeiContentLightLevel DLC_HDRMetadataSeiContentLightLevel;
#endif
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: MDrv_DLC_GetHDRInit()
/// @brief \b Function \b Description: Get HDR Init Info
/// @param <IN>        \b None
/// @param <OUT>       \b None
/// @param <RET>       \b None
/// @param <GLOBAL>    \b None
////////////////////////////////////////////////////////////////////////////////
MS_BOOL MDrv_DLC_GetHDRInit(DLC_HDRinit * pstDLC_HDRInitData);
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: MDrv_DLC_GetAverageValueSub()
/// @brief \b Function \b Description:  Get Average exactness of Luminous Value for sub window
/// @param <IN>        \b None
/// @param <OUT>       \b None
/// @param <RET>       \b uwTmpAvr
/// @param <GLOBAL>    \b None
////////////////////////////////////////////////////////////////////////////////
MS_U8   MDrv_DLC_GetAverageValueSub(void );
