...
#endif
    E_MVOP_CMD_SET_GAME_MODE,                   ////<0x122 Set game mode for mvop fps 120, from clippers.
    E_MVOP_CMD_SET_FORCE_P_MODE,                ////<0x123 Set MVOP is force p mode for bbc ip change.
