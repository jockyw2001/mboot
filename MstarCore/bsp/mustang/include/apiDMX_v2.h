...
typedef enum {
    ...
    MApi_CMD_DMX_TSIO_Service_DMAin_PidOpen = 320,      /// pointer to (DMX_TSIO_Service_DMAin_PidOpen_PARAM)
    MApi_CMD_DMX_TSIO_Service_DMAin_PidClose = 321,     /// pointer to (DMX_TSIO_Service_DMAin_PidClose_PARAM)
} eDmxIoctlOpt;
