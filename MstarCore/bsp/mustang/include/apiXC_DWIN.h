...
typedef enum
{
    ...
    ///< Top field only.
    DIP_DATA_FMT_DI_YUV422_FIELDTYPE_TOP,
    ///< Bottom field only.
    DIP_DATA_FMT_DI_YUV422_FIELDTYPE_BOTTOM,
    ///< Both fields Arrangement with Top -> Bottom
    DIP_DATA_FMT_DI_YUV422_FIELDTYPE_TOP_BOTTOM_BOTH,
    ///< Both fields Arrangement with Bottom -> Top
    DIP_DATA_FMT_DI_YUV422_FIELDTYPE_BOTTOM_TOP_BOTH,
    DIP_DATA_FMT_MAX
} EN_XC_DIP_DATA_FMT;
