...
#define GOP_INFO(x, args...) ULOGI("GOP API", x, ##args)
// Warning, illegal paramter but can be self fixed in functions
#define GOP_WARN(x, args...) ULOGW("GOP API", x, ##args)
//  Need debug, illegal paramter.
#define GOP_DBUG(x, args...) ULOGD("GOP API", x, ##args)
// Error, function will be terminated but system not crash
#define GOP_ERR(x, args...) ULOGE("GOP API", x, ##args)
// Critical, system crash. (ex. assert)
#define GOP_FATAL(x, args...) ULOGF("GOP API", x, ##args)
