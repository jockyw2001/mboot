...
#endif
{
    ...
    MS_U32                      u32AlignDummy[2];   //align size for MI init share mem size check fail
#endif
#endif
    MS_U32                      Type2NotifyParam1;  ///< DMX section callback
} DMX_Sect_info;

/// DMX section filter information structure_EX
typedef struct DLL_PACKED
{
    ...
    DMX_SECT_MODE               SectMode;           ///< DMX section mode
    DMX_EVENT                   Event;              ///< DMX section event
    DMX_Type2NotifyCb_Ex        pType2Notify_Ex;    ///< DMX section callback (type2)
...
/// DMX filter information structure_EX
typedef struct DLL_PACKED
{
...
/// @return UTOPIA_STATUS_ERR_NOT_AVAIL: DMX system init ready
//-------------------------------------------------------------------------------------------------
...
/// @ingroup TSP_FIQ
/// @param u32FQEng        \b IN : FQ engine id
/// @param pRead           \b OUT: The pointer to store the obtained FIQ File-in read pointer
/// @return DMX_FILTER_STATUS_OK    - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
//-------------------------------------------------------------------------------------------------
...
/// @ingroup TSP_FIQ
/// @param u32FQEng        \b IN : FQ engine id
/// @param pWrite          \b OUT: The pointer to store the obtained FIQ PVR write pointer
/// @return DMX_FILTER_STATUS_OK    - Success
/// @return DMX_FILTER_STATUS_ERROR - Failure
//-------------------------------------------------------------------------------------------------
