...
#define SPI_4BYTE_ADDR_BOUND    0x01000000
#define SPI_3BYTE_ADDR_MASK     0x00FFFFFF
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC const SERFLASH_Info *MDrv_SERFLASH_GetInfo(void);
...
/// @return FALSE : failed
//------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_GetLibVer(const MSIF_Version **ppVersion);
...
//------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_GetStatus(SERFLASH_DrvStatus* pDrvStatus);
...
//------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SetDbgLevel(MS_U8 u8DbgLevel);
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SetWPInfo(MS_BOOL bWPInfo);
...
/// @return NULL :
//------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SERFLASH_SetMcuCSCallBack(ms_Mcu_ChipSelect_CB ChipSel_cb);
DLL_PUBLIC void MDrv_SERFLASH_SetFlashWPCallBack(ms_Flash_SetHWWP_CB FlashWP_cb);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_DetectType(void);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_DetectSize(MS_U32 *u32FlashSize);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_Set2XRead(MS_BOOL b2XMode);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SetCKG(SPI_DrvCKG eCKGspi);
...
/// @note
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SERFLASH_ClkDiv(SPI_DrvClkDiv eClkDivspi);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SetMode(MS_BOOL bXiuRiu);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_U64 MDrv_SERFLASH_ReadUID(void);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_ChipSelect(MS_U8 u8FlashIndex);

//-------------------------------------------------------------------------------------------------
/// Initialize Serial Flash
/// @return None
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SERFLASH_Init(void);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_ReadID(MS_U8 *pu8FlashID, MS_U32 u32IDSize);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_Read(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer);

//-------------------------------------------------------------------------------------------------
/// Description : Read data from Serial Flash
/// @param  u32OTPAddr    \b IN: Flash Address
/// @param  u32OTPSize    \b IN: Flash Size Data in Bytes
/// @param  u32OTPSize    \b OUT: Virtual Buffer Address ptr to store flash read data
/// @return TRUE : succeed
/// @return FALSE : fail before timeout or illegal parameters
/// @note   Not allowed in interrupt context
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
MS_BOOL MDrv_SERFLASH_ReadOTP(MS_U32 u32OTPAddr, MS_U32 u32OTPSize, MS_U8 *pu8OTPData);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_EraseChip(void);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_AddressToBlock(MS_U32 u32FlashAddr, MS_U32 *pu32BlockIndex);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_BlockToAddress(MS_U32 u32BlockIndex, MS_U32 *pu32FlashAddr);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_AddressErase(MS_U32 u32StartAddr, MS_U32 u32EraseSize, MS_BOOL bWait);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_BlockErase(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bWait);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SectorErase(MS_U32 u32StartAddr, MS_U32 u32EndAddr);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_CheckWriteDone(void);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_Write(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_DMA(MS_U32 u32FlashStart, MS_U32 u32DRAMStart, MS_U32 u32Size);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect(MS_BOOL bEnable);

//-------------------------------------------------------------------------------------------------
/// Description : Spasion flash DYB unlock
/// @return TRUE : succeed
/// @return FALSE : fail before timeout
/// @note
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SPSNDYB_UNLOCK(void);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect_Enable_All_Range(void);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect_Disable_All_Range(void);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect_Disable_Range_Set(MS_U32 u32DisableLowerBound, MS_U32 u32DisableSize);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect_Area(MS_BOOL bEnableAllArea, MS_U8 u8BlockProtectBits);
...
/// @note   Not allowed in interrupt context
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_ReadStatusRegister(MS_U8 *pu8StatusReg);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_ReadStatusRegister2(MS_U8 *pu8StatusReg);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteStatusRegister(MS_U16 u16StatusReg);
...
/// [fw : drvBDMA ]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_CopyHnd(MS_PHYADDR u32FlashAddr, MS_PHYADDR u32DstAddr, MS_U32 u32Len, SPIDMA_Dev eDstDev, MS_U8 u8OpCfg);
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SERFLASH_SetGPIO(MS_BOOL bSwitch);

//-------------------------------------------------------------------------------------------------
//  WRAPPER FOR CHAKRA
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_WriteProtect_Area_Lookup(MS_U32 u32ProtectSpace, MS_U32 u32NonProtectSpace, MS_U8 *pu8BlockProtectBits);
DLL_PUBLIC MS_U32 MDrv_SERFLASH_WriteProtect_Area_Boundary(void);

DLL_PUBLIC MS_BOOL MDrv_FLASH_Write(MS_U32 u32FlashAddr,MS_U32 u32FlashSize,MS_U8 * user_buffer);
DLL_PUBLIC MS_BOOL MDrv_FLASH_Read(MS_U32 u32FlashAddr,MS_U32 u32FlashSize,MS_U8 * user_buffer);
DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteProtect(MS_BOOL bEnable);

DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteProtect_Enable_All_Range(void);
DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteProtect_Disable_All_Range(void);
DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteProtect_Disable_Range_Set(MS_U32 DisableLowerBound, MS_U32 DisableSize);
DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteProtect_Area(MS_BOOL bEnableAllArea, MS_U8 BlockProtectBits);
DLL_PUBLIC MS_BOOL MDrv_FLASH_ReadStatusRegister(MS_U8 *pu8StatusReg);
DLL_PUBLIC MS_BOOL MDrv_FLASH_ReadStatusRegister2(MS_U8 *pu8StatusReg);
DLL_PUBLIC MS_BOOL MDrv_FLASH_WriteStatusRegister(MS_U16 u16StatusReg);

DLL_PUBLIC MS_BOOL MDrv_FLASH_DetectType(void);
DLL_PUBLIC MS_BOOL MDrv_FLASH_DetectSize(MS_U32 *u32FlashSize);
DLL_PUBLIC MS_BOOL MDrv_FLASH_AddressToBlock(MS_U32 u32FlashAddr, MS_U32 *pu32BlockIndex);
DLL_PUBLIC MS_BOOL MDrv_FLASH_BlockToAddress(MS_U32 u32BlockIndex, MS_U32 *pu32FlashAddr);
DLL_PUBLIC MS_BOOL MDrv_FLASH_AddressErase(MS_U32 u32StartAddr,MS_U32 u32EraseSize,MS_BOOL bWait);
DLL_PUBLIC MS_BOOL MDrv_FLASH_BlockErase(MS_U16 u16StartBlock,MS_U16 u16EndBlock,MS_BOOL bWait);
DLL_PUBLIC MS_BOOL MDrv_FLASH_CheckWriteDone(void);
DLL_PUBLIC MS_BOOL MDrv_FLASH_Attribute(SPI_Attribute SpiAttri);

#ifdef MXIC_IBPM
DLL_PUBLIC void MDrv_SERFLASH_EnterIBPM(void);
DLL_PUBLIC MS_U8 MDrv_SERFLASH_ReadBlockStatus(MS_PHYADDR u32FlashAddr);
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SingleBlockProtect(MS_PHYADDR u32FlashAddr,MS_BOOL bLock);
DLL_PUBLIC MS_U32 MDrv_SERFLASH_MultiBlockProtect(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bLock);
#endif

#ifdef MUNINN_ENABLE
DLL_PUBLIC MS_U8 MDrv_OTP_ReadStatusReg(MS_U8 u8ByteAddr);
DLL_PUBLIC void MDrv_OTP_WriteStatusReg(MS_U8 u8ByteAddr, MS_U8 u8ByteReg);
DLL_PUBLIC MS_PHYADDR MDrv_OTP_Read(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer);
DLL_PUBLIC MS_PHYADDR MDrv_OTP_FastRead(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer);
DLL_PUBLIC MS_PHYADDR MDrv_OTP_Write(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer);
DLL_PUBLIC MS_BOOL MDrv_OTP_WriteTestMode(MS_U32 u32FlashAddr, MS_U8 ByteData);
#endif

// FSP
DLL_PUBLIC MS_BOOL MDrv_FSP_WriteData(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data);
DLL_PUBLIC MS_BOOL MDrv_FSP_ReadData(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data);
DLL_PUBLIC MS_BOOL MDrv_FSP_BlockErase(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bWait);
DLL_PUBLIC MS_BOOL MDrv_FSP_AddressErase(MS_U32 u32StartAddr, MS_U32 u32EraseSize, MS_BOOL bWait);

DLL_PUBLIC MS_BOOL MDrv_SERFLASH_SetEnvStartAddr(MS_U32 u32StartAddr);
