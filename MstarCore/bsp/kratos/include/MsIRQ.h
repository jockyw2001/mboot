...
typedef enum
{
    ...
    E_INT_IRQ_CA_RSA_INT0               = E_INT_FIQ_0x60_START+4,   //Keltic / Kaiser
    ...
    E_INT_IRQ_SAR1                       = E_INT_IRQ_0xB0_START+15,  //Kratos
    E_INT_IRQ_IDAC_PLUG_DET             = E_INT_IRQ_0xB0_START+15,  //Kenya
    ...
    E_INT_FIQ_LAN_ESD                   = E_INT_FIQ_0xD0_START+0,   //Kenya
    E_INT_FIQ_GPIO0                     = E_INT_FIQ_0xD0_START+1,   //T12
    E_INT_FIQ_REQ_HST0_TO_3             = E_INT_FIQ_0xD0_START+1,   //Kenya
    E_INT_FIQ_GPIO1                     = E_INT_FIQ_0xD0_START+2,   //T12
    E_INT_FIQ_REQ_HST0_TO_2             = E_INT_FIQ_0xD0_START+2,   //Kenya
    E_INT_FIQ_GPIO2                     = E_INT_FIQ_0xD0_START+3,   //T12
    E_INT_FIQ_REQ_HST0_TO_1             = E_INT_FIQ_0xD0_START+3,   //Kenya
    E_INT_FIQ_GPIO3                     = E_INT_FIQ_0xD0_START+4,   //T12
    E_INT_FIQ_ERROR_RASP                = E_INT_FIQ_0xD0_START+4,   //Kenya
    E_INT_FIQ_GPIO4                     = E_INT_FIQ_0xD0_START+5,   //T12
    E_INT_FIQ_REQ_HST1_TO_3             = E_INT_FIQ_0xD0_START+5,   //Kenya
    E_INT_FIQ_GPIO5                     = E_INT_FIQ_0xD0_START+6,   //T12
    E_INT_FIQ_REQ_HST1_TO_2             = E_INT_FIQ_0xD0_START+6,   //Kenya
    E_INT_FIQ_GPIO6                     = E_INT_FIQ_0xD0_START+7,   //T12
    E_INT_FIQ_REQ_HST1_TO_0             = E_INT_FIQ_0xD0_START+7,   //Kenya
    E_INT_FIQ_GPIO7                     = E_INT_FIQ_0xD0_START+8,   //T12
    E_INT_FIQ_REQ_HST2_TO_3             = E_INT_FIQ_0xD0_START+8,   //Kenya
    E_INT_FIQ_VE_VSYNC_IN               = E_INT_FIQ_0xD0_START+9,   //Agate
    E_INT_FIQ_REQ_HST2_TO_1             = E_INT_FIQ_0xD0_START+9,   //Kenya
    E_INT_FIQEXPL_HST0_TO_3             = E_INT_FIQ_0xD0_START+10,  //Agate
    E_INT_FIQ_REQ_HST2_TO_0             = E_INT_FIQ_0xD0_START+10,  //Kenya
    E_INT_FIQEXPL_HST1_TO_3             = E_INT_FIQ_0xD0_START+11,  //Agate
    E_INT_FIQ_REQ_HST3_TO_2             = E_INT_FIQ_0xD0_START+11,  //Kenya
    E_INT_FIQEXPL_HST2_TO_3             = E_INT_FIQ_0xD0_START+12,  //Agate
    E_INT_FIQ_REQ_HST3_TO_1             = E_INT_FIQ_0xD0_START+12,  //Kenya
    E_INT_FIQEXPH_CMDQ                  = E_INT_FIQ_0xD0_START+13,  //Agate
    E_INT_FIQ_REQ_HST3_TO_0             = E_INT_FIQ_0xD0_START+13,  //Kenya
