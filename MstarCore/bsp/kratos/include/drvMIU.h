...
// Extern Functions
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void    MDrv_MIU_Mask_Req_OPM_R(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_DNRB_R(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_DNRB_W(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_DNRB_RW(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_SC_RW(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_MVOP_R(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_MVD_R(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_MVD_W(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_MVD_RW(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_Mask_Req_AUDIO_RW(MS_U8 u8Mask, MS_U8 u8Miu);
DLL_PUBLIC void    MDrv_MIU_MaskReq(MS_U8 u8Miu, eMIUClientID eClientID);
DLL_PUBLIC void    MDrv_MIU_UnMaskReq(MS_U8 u8Miu, eMIUClientID eClientID);
DLL_PUBLIC void    MDrv_MIU_InitCounter(void);
DLL_PUBLIC void    MDrv_MIU_VOP_SwitchMIU(MS_U8 u8MiuID);
DLL_PUBLIC void    MDrv_MIU_PrintMIUProtectInfo(void);
DLL_PUBLIC MS_U8*  MDrv_MIU_GetDefaultClientID_KernelProtect(void);
DLL_PUBLIC MS_U16  MDrv_MIU_GetBusWidth(void);
DLL_PUBLIC MS_BOOL MDrv_MIU_SetSsc(MS_U16 u16Fmodulation, MS_U16 u16FDeviation,MS_BOOL bEnable);
DLL_PUBLIC MS_BOOL MDrv_MIU_SetSscValue(MS_U8 u8MiuDev, MS_U16 u16Fmodulation, MS_U16 u16FDeviation, MS_BOOL bEnable);
DLL_PUBLIC MS_BOOL MDrv_MIU_GetClientID(euMIUClientIDTYPE client_name, stMIUClientID_t *client_read, stMIUClientID_t *client_write);
DLL_PUBLIC MS_BOOL MDrv_MIU_Mask(euMIUClientIDTYPE client_name);
DLL_PUBLIC MS_BOOL MDrv_MIU_Unmask(euMIUClientIDTYPE client_name);
DLL_PUBLIC MS_BOOL MDrv_MIU_MaskByPort(euMIUClientIDTYPE client_name,stMIUClientID_t *ByPort);
DLL_PUBLIC MS_BOOL MDrv_MIU_UnmaskByPort(euMIUClientIDTYPE client_name,stMIUClientID_t *ByPort);
DLL_PUBLIC MS_BOOL MDrv_MIU_SetIOMapBase(void);
DLL_PUBLIC MS_BOOL MDrv_MIU_ProtectAlign(MS_U32 *u32PageShift);
DLL_PUBLIC MS_BOOL MDrv_MIU_Dram_Size(MS_U8 MiuID, MS_U8 DramSize);
DLL_PUBLIC MS_BOOL MDrv_MIU_Dram_ReadSize(MS_U8 MiuID, MIU_DDR_SIZE *pDramSize);
DLL_PUBLIC MS_U8 MDrv_MIU_ClinetNumber(MS_U8 u8Blockx);
DLL_PUBLIC MS_BOOL MDrv_MIU_Protect( MS_U8 u8Blockx, MS_U8 *pu8ProtectId, MS_U32 u32Start, MS_U32 u32End, MS_BOOL bSetFlag );
DLL_PUBLIC MS_BOOL MDrv_MIU_IsSupportMIU1(void);
DLL_PUBLIC MS_BOOL MDrv_MIU_SelMIU(eMIUClientID eClientID, eMIU_SelType eType);
DLL_PUBLIC MS_BOOL MDrv_MIU_GetClientInfo(MS_U8 u8MiuDev, eMIUClientID eClientID, MIU_ClientInfo *pInfo);
DLL_PUBLIC MS_BOOL MDrv_MIU_GetProtectInfo(MS_U8 u8MiuDev, MIU_PortectInfo *pInfo);
DLL_PUBLIC MS_BOOL MDrv_MIU_SetGroupPriority(MS_U8 u8MiuDev, MIU_GroupPriority sPriority);
DLL_PUBLIC MS_BOOL MDrv_MIU_SetHPriorityMask(MS_U8 u8MiuDev, eMIUClientID eClientID, MS_BOOL bMask);
DLL_PUBLIC MS_BOOL MDrv_MIU_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC MS_BOOL MDrv_MIU_EnableScramble(MS_BOOL bEnable);
DLL_PUBLIC MS_BOOL MDrv_MIU_IsScrambleEnabled(void);
DLL_PUBLIC MS_BOOL MDrv_MIU_Init(void);
DLL_PUBLIC MS_U32 MDrv_MIU_SetPowerState(EN_POWER_MODE u16PowerState);
DLL_PUBLIC MS_BOOL MDrv_MIU_GetClientWidth(MS_U8 u8MiuDevi, eMIUClientID eClientID, eMIU_ClientWidth *pClientWidth);
