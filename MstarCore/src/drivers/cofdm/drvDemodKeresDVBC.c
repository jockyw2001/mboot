...
#if ((defined(CONFIG_KERES) || defined(CONFIG_KIRIN))&&(FRONTEND_DEMOD_TYPE == EMBEDDED_DVBC_DEMOD))
#include "MsCommon.h"
#include "HbCommon.h"
...
#if ((FRONTEND_TUNER_TYPE == TUNER_PHILIPS_TDA18250HN) || (FRONTEND_TUNER_TYPE == TUNER_MXL603)|| (FRONTEND_TUNER_TYPE == TUNER_MXL608)  || (FRONTEND_TUNER_TYPE == TUNER_TDA18250AB) || (FRONTEND_TUNER_TYPE == TUNER_R836) ||(FRONTEND_TUNER_TYPE == TUNER_SI2147))
