...
static MS_BOOL _InitInternalDVBT2(void)
{
    ...
    else
    {
        ...
        printf("u32INTERNAL_DVBT2_TDI_ADR = 0x%x\n", u32INTERNAL_DVBT2_TDI_ADR);
        printf("u32INTERNAL_DVBT2_DJB_ADR = 0x%x\n", u32INTERNAL_DVBT2_DJB_ADR);
        printf("u32INTERNAL_DVBT2_EQ_ADR = 0x%x\n", u32INTERNAL_DVBT2_EQ_ADR);
        printf("u32INTERNAL_DVBT2_FW_ADR = 0x%x\n", u32INTERNAL_DVBT2_FW_ADR);
    }
#endif
