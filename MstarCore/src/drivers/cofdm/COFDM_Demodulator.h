...
#if (defined(CONFIG_KENYA)||defined(CONFIG_KERES)||defined(CONFIG_KIRIN)||defined(CONFIG_KRIS)||defined(CONFIG_KRATOS)||defined(CONFIG_KIWI)||defined(CONFIG_KAYLA)||defined(CONFIG_K5TN))
typedef enum
{
	COFDM_FEC_LOCK,
	COFDM_PSYNC_LOCK,
