...
//===========================================================================
	...
	(ENABLE_KIRIN) || (ENABLE_KRIS) || (ENABLE_MONACO) ||  (ENABLE_MUJI) || \
	(ENABLE_CELTICS) || (ENABLE_MONET)
	...
	(ENABLE_CELTICS) || (ENABLE_MONET) || (ENABLE_MILAN) || (ENABLE_MARLON) || \
	(ENABLE_KIRIN) || (ENABLE_KRIS)
    ...
    /* PV2MI bridge ECO every chip must apply it */
...
#elif (ENABLE_KERES) || (ENABLE_KIRIN) || (ENABLE_KRIS)
...
void TV_usb_init_port1(void)
{
	...
	(ENABLE_MONET) || (ENABLE_KIRIN) || (ENABLE_KRIS)
...
void TV_usb_init_port2(void)
{
	...
	(ENABLE_MUJI) || (ENABLE_CELTICS) || (ENABLE_MONET)
    ...
    /* PV2MI bridge ECO every chip must apply it */
    writeb(readb((void*)(HW_BASE+(USBC2_BASE+0x0a)*2) ) | 0x40, (void*) (HW_BASE+(USBC2_BASE+0x0a)*2)); //enable PV2MI bridge ECO

#if (ENABLE_EIFFEL) || (ENABLE_NIKE) || (ENABLE_NADAL) || \
	(ENABLE_EINSTEIN) || (ENABLE_NIKON) || (ENABLE_NAPOLI) || \
	(ENABLE_MADISON) || (ENABLE_MIAMI) || (ENABLE_CLIPPERS) || \
	(ENABLE_MONACO) || (ENABLE_MUJI) || (ENABLE_CELTICS) || \
	(ENABLE_MONET) || (ENABLE_MILAN) || (ENABLE_MARLON)
...
void TV_usb_init_port3(void)
{
...
#elif (ENABLE_MONACO) || (ENABLE_MONET)
    ...
    /* PV2MI bridge ECO every chip must apply it */
    writeb(readb((void*)(HW_BASE+(USBC3_BASE+0x0a)*2) ) | 0x40, (void*) (HW_BASE+(USBC3_BASE+0x0a)*2)); //enable PV2MI bridge ECO
...
{
	//Add this API for compatible with USB20 code base
        flib_Host20_Interrupt_Init(dev);
}
