...
s32 MHal_EMAC_CableConnection(void)
{
    ...
    MHal_EMAC_read_phy(phy_id, PHY_REG_STAT1000, &value);
    ...
    {
        MHal_EMAC_read_phy(phy_id, PHY_REG_LINK_PARTNER, &value);
...
void MHal_EMAC_eWave_Table_Init(void)
{
    ...
    eWaveCbTable[4] = MHal_REALTEK_GPHY_10BASE_Init_setting;
    eWaveCbTable[5] = MHal_REALTEK_GPHY_10BASE_Random_signals;
    eWaveCbTable[6] = MHal_REALTEK_GPHY_10BASE_All_one;
    eWaveCbTable[7] = MHal_REALTEK_GPHY_10BASE_All_zero;
    eWaveCbTable[8] = MHal_REALTEK_GPHY_10BASE_Finish;
}
...
void MHal_EMAC_Power_On_Clk(void)
{
    ...
    MHal_EMAC_WritReg8(0x100a, 0x03, 0x0c);

    /* Enable GMAC tx clock */
    /* Enable GMAC rx clock */
    /* IO setting, enable TX delay */
    MHal_EMAC_WritReg8(0x121f, 0x22, 0x08);
    MHal_EMAC_WritReg8(0x121f, 0x23, 0x00);
    MHal_EMAC_WritReg8(0x121f, 0x24, 0x80);
    MHal_EMAC_WritReg8(0x121f, 0x25, 0x20);
    MHal_EMAC_WritReg8(0x121f, 0x26, 0xe6);
    MHal_EMAC_WritReg8(0x121f, 0x27, 0x6e);
    MHal_EMAC_WritReg8(0x121f, 0x20, 0x00);
    MHal_EMAC_WritReg8(0x121f, 0x21, 0x52);
...
void MHal_REALTEK_GPHY_10BASE_Init_setting(void)
{
    printf("REALTEK_GPHY_10BASE_Init\n");
    MHal_EMAC_enable_mdi();
    MHal_EMAC_write_phy(phy_id, 31, 0x0005);
    MHal_EMAC_write_phy(phy_id,  5, 0x8b86);
    MHal_EMAC_write_phy(phy_id,  6, 0xe200);
    MHal_EMAC_write_phy(phy_id, 31, 0x0007);
    MHal_EMAC_write_phy(phy_id, 30, 0x0020);
    MHal_EMAC_write_phy(phy_id, 21, 0x0108);
    MHal_EMAC_write_phy(phy_id, 31, 0x0000);
}

void MHal_REALTEK_GPHY_10BASE_Finish(void)
{
    printf("REALTEK_GPHY_10BASE_Finish\n");
    MHal_EMAC_write_phy(phy_id, 31, 0x0006);
    MHal_EMAC_write_phy(phy_id,  0, 0x5a00);
    MHal_EMAC_write_phy(phy_id, 31, 0x0000);
}

void MHal_REALTEK_GPHY_10BASE_Random_signals(void)
{
    printf("REALTEK_GPHY_10BASE_T_Random_signals\n");
    MHal_EMAC_write_phy(phy_id, 31, 0x0006);
    MHal_EMAC_write_phy(phy_id,  0, 0x5a21);
}

void MHal_REALTEK_GPHY_10BASE_All_one(void)
{
    printf("REALTEK_GPHY_10BASE_T_All_one\n");
    MHal_EMAC_write_phy(phy_id, 31, 0x0006);
    MHal_EMAC_write_phy(phy_id,  2, 0x05ee);
    MHal_EMAC_write_phy(phy_id,  0, 0xFF21);
}

void MHal_REALTEK_GPHY_10BASE_All_zero(void)
{
    printf("REALTEK_GPHY_10BASE_T_All_zero\n");
    MHal_EMAC_write_phy(phy_id, 31, 0x0006);
    MHal_EMAC_write_phy(phy_id,  2, 0x05ee);
    MHal_EMAC_write_phy(phy_id,  0, 0x0021);
}
