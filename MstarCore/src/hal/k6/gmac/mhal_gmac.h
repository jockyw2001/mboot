...
#define PHY_REG_BASIC                       0x00
#define PHY_REG_STATUS                      0x01
#define PHY_REG_ADVERTISE                   0x04    /* Advertisement control reg   */
#define PHY_REG_LINK_PARTNER                0x05    /* Link partner ability reg    */
#define PHY_REG_CTRL1000                    0x09    /* 1000BASE-T control          */
#define PHY_REG_STAT1000                    0x0a    /* 1000BASE-T status           */
#define PHY_REG_PHYSR                       0x11
