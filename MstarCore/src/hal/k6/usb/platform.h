...
#if (ENABLE_MONACO) || (ENABLE_MIAMI) || (ENABLE_MUJI) || (ENABLE_CELTICS) || \
	(ENABLE_MASERATI)
#define XHCI_0_BASE		(HW_BASE+(0x090000 << 1))
#define XHCI_PORT0_ADDR		(XHCI_0_BASE+0x0440)
#define XHCI_PORT1_ADDR		(XHCI_0_BASE+0x0450)
...
#elif (ENABLE_KANO)
#define XHCI_0_BASE		(HW_BASE+(0xC0000 << 1))
#define XHCI_PORT0_ADDR		(XHCI_0_BASE+0x0440)
#define XHCI_PORT1_ADDR		(XHCI_0_BASE+0x0450)
...
#define MSTAR_U3PHY_P0_D_BASE	(HW_BASE+(0x11C00 << 1))
#elif (ENABLE_K6)
#define XHCI_0_BASE		(HW_BASE+(0x0F0000 << 1))
#define XHCI_PORT0_ADDR		(XHCI_0_BASE+0x0430)
#define MSTAR_U3TOP_BASE	(HW_BASE+(0x40200 << 1))
#define MSTAR_U3PHY_P0_A_BASE	(HW_BASE+(0x02100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(HW_BASE+(0x02000 << 1))
...
#define XHC_COMP_PORT0		{0, XHCI_PORT0_ADDR, MSTAR_U3TOP_BASE, MSTAR_U3PHY_P0_A_BASE, MSTAR_U3PHY_P0_D_BASE, XHCI_0_BASE}
#ifdef XHCI_2PORTS
#define XHC_COMP_PORT1		{1, XHCI_PORT1_ADDR, MSTAR_U3TOP_BASE, MSTAR_U3PHY_P1_A_BASE, MSTAR_U3PHY_P1_D_BASE, XHCI_0_BASE}
#endif
