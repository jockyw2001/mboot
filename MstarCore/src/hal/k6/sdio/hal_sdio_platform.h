...
#define BIT_FCIE_CLK_DIV4_EN			(BIT07) // 0: clk_4X(fast), 1: clk_fcie(slow)
#define BIT_FCIE_CLK_GATING				(BIT08)
#define BIT_FCIE_CLK_INVERSE			(BIT09)
#define BIT_CLKGEN_FCIE_MASK			(BIT13|BIT12|BIT11|BIT10)
#define BIT_CLKGEN_FCIE_SHIFT			10
#define BIT_FCIE_CLK_SRC_SEL			(BIT14) // 0: clk_xtali, 1: clk_fcie
