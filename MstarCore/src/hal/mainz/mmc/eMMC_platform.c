...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(FCIE_DDR_MODE, BIT3|BIT2|BIT1);
	// emmc_pll
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x70, BIT2|BIT3);           // reg_emm_reset_oen
    ...
    switch(u32Mode)
    {
        ...
        case FCIE_eMMC_HS200:
            ...
            REG_FCIE_SETBIT(reg_emmcpll_0x20, BIT10|BIT9);      // reg_sel_internal
