...
#elif (ENABLE_MANHATTAN) || (ENABLE_MAXIM) || (ENABLE_MARCUS)
...
/* Port1 */
	...
	(ENABLE_MACAN) || (ENABLE_MAXIM) || (ENABLE_MARCUS)
...
#elif (ENABLE_MANHATTAN) || (ENABLE_MACAN) || (ENABLE_MAXIM) || (ENABLE_MARCUS)
