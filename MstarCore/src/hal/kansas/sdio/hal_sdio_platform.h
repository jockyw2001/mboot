...
// this file is use only for kansas(K7U) project 2016.9.13
...
#include <config.h> // mboot need, kernel don't
	...
	#else
		#include <stdio.h> // fpga enviroment need for printf
		#define RIU_BASE			0xFD000000 // FPGA
	#endif
...
#define FCIE_IP					1 // kansas FCIE has no pad mux out for sd function
#define SDIO_IP					2
...
#define RIU_BANK_SDIOPLL		0x123FUL
#endif
...
#define RIU_BASE_SDIOPLL		RIU_BANK_2_BASE(RIU_BANK_SDIOPLL)
...
#define R_SDIO_PLL_0x1D					(RIU_BASE_SDIOPLL + (0x1D<<2))
...
#define CHIPTOP_36h						(RIU_BASE_CHIPTOP+(0x36 << RIU_UNIT_SHIFT))
