...
#define REG_GEMAC0_BANK                     0x121BUL
#define REG_X32_GEMAC0_BANK                 0x1A1EUL
#define RIU_REG_BASE                        0xBF000000
#define REG_ADDR_BASE                       0xBF243600
                                            //RIU_REG_BASE + ((REG_X32_GEMAC0_BANK*0x100UL)<<1)
                                            //The register address base. Depends on system define.
