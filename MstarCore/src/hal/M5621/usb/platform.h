...
#elif (ENABLE_MANHATTAN) || (ENABLE_MAXIM) || (ENABLE_MARVEL)
...
/* Port1 */
	...
	(ENABLE_MACAN) || (ENABLE_MAXIM) || (ENABLE_MARVEL)
...
#elif (ENABLE_MANHATTAN) || (ENABLE_MACAN) || (ENABLE_MAXIM) || (ENABLE_MARVEL)
