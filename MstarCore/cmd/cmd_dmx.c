...
#if defined(CONFIG_URANUS4) || defined(CONFIG_KRONUS) || defined(CONFIG_KAISERIN) || defined(CONFIG_KENYA)||defined(CONFIG_KERES)||defined(CONFIG_KIRIN)||defined(CONFIG_KRIS)||defined(CONFIG_KAYLA) ||defined(CONFIG_KRATOS)||defined(CONFIG_KIWI)||defined(CONFIG_K5TN)
...
#if defined(CONFIG_KERES)||defined(CONFIG_KIRIN)||defined(CONFIG_KRIS)||defined(CONFIG_KAYLA)||defined(CONFIG_KRATOS)||defined(CONFIG_KIWI)||defined(CONFIG_K5TN)
