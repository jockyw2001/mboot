...
#ifndef __CUS_SATA_USB_TEST_H__
#define __CUS_SATA_USB_TEST_H__
...
typedef struct
{
	MS_U32 	u32ReadRegAddr;
	MS_U8	u8ReadRegValue;
} MI_SysReadReg_t;

typedef struct
{
	MS_U32 	u32WriteRegAddr;
	MS_U8	u8WriteRegValue;
} MI_SysWriteReg_t;
...
typedef enum {
	...
	SATA_MFTP,
	SATA_SSOP,
	SATA_TX_PATTERN_GEN1,
	SATA_TX_PATTERN_GEN2
}MI_SataPattern_e;
