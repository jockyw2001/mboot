...
#define BOARD_NAME                  "BD_MST257B_D01A_S"
...
#define PADS_PM5_IS_IRIN            PADMUX_MDOE_DEFAULT
...
#if (CONFIG_Second_UART_Mode_2 || CONFIG_Third_UART_Mode_2 || CONFIG_Fourth_UART_Mode_2)
#define PADS_TS0_MODE               PADMUX_MDOE_DEFAULT
#else
#define PADS_TS0_MODE               PADMUX_MDOE1
#endif
#define PADS_TS1_MODE               PADMUX_MDOE1
#define PADS_TS2_MODE               PADMUX_MDOE5
#define PADS_TS_OUT_MODE            PADMUX_MDOE_DEFAULT
#define PADS_NAND_MODE              PADMUX_MDOE1
#define PADS_NAND_CS1_EN            PADMUX_MDOE1
#define PADS_CI_MODE                PADMUX_MDOE1
#define PADS_CCIR_OUT_MODE          PADMUX_MDOE_DEFAULT
#define PADS_CCIR_IN_MODE           PADMUX_MDOE_DEFAULT
#define PADS_PANEL_IF_MODE          PADMUX_MDOE_DEFAULT
...
#define PADS_I2S_OUT_MODE           PADMUX_MDOE1
#define PADS_I2S_OUT_MODE_2         PADMUX_MDOE3
#define PADS_I2S_OUT_MUTE_MODE      PADMUX_MDOE1
#define PADS_SDIO_MODE              PADMUX_MDOE_DEFAULT
#define PADS_SD_CONFIG              PADMUX_MDOE_DEFAULT
#define PADS_ET_MODE                PADMUX_MDOE_DEFAULT
#define PADS_RF_AGC_EN              PADMUX_MDOE_DEFAULT
#define PADS_IF_AGC_EN              PADMUX_MDOE_DEFAULT
...
#define PADS_MODEM_MODE             PADMUX_MDOE_DEFAULT
#define PADS_PWM_MODE               PADMUX_MDOE_DEFAULT
#define PADS_PF_CS1_EN              PADMUX_MDOE_DEFAULT
...
#define PADS_HDMITX_DDC_MODE        PADMUX_MDOE_DEFAULT
#define PADS_HDMITX_ARC_MODE        PADMUX_MDOE_DEFAULT
#define PADS_HDMIRX_ARC_MODE        PADMUX_MDOE_DEFAULT
#else
#define PADS_HDMITX_DDC_MODE        PADMUX_MDOE1
#define PADS_HDMITX_ARC_MODE        PADMUX_MDOE1
#define PADS_HDMIRX_ARC_MODE        PADMUX_MDOE1
#endif
#define PADS_SATA_LED_MODE          PADMUX_MDOE_DEFAULT

//------GPIO setting(default GPIO pin level)------------------------------------
// None PM
#define PAD_GPIO0_IS_GPIO GPIO_OUT_HIGH // ANT OVERLOAD2
#define PAD_GPIO1_IS_GPIO GPIO_OUT_LOW  // USB3_EN
#define PAD_GPIO2_IS_GPIO GPIO_OUT_HIGH // USB_EN
#define PAD_GPIO3_IS_GPIO GPIO_OUT_HIGH // Frontend RST2
#define PAD_GPIO4_IS_GPIO GPIO_OUT_HIGH // RGB/CVBS
#define PAD_GPIO5_IS_GPIO GPIO_OUT_HIGH // HDMITX_POW_CTRL
#define PAD_GPIO6_IS_GPIO GPIO_OUT_HIGH // LED_CTL_1
#define PAD_GPIO7_IS_GPIO GPIO_OUT_HIGH // LED_CTL_0
//#define PAD_GPIO8_IS_GPIO GPIO_OUT_HIGH // SPDIF OUT (not GPIO function)
#define PAD_GPIO9_IS_GPIO GPIO_OUT_HIGH // SCART_PIN8_CTL1
#define PAD_VSYNC_OUT_IS_GPIO GPIO_OUT_HIGH // RST_RF4CE
#define PAD_HSYNC_OUT_IS_GPIO GPIO_OUT_HIGH // INT_RF4CE
// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_OUT_LOW // PCIE_PERST#
#define PAD_SAR_GPIO1_IS_GPIO GPIO_OUT_HIGH // HDMI CTL
#define PAD_SAR_GPIO2_IS_GPIO GPIO_OUT_LOW // GPIO_3.3V_EMMC
#define PAD_SAR_GPIO3_IS_GPIO GPIO_OUT_HIGH // Frontend RST
#define PAD_SAR_GPIO4_IS_GPIO GPIO_OUT_LOW // GPIO_1.8V_EMMC
//#define PAD_SAR_GPIO5_IS_GPIO GPIO_IN // PWR CUT (temp to disable)
#define PAD_VID0_IS_GPIO GPIO_OUT_HIGH // VID 0 (CPU PWR SCL )
#define PAD_VID1_IS_GPIO GPIO_OUT_HIGH // VID 1 (CPU PWR SDA )
#define PAD_PM_GPIO0_IS_GPIO GPIO_OUT_HIGH // PHY_RST ; PM_PWM_0
#define PAD_PM_GPIO1_IS_GPIO GPIO_IN // PCIE_WAKEUP ; RF4CE_Wakeup
#define PAD_PM_GPIO2_IS_GPIO GPIO_OUT_HIGH // Front Panel DATA
#define PAD_PM_GPIO3_IS_GPIO GPIO_OUT_HIGH // CTRL_PCIE_POW ; LNB_INT_2
#define PAD_PM_GPIO4_IS_GPIO GPIO_OUT_HIGH // PD_CTL
#define PAD_PM_GPIO5_IS_GPIO GPIO_IN // CLKREQ_N
#define PAD_PM_GPIO6_IS_GPIO GPIO_OUT_HIGH // ANT PWR CTRL.
#define PAD_PM_GPIO7_IS_GPIO GPIO_IN // USB3_OCP
#define PAD_PM_GPIO8_IS_GPIO GPIO_OUT_HIGH // Front Panel CLK ; CORE PWR VID0
#define PAD_PM_GPIO9_IS_GPIO GPIO_IN // CHIP_CONFIG[0] ; DAC_GPIO0
#define PAD_PM_GPIO10_IS_GPIO GPIO_IN // CHIP_CONFIG[1] ; DAC_GPIO1
#define PAD_PM_GPIO11_IS_GPIO GPIO_OUT_HIGH // Front Panel LED Green
#define PAD_PM_GPIO12_IS_GPIO GPIO_IN // CHIP_CONFIG[2] ; FB_GPIO
#define PAD_PM_GPIO13_IS_GPIO GPIO_IN // OTP Config
#define PAD_PM_GPIO14_IS_GPIO GPIO_OUT_HIGH // Front Panel GPIO ; CORE PWR VID0
#define PAD_PM_GPIO15_IS_GPIO GPIO_OUT_HIGH // Front Panel LED RED
...
//================================= PCIE ========================================
#define ENABLE_PCIE_GPIO_INFO
#define REG_PCIE_POWER_CONTROL                  0x1402EE
#define REG_PCIE_POWER_GPIO_BANK                0x000F
#define REG_PCIE_POWER_GPIO_OFFSET              0x06 //bit0~bit7 offset addr
#define REG_PCIE_POWER_GPIO_BIT                 0x1  //bit8~bit10 bit count
#define REG_PCIE_POWER_GPIO_LOW_ACTIVE          0x1  //Turn on 5V  ( 0:  GPIO High   1: GPIO Low) active

#define REG_PCIE_PERST_CONTROL                  0x1402F2
#define REG_PCIE_PERST_GPIO_BANK                0x0014
#define REG_PCIE_PERST_GPIO_OFFSET              0x24 //bit0~bit7 offset addr
#define REG_PCIE_PERST_GPIO_BIT                 0x0  //bit8~bit10 bit count
#define REG_PCIE_PERST_GPIO_LOW_ACTIVE          0x1  //Turn on 5V  ( 0:  GPIO High   1: GPIO Low) active
//===============================================================================
...
#define	SDIO_CD_BANK		0x0014		// IN register bank
#define	SDIO_CD_OFFSET		0x25		// 8 bits address offset
#define SDIO_CD_BIT			BIT1		// IN value bit
...
#define CpuCorePWRHigh()                 *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) | 0x0002;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) & ~0x0001; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) | 0x0008;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) & ~0x0100;

#define CpuCorePWRLow()                  *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) & ~0x0002;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0f10 << 1)) & ~0x0001; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) | 0x0008;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x0e6a << 1)) & ~0x0100;
