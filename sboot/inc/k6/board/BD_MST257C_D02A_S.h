...
#define BOARD_NAME                  "BD_MST257C_D02A_S"
...
#define PADS_SM0_EN                 PADMUX_MDOE_DEFAULT
#define PADS_SM0_IO                 PADMUX_MDOE_DEFAULT
...
#define PADS_SPDIF_OUT_MODE         PADMUX_MDOE1
...
#endif
#define PADS_SATA_LED_MODE          PADMUX_MDOE1

//------GPIO setting(default GPIO pin level)------------------------------------
// None PM
#define PAD_GPIO0_IS_GPIO GPIO_IN // USB0_OCP
#define PAD_GPIO1_IS_GPIO GPIO_OUT_HIGH  // CORE PWR VID0
#define PAD_GPIO2_IS_GPIO GPIO_OUT_HIGH  // CORE PWR VID1
#define PAD_GPIO3_IS_GPIO GPIO_OUT_HIGH  // USB0_EN
#define PAD_GPIO4_IS_GPIO GPIO_OUT_HIGH  // USB1_EN
#define PAD_GPIO5_IS_GPIO GPIO_IN  // USB3_OCP
//#define PAD_GPIO6_IS_GPIO GPIO_OUT_HIGH  // SATA LED EN; Control by pad mux
#define PAD_GPIO7_IS_GPIO GPIO_OUT_HIGH  // USB3_EN
#define PAD_GPIO8_IS_GPIO GPIO_IN  // USB1_OCP
#define PAD_GPIO9_IS_GPIO GPIO_OUT_HIGH  // GHY RST
#define PAD_VSYNC_OUT_IS_GPIO GPIO_OUT_HIGH  // VSYNC OUT
#define PAD_HSYNC_OUT_IS_GPIO GPIO_OUT_HIGH  // HSYNC OUT
#define PAD_TS0_D4_IS_GPIO GPIO_IN  // RTC_INTAZ
#define PAD_TS0_D5_IS_GPIO GPIO_IN  // RTC_INTBZ
#define PAD_TS2_CLK_IS_GPIO GPIO_OUT_HIGH  // WL_DISN
#define PAD_TS2_D0_IS_GPIO GPIO_OUT_HIGH  // LED_WL
#define PAD_TS2_D1_IS_GPIO GPIO_IN  // CLKREQ_N
#define PAD_TS2_D2_IS_GPIO GPIO_OUT_HIGH  // PRSTN
#define PAD_TS2_D3_IS_GPIO GPIO_OUT_HIGH  // BT_DIS
#define PAD_TS2_D4_IS_GPIO GPIO_IN  // PCIE_WAKEUP
#define PAD_TS2_D5_IS_GPIO GPIO_OUT_HIGH  // CTRL_PCIE_POW

// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_OUT_LOW // Front Panel LED RED
#define PAD_SAR_GPIO1_IS_GPIO GPIO_OUT_LOW // GPIO_1.8V_EMMC
#define PAD_SAR_GPIO2_IS_GPIO GPIO_OUT_LOW // GPIO_3.3V_EMMC
//#define PAD_SAR_GPIO5_IS_GPIO GPIO_IN // PWR_Detect (temp to disable)
#define PAD_VID0_IS_GPIO GPIO_OUT_HIGH // VID 0 (CPU PWR SCL )
#define PAD_VID1_IS_GPIO GPIO_OUT_HIGH // VID 1 (CPU PWR SDA )
#define PAD_PM_GPIO0_IS_GPIO GPIO_OUT_HIGH // Front Panel DATA
#define PAD_PM_GPIO1_IS_GPIO GPIO_OUT_HIGH // Front Panel  CLK
#define PAD_PM_GPIO2_IS_GPIO GPIO_IN // RGNII_INT
#define PAD_PM_GPIO3_IS_GPIO GPIO_OUT_LOW // Front Panel LED Green
#define PAD_PM_GPIO4_IS_GPIO GPIO_OUT_HIGH // PD controll
#define PAD_PM_GPIO6_IS_GPIO GPIO_OUT_HIGH // Front Panel GPIO
#define PAD_PM_GPIO9_IS_GPIO GPIO_IN // CHIP Config 0
#define PAD_PM_GPIO10_IS_GPIO GPIO_IN // CHIP Config 1
#define PAD_PM_GPIO12_IS_GPIO GPIO_IN // CHIP Config 2
...
#define CpuCorePWRHigh()                 *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) | 0x0010;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) & ~0x0020; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101ea0 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101ea0 << 1)) & ~0x8000; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e24 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e24 << 1)) & ~0x0030;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e12 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e12 << 1)) & ~0x00c0;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e06 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e06 << 1)) & ~0x0300;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e04 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e04 << 1)) & ~0x0c00;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e0e << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e0e << 1)) & ~0x0003;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e26 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e26 << 1)) & ~0x0003;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e26 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e26 << 1)) & ~0x0300;

#define CpuCorePWRLow()                  *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) & ~0x0010;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x1025b2 << 1)) & ~0x0020; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101ea0 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101ea0 << 1)) & ~0x8000; \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e24 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e24 << 1)) & ~0x0030;  \
                                         *(volatile MS_U16 *)(0x1f000000 + (0x101e12 << 1)) = *(volatile MS_U16 *)(0x1f000000 + (0x101e12 << 1)) & ~0x00c0;  \
