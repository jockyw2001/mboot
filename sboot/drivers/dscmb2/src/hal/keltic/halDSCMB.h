...
#define HAL_DSCMB_FLT_NULL                      0xFFFFFFFF
#define PID_SLOT_INDEX_NULL                     0x7F

//HAL_DSCMB_KTE_GetStatus(), for debug usage
#define DSCMB_PIDIDX_EN     0x80000000
#define DSCMB_KTE_VALID     0x40000000
#define DSCMB_KTE_DUAL_EN   0x10000000
#define DSCMB_KTE_LSAS_EN   0x00000001
#define DSCMB_KTE_ESA_EN    0x00000100
#define DSCMB_KTE_LSAD_EN   0x00010000
#define DSCMB_KTE_IV_EN     0x01000000


#define HAL_DSCMB_KTE_MAX      128 // 0 ~ 127 and 127 is reserved for NULL key
#define HAL_DSCMB_KTE_ID_NULL  127
#define HAL_DSCMB_PIDIDX_MAX    64
#define HAL_DSCMB_PIDFLT_NUM    64
#define HAL_DSCMB_TSIF_MAX       2
#define HAL_DSCMB_TSID_MAX       2
#define HAL_DSCMB_ENG_MAX        1

#define HAL_DSCMB_ENG_NUM               1

#define HAL_DSCMB_KEY_TYPE_CLEAR        0
#define HAL_DSCMB_KEY_TYPE_EVEN         2
#define HAL_DSCMB_KEY_TYPE_ODD          3

// #define REG_DSCMB_POS_SWITCH13          13
// #define REG_DSCMB_POS_SWITCH14          14
#define HAL_DSCMB_KEYLEN_MAX            16
#define HAL_DSCMB_MULTI2_SYSKEY_MAX     32

#define HAL_DSCMB_SPSPVR_ENG_NUM        2
#define HAL_DSCMB_SPSPVR_FLT_NUM        32
#define HAL_DSCMB_SPSPVR_BUF_NUM        2

#define DSCMB_CAPVR_PIDTABLE_NUM  (3)
...
typedef enum
{
    ...
    E_HAL_DSCMB_KL_DSTDMA_SPS0   = 0x8 ,
    E_HAL_DSCMB_KL_DSTDMA_SPS1   = 0x9 ,
    E_HAL_DSCMB_KL_DSTDMA_SPS2   = 0xa ,
    E_HAL_DSCMB_KL_DSTDMA_SPS3   = 0xb ,
    E_HAL_DSCMB_KL_DSTDMA_SPD0   = 0xc ,
    E_HAL_DSCMB_KL_DSTDMA_SPD1   = 0xd ,
    E_HAL_DSCMB_KL_DSTDMA_SPD2   = 0xe ,
    E_HAL_DSCMB_KL_DSTDMA_SPD3   = 0xf ,
...
typedef enum
{
    E_HAL_DSCMB_SPSPVR0 = 0,
    E_HAL_DSCMB_SPSPVR1 = 1,
...
// SPS PVR Functions //
// SPS only support AES ECB alogorithm //
MS_BOOL HAL_DSCMB_SPSPVR_Reset( MS_U32 EngId);
MS_BOOL HAL_DSCMB_SPSPVR_SetPid( MS_U32 EngId , MS_U32 u32FltId , MS_U32 U32Pid , MS_BOOL bBuf0, MS_BOOL bBuf1 );
MS_BOOL HAL_DSCMB_SPSPVR_GetWPtr( MS_U32 EngId , MS_U32 *pu32WPtr0, MS_U32 *pu32WPtr1 );
MS_BOOL HAL_DSCMB_SPSPVR_SetBuffer(MS_U32 EngId,MS_U32 BufSel,MS_U32 u32Buf0,MS_U32 u32Size0,MS_U32 u32Buf1 , MS_U32 u32Size1 );
...
MS_BOOL HAL_DSCMB_KL_KeyBus(DSCMB_KL_SelEng eKLEng, MS_U32 u32FltId, MS_U32 u32Field, DSCMB_Key_Type u32KeyType, DSCMB_KLDst eDst);
