...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_KENTUCKY_UBOOT_H__
#define __UNFD_KENTUCKY_UBOOT_H__
...
// HW Timer for Delay
//=====================================================
#define TIMER1_ENABLE						GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x10)
#define TIMER1_HIT							GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x11)
#define TIMER1_MAX_LOW						GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x12)
#define TIMER1_MAX_HIGH						GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x13)
#define TIMER1_CAP_LOW						GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x14)
#define TIMER1_CAP_HIGH						GET_REG_ADDR(TIMER0_REG_BASE_ADDR, 0x15)
