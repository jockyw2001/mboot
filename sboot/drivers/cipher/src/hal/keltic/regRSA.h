...
//  Type and Structure
//-------------------------------------------------------------------------------------------------
#define REG_AESDMACTRL_BASE         0x1940  //(0x0C00/2 + 0x50) * 4
#define REG_SHARNGCTRL_BASE         (0x9E80 * 4)
#define REG_RSACTRL_BASE            (0x71200 * 2) // Bank 1712
...
#define REG_MAGIC                   (REG_SHARNGCTRL_BASE + 0x10 * 4)
#define REG_READ_FWC_STATUS         (REG_SHARNGCTRL_BASE + 0x2c * 4)
#define SHARNG_CTRL_SHA_BUSY                0x0002
#define SHARNG_CTRL_SHA_READY               0x0001

#define REG_FWC_SCATTERGATHER_START (REG_SHARNGCTRL_BASE + 0x60 * 4)
#define REG_FWC_SCATTERGATHER_SIZE  (REG_SHARNGCTRL_BASE + 0x62 * 4)
#define REG_FWC_MESSAGE_LENGTH      (REG_SHARNGCTRL_BASE + 0x63 * 4)

#define REG_FWC_SHA_CTRL            (REG_SHARNGCTRL_BASE + 0x65 * 4)
#define SHARNG_CTRL_SHA_FIRE_ONCE           0x1000
#define SHARNG_CTRL_SHA_RST                 0x2000
#define SHARNG_CTRL_SHA_SEL_SHA256          0x4000
