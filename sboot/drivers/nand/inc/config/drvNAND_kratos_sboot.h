...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_KRATOS_SBOOT_H__
#define __UNFD_KRATOS_SBOOT_H__
...
#define REG_SYNC_PE						    GET_REG_ADDR(CHIPTOP_BASE, 0x24)
#define REG_S_GPIO_PE						GET_REG_ADDR(CHIPTOP_BASE, 0x25)
