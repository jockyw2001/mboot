...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_KENYA_SBOOT_H__
#define __UNFD_KENYA_SBOOT_H__
...
#define CONFIG_SRAM_BASE_ADDRESS            0x81000000  //REVIEW IT!
#else
#define CONFIG_SRAM_BASE_ADDRESS            0xB0004000  //REVIEW IT!
#endif

#define CONFIG_SRAM_FCIE_OFFSET             0x3800
...
#define ROM_PPM_ADDR						(0xB0004000+0x3800+128)								//check the elf.map for rom code binary
