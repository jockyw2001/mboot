...
#define eMMC_ST_ERR_RPMB_EXCEED_SIZE	 (0x0A36 | eMMC_ST_PLAT)
#define eMMC_ST_ERR_RPMB_HMAC_ERR	     (0x0A37 | eMMC_ST_PLAT)
#define eMMC_ST_ERR_RPMB_WCNT_MAX	     (0x0A38 | eMMC_ST_PLAT)
