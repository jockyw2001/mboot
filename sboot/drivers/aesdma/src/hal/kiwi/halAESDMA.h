...
#define CONFIG_XIU_BASE_ADDRESS     0xB3000000
#define CONFIG_EMMC_BASE_ADDRESS    0xB2000000
...
#define EFUSE_BASE_ADDR      (0x002000)
#define DIDKEY_BASE_ADDR     (0x003800)
#define AESDMA_BASE_ADDR     (0x170600)
#define SHARNG_BASE_ADDR     (0x170600)
#define RSA_BASE_ADDR        (0x170600)
#define DMA_SECURE_BASE_ADDR (0x170400)
...
#define SECURE_RSA_OUT_DRAM_ADDRESS          (0x40109000)
#define SECURE_SHA_OUT_DRAM_ADDRESS          (0x40109100)
#define SECURE_RSA_OUT_SRAM_ADDRESS          (0xB2003600)
#define SECURE_SHA_OUT_SRAM_ADDRESS          (0xB2003700)
#define SECURE_WB_FIFO_OUT_ADDRESS           (0xB2002400)
