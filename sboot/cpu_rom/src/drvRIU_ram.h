...
void BootRam_WriteRegMaskTbl(const MS_REG_INIT *pRegMaskTbl);
void BootRam_WriteRegTbl32(const MS_REG_INIT *pRegTbl32);
void BootRam_WriteRegTbl32Off(const MS_REG_INIT *pRegTbl32, int iRegOffset);
