...
#include "drvRIU.h"
    ...
    #include "bootrom_miu_ddr2.h"
#elif (CONFIG_MEM1866MHz || CONFIG_MEM1600MHz)
    #if defined(CONFIG_MSTAR_DDR_512MB)
        #include "bootrom_miu_ddr3_512M.h"
    #elif defined(CONFIG_MSTAR_DDR_256MB)
        #include "bootrom_miu_ddr3_256M.h"
    #elif defined(CONFIG_MSTAR_DDR_128MB)
        #include "bootrom_miu_ddr3_128M.h"
    #else
