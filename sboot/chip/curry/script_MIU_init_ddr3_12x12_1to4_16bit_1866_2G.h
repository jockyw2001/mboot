...
#define ENABLE_MIU1 0
    ...
    _RV32_2(0x1204, 0x4053),
#if (ENABLE_MEM1600MHz)
    _RV32_2(0x1206, 0x1560),
#else
    _RV32_2(0x1206, 0x3571),
#endif
#else
...
#endif
    _RV32_2(0x0d0a, 0x3302),
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x0d0e, 0x0099),
#else
    _RV32_2(0x0d0e, 0x0089),
#endif
    //_RV32_2(0x0d14, 0x0c00),
    _RV32_2(0x0d14, 0x0300),
    _RV32_2(0x0d2e, 0x3344),
    _RV32_2(0x0d38, 0x6577),
    _RV32_2(0x0d3a, 0xb0ba),
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x0d3c, 0x9111),
    _RV32_2(0x0d3e, 0xb011),
#else
    _RV32_2(0x0d3c, 0x9455),
    _RV32_2(0x0d3e, 0x2044),
#endif
    _RV32_2(0x0d48, 0x5577),
    _RV32_2(0x0d4a, 0xb0b0),
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x0d4c, 0x0311),
    _RV32_2(0x0d4e, 0x0033),
#else
    _RV32_2(0x0d4c, 0x0055),
    _RV32_2(0x0d4e, 0x0055),
#endif
    _RV32_2(0x0d50, 0x2222),
    _RV32_2(0x0d52, 0x6464),
    _RV32_2(0x0d6c, 0x0808),
    _RV32_2(0x0d6e, 0x0808),

    {CHIPCFG_STR_IFAC,0x0},
    _RV32_2(0x0d94, 0x0606),
    _RV32_2(0x0d96, 0x0504),
    _RV32_2(0x0da0, 0x3343),
    _RV32_2(0x0da2, 0x2420),
    _RV32_2(0x0da4, 0x4364),
    _RV32_2(0x0da6, 0x2540),
    _RV32_2(0x0da8, 0x2132),
    _RV32_2(0x0daa, 0x0531),
    _RV32_2(0x0dac, 0x6558),
    _RV32_2(0x0dae, 0x0723),
    {CHIPCFG_STR_IFAC_END,0x0},
    ...
    _RV32_2(0x0dd2, 0x4433),
    _RV32_2(0x0dd4, 0x3444),
    _RV32_2(0x0dd6, 0x3423),
    _RV32_2(0x0dd8, 0x0044),
    _RV32_2(0x0de0, 0x5555),
    _RV32_2(0x0de2, 0x5555),
    _RV32_2(0x0de4, 0x5555),
    _RV32_2(0x0de6, 0x5553),
    _RV32_2(0x0de8, 0x0055),
    _RV32_2(0x0dfc, 0x0707),
    _RV32_2(0x0dfe, 0x0303),

    // For auto K test_base
    _RV32_2(0x0dce, 0xffff),
    ...
    _RV32_2(0x0d70, 0x0800),
    // driving setting
    _RV32_2(0x0d58, 0x0b0b),
    _RV32_2(0x0d5a, 0xaaaa),
    _RV32_2(0x0d5c, 0xacaa),
    _RV32_2(0x0d5e, 0xacaa),

    // trig. lvl setting
    {CHIPCFG_STR_IFAC,0x0},
    {CHIPCFG_CMD_BASE, 0x1f22},
    _RV32_2(0x0d74, 0x0707),
    _RV32_2(0x0d76, 0x0707),
