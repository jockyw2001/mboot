...
//---------------------------------------------------------------------
 ...
 // Script Generated GPIO
    ...
    _RVM1(0x1e0a, 0, BIT4),        //Reg[101e0a]#4=0
    #endif
    ...
    _RVM1(0x262e, PAD_S_GPIO0_OUT, BIT4),
    _RVM1(0x262e, PAD_S_GPIO0_OEN, BIT5),
    //reg_all_pad_in=0
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_i2c_out_mode=0
    _RVM1(0x1e0b, 0, BIT4),   //Reg[101e0b]#4=0
    //reg_mspi_mode = 0
    ...
    _RVM1(0x2636, PAD_S_GPIO4_OUT, BIT4),
    _RVM1(0x2636, PAD_S_GPIO4_OEN, BIT5),
    //reg_all_pad_in=0
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_i2c_in_mode=0
    _RVM1(0x1e0b, 0, BIT0),   //Reg[101e0b]#0=0
    ...
    //reg_mcu_jtag_mode=0
    _RVM1(0x1e08, 0, BIT5|BIT4),   //Reg[101e08]#5~#4=0
    //reg_chiptop_dummy_3_0=0
    _RVM1(0x1e46, 0, BIT1|BIT0),   //Reg[101e46]#1~#0=0
    ...
    //reg_mcu_jtag_mode=0
    _RVM1(0x1e8, 0, BIT5|BIT4),   //Reg[101e8]#5~#4=0
    //reg_SecondUARTMode=0
    _RVM1(0x1e06, 0, BIT1|BIT0),   //Reg[101e06]#1~#0=0
    _RVM1(0x294e, BIT5|BIT4, BIT5|BIT4),   //Reg[10294e]#5~#4=1
    _RVM1(0x294e, 0, BIT3|BIT2),   //Reg[10294e]#3~#2=0
    #endif
    ...
    //reg_i2cm0_mode=0
    _RVM1(0x1e12, 0, BIT1|BIT0),   //Reg[101e12]#1~#0=0
    //reg_i2cm1_mode=0
    _RVM1(0x1e12, 0, BIT5|BIT4),   //Reg[101e12]#5~#4=0
    #endif
    ...
    _RVM1(0x1e06, 0, BIT1|BIT0),   //Reg[101e06]#1~#0=0
    //reg_ThirdUARTMode=0
    _RVM1(0x1e06, 0, BIT5|BIT4),   //Reg[101e06]#5~#4=0
    //reg_ForthUARTMode=0
    _RVM1(0x1e07, 0, BIT1|BIT0),   //Reg[101e07]#1~#0=0
    //reg_nand_mode=0
    _RVM1(0x1e10, 0, BIT5|BIT4),   //Reg[101e10]#5~#4=0
    _RVM1(0x1e87, 0, BIT0),   //Reg[101e87]#0=0
    //reg_fcie_md_sel=0
    _RVM1(0x0f81, 0, BIT3),   //Reg[160f81]#3=0
    #endif
    ...
    _RVM1(0x1e11, 0, BIT1|BIT0),   //Reg[101e11]#1~#0=0
    //reg_fuart_mode=0
    _RVM1(0x1e13, 0, BIT3|BIT2),   //Reg[101e13]#3~#2=0
    //reg_nand_mode=0
    _RVM1(0x1e10, 0, BIT5|BIT4),   //Reg[101e10]#5~#4=0
    _RVM1(0x1e87, 0, BIT0),   //Reg[101e87]#0=0
    //reg_fcie_md_sel=0
    ...
    //reg_gpio2_pe=1
    _RVM1(0x1e4e, BIT3, BIT3),   //Reg[101e4e]#3=1
    //reg_all_pad_in=0
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_test_in_mode=0
    _RVM1(0x1e24, 0, BIT1|BIT0),   //Reg[101e24]#1~#0=0
    ...
    //reg_gpio4_pe=1
    _RVM1(0x1e4f, BIT3, BIT3),   //Reg[101e4f]#3=1
    //reg_all_pad_in=0
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_test_in_mode=0
    _RVM1(0x1e24, 0, BIT1|BIT0),   //Reg[101e24]#1~#0=0
    ...
    _RVM1(0x1e87, 0, BIT0),   //Reg[101e87]#0=0
    //reg_ci_mode=0
    _RVM1(0x1e0e, 0, BIT0),   //Reg[101e0e]#0=0
    //reg_fcie_md_sel=0
    _RVM1(0x0f81, 0, BIT3),   //Reg[160f81]#3=0
    #endif
    ...
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_ts0_mode=0
    _RVM1(0x1e04, 0, BIT2|BIT1|BIT0),   //Reg[101e04]#2~#0=0
    //reg_mcu_jtag_mode=0
    _RVM1(0x1e08, 0, BIT5|BIT4),   //Reg[101e08]#5~#4=0
    //reg_chiptop_dummy_3_0=0
    _RVM1(0x1e46, 0, BIT1|BIT0),   //Reg[101e46]#1~#0=0
    ...
    _RVM1(0x1424, PAD_VPLUG_DET_OUT, BIT3),
    _RVM1(0x1423, PAD_VPLUG_DET_OEN, BIT3),
    //reg_sar_aisel[3]=0
...
//---------------------------------------------------------------------
    ...
    _RVM1(0x1E18, DRVPAD_SM0_C48 << 4, BIT4),
    #endif
    ...
    _RVM1(0x1E12, DRVPAD_I2CM0_MODE, BIT1|BIT0),
    #endif
    
    #if (DRVPAD_I2CM1_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E12, DRVPAD_I2CM1_MODE << 4, BIT5|BIT4),
    #endif  

    #if (DRVPAD_TS0_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E04, DRVPAD_TS0_MODE, BITMASK(2:0)),
    #endif
    ...
    _RVM1(0x1E10, DRVPAD_NAND_MODE << 4, BITMASK(5:4)),
    #endif

    #if (DRVPAD_CI_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E0E, DRVPAD_CI_MODE, BIT0),
    #endif

    #if (DRVPAD_SPDIF_OUT_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E0A, DRVPAD_SPDIF_OUT_MODE << 4, BIT4),
    #endif
    ...
    // UART MUX 
    _RVM1(0x1E06, DRVPAD_SECOND_UART_MODE, BITMASK(1:0)),
    #endif

    #if (DRVPAD_THIRD_UART_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E06, DRVPAD_THIRD_UART_MODE << 4, BITMASK(5:4)), 
    #endif

    #if (DRVPAD_FORTH_UART_MODE!=PADMUX_MDOE_DEFAULT)
    _RVM1(0x1E07, DRVPAD_FORTH_UART_MODE, BITMASK(1:0)),
    #endif
...
//---------------------------------------------------------------------    
    ...
    /*2'd0: disable LED0/LED1 function to PAD
          2'd1: LED1 function use PAD_PM_GPIO[16]
          2'd2: LED0/LED1 function use PAD_PM_GPIO[2]/PAD_PM_GPIO[3]
          2'd3: LED0/LED1 function use PAD_PM_GPIO[15]/PAD_PM_GPIO[16] */
