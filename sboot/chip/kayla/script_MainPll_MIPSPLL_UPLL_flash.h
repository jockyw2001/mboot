...
// Initial VEPLL
//--------------------------------------
WREG_B ((REG_ADDR_BASE + (0x100bf8 <<1 ) +1) , 0x01    ),
WREG   ((REG_ADDR_BASE + (0x10311e <<1 )) , 0x6063  ),
WREG   ((REG_ADDR_BASE + (0x103120 <<1 )) , 0x40f6  ),
WREG_B ((REG_ADDR_BASE + (0x1031b4 <<1 ) +1) , 0x03    ),
WREG_B ((REG_ADDR_BASE + (0x1031b8 <<1 )) , 0x0c    ),
//--------------------------------------
// Switch clk_miu to 266MHz from VEPLL
//--------------------------------------
WREG ((REG_ADDR_BASE + (0x100b3e <<1 )) , 0x0010),
...
WREG  ((REG_ADDR_BASE + (0x103aa2 <<1 )) , 0x5080   ), // PLL_TEST[30:28]: 3'b101 for IBIAS current select"
...
WREG  ((REG_ADDR_BASE + (0x103a22 <<1 )) , 0x5080   ), // PLL_TEST[30:28]: 3'b101 for IBIAS current select"
                                                   // PLL_TEST[23] CLK480 to digital output source selection"
