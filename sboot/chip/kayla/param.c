...
//set reg_dram_size
        ...
        {(0x12D2<<1)+1, 0x60F0},
#elif defined(CONFIG_MSTAR_DDR_32MB)
        {(0x12D2<<1)+1, 0x50F0},
#else
#error "please check dram size range"
        ...
        {CHIPCFG_CMD_WAIT, 100},  //Enter refresh mode end
        {CHIPCFG_CMD_BASE_8BITS, 0xBF20}, //_Disable_ATOP_SW start
        {((0x1202<<1)+1),0x00F0},
        {CHIPCFG_CMD_BASE_8BITS, 0xBF22},
        _RV32_2(0x0D54, 0x0070),
        _RV32_2(0x0D08, 0xffff),          //_Disable_ATOP_SW start end
        {CHIPCFG_CMD_BASE,0xbf20},   //_Exit_Refresh_Mode start
        _RV32_2(0x1200, 0x002F),
        _RV32_2(0x1246, 0xFFFE),
        ...
        _RV32_2(0x1506, 0xffff),
        _RV32_2(0x1526, 0xffff),
        {CHIPCFG_CMD_WAIT, 200},//_Exit_Refresh_Mode end
        {CHIPCFG_CMD_BASE,0xbf20},
