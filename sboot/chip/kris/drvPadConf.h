...
//---------------------------------------------------------------------
 ...
 // Script Generated GPIO
    ...
    _RVM1(0x250d, PAD_SM0_GPIO_OUT, BIT12),
    _RVM1(0x250d, PAD_SM0_GPIO_OEN, BIT13),
    //reg_sm0_gpio_en=1
    _RVM1(0x1e51, BIT0, BIT0),   //Reg[101e51]#0=1
    //reg_pd_smc_pad=0
    _RVM1(0x2958, 0, BIT6),   //Reg[102958]#6=0
    ...
    //reg_gpio4_pe=1
    _RVM1(0x1e4e, BIT11, BIT11),   //Reg[101e4e]#11=1
    //reg_all_pad_in=0
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_test_in_mode=0
    _RVM1(0x1e24, 0, BIT1|BIT0),   //Reg[101e24]#1~#0=0
    ...
    _RVM1(0x1ea1, 0, BIT7),   //Reg[101ea1]#7=0
    //reg_ts0_mode=0
    _RVM1(0x1e04, 0, BIT2|BIT0),   //Reg[101e04]#2~#0=0
    //reg_mcu_jtag_mode=0
    _RVM1(0x1e08, 0, BIT5|BIT4),   //Reg[101e08]#5~#4=0
    //reg_chiptop_dummy_3_0=0
    _RVM1(0x1e46, 0, BIT1|BIT0),   //Reg[101e46]#1~#0=0
    ...
    _RVM1(0x1e04, 0, BIT2|BIT0),   //Reg[101e04]#2~#0=0
    //reg_ts1_mode=0
    _RVM1(0x1e04, 0, BIT6|BIT4),   //Reg[101e04]#6~#4=0
    //reg_mspi_mode=0
    _RVM1(0x1e12, 0, BIT7),   //Reg[101e12]#7=0
    _RVM1(0x1e13, 0, BIT0),   //Reg[101e13]#0=0
    _RVM1(0x1e86, 0, BIT0),   //Reg[101e86]#0=0
    ...
    _RVM1(0x0e25, 0, BIT7|BIT0),   //Reg[000e25]#7~#0=ba
    //reg_gpio_pm_lock[7:0]=be
    _RVM1(0x0e24, 0, BIT7|BIT0),   //Reg[000e24]#7~#0=be
    #endif
    ...
    //reg_gt1_is_gpio=1
    _RVM1(0x0e39, BIT1, BIT1),   //Reg[000e39]#1=1
    #endif
...
//---------------------------------------------------------------------
	...
	#define LED_MODE ((PADS_LED_MODE == PAD_PM_GPIO15) ? (BIT4|BIT5) : \
                      (PADS_LED_MODE == PAD_PM_GPIO2 ) ? (BIT4) : 0)

	_RVM1(0x0E50, LED_MODE, (BIT4|BIT5)),
