...
// PCM & TCK
WREG(REG_ADDR_BASE + (0x101e04 << 1), 0x0020), // CLK_TCK_IN from PAD_TS1_SYNC
WREG(REG_ADDR_BASE + (0x100b34 << 1), 0x0000), // clk_pcm = 27M
                                               // clk_tck = CLK_TCK_IN

// MIU
#if ( MIU_INTERFACE == DDR3_INTERFACE_BGA)
WREG(REG_ADDR_BASE + (0x100b3c << 1), 0x0002), // clk_mpll_syn = 432M (for VEPLL  0: 216M, 1:432M)
#else
WREG(REG_ADDR_BASE + (0x100b3c << 1), 0x0000), // clk_mpll_syn = 432M (for VEPLL  0: 216M, 1:432M)
#endif
...
WREG(REG_ADDR_BASE + (0x100b52 << 1), 0x0400), // clk_ts2 = CLK_TS0_IN
                                               // clk_ts3 = CLK_TS1_IN                                             
WREG(REG_ADDR_BASE + (0x100b54 << 1), 0x0800), // clk_tsp = 144M
...
// HVD
WREG(REG_ADDR_BASE + (0x100b68 << 1), 0x0000), // CLK_HVD=108Mhz
// JPD
...
WREG(REG_ADDR_BASE + (0x100ba6 << 1), 0x0018), // clk_odclk = 27M (CLK_OUT_DAC/8) (output pixel clock)
...
//TSO
WREG(REG_ADDR_BASE + (0x100b4e << 1), 0x0000), // clk_stamp
