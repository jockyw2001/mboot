...
#include "script_clk_gen.h"
        ...
        {0x3100, 0xB090},
        //{0x310c, 0x0005},      // 0x1018 43[0]: Write through enable when write hit
...
#if defined(CONFIG_MSTAR_MMAP_64MB)
    #include "script_MIU_init_ddr2_QFP_64M.h"
#elif defined(CONFIG_MSTAR_MMAP_32MB)
    #include "script_MIU_init_ddr2_QFP_32M.h"
#else
#error "Unspecified DRAM SIZE"
#endif
#elif ( MIU_INTERFACE == DDR2_INTERFACE_FPGA)
...
#error "Unspecified DRAM TYPE"
        ...
        {CHIPCFG_CMD_BASE, 0xBF20},
        {(2 * 0x101230) & 0xffff,  0x4000},  //miu normal mode
        {CHIPCFG_CMD_WAIT, 5},
        {CHIPCFG_CMD_WAIT, 5},

        {(2 * 0x100902) & 0xffff,  0x401c},  //wriu -w 0x100902 0x401c //clear
        {(2 * 0x100904) & 0xffff,  0x3024},  //wriu -w 0x100904 0x3024
        {(2 * 0x100906) & 0xffff,  0x0000},  //wriu -w 0x100906 0x0000
        {(2 * 0x100908) & 0xffff,  0x0000},  //wriu -w 0x100908 0x0000 //src address = 0
        {(2 * 0x10090a) & 0xffff,  0x0000},  //wriu -w 0x10090a 0x0000 //src address = 0
        {(2 * 0x10090c) & 0xffff,  0x0000},  //wriu -w 0x10090c 0x0100 //dst address = 0
        {(2 * 0x10090e) & 0xffff,  0x0000},  //wriu -w 0x10090e 0x0000 //dst address = 0
        {(2 * 0x100910) & 0xffff,  0x4000},  //wriu -w 0x100910 0x0004 //write size = 16K
        {(2 * 0x100912) & 0xffff,  0x0000},  //wriu -w 0x100912 0x0000 //write size = 16K
        {(2 * 0x100914) & 0xffff,  0x0000},  //wriu -w 0x100914 0xCDAB //write data = 0
        {(2 * 0x100916) & 0xffff,  0x0000},  //wriu -w 0x100916 0xADDE //write data = 0
        {(2 * 0x100900) & 0xffff,  0x0001},  //wriu -w 0x100900 0x0001 //write enable
        ...
        //  TSP setting    //
        {CHIPCFG_CMD_BASE_8BITS, 0xBF20},
        {(2 * 0x1015F4) & 0xffff,  0x00ff},  //sw_rst
        {(2 * 0x1015F4) & 0xffff,  0x03ff},  // disable sw_rst, enable cpu
        {(2 * 0x1015F4) & 0xffff,  0x02ff}, //disable sw_rst
        {(2 * 0x1015f0) & 0xffff,  0x00ff}, //dma start address , 256 byte aligment,
        {(2 * 0x1015f1) & 0xffff,  0x00ff},
        {(2 * 0x101614) & 0xffff,  0x00ff},
        {CHIPCFG_CMD_BASE, 0xBF20},          /////// 16bit mode for dma size ////
        {CHIPCFG_CMD_WAIT, 10},
        {CHIPCFG_CMD_WAIT, 10},
        {(2 * 0x1015f2) & 0xffff,  0x1000}, //dma read number
        {CHIPCFG_CMD_BASE_8BITS, 0xBF20},
        {(2 * 0x101558) & 0xffff,  0x40ff}, //wb_rst
        {(2 * 0x101559) & 0xffff,  0xbbff},
        {(2 * 0x1015F4) & 0xffff,  0x06ff}, //dma read start, disable sw_rs
        {CHIPCFG_CMD_WAIT, 50},
        {CHIPCFG_CMD_WAIT, 50},

        {CHIPCFG_CMD_BASE, 0xBF20},
        {(2 * 0x101230) & 0xffff,  0x0000},  //miu test mode
        {CHIPCFG_CMD_WAIT, 5},
        {CHIPCFG_CMD_WAIT, 5},

        {CHIPCFG_CMD_WAIT, 0x50},
        {CHIPCFG_CMD_WAIT, 0x50},
        {CHIPCFG_CMD_END,  0xFFFF},
