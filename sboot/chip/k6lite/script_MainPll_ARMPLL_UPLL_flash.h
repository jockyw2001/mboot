...
WREG_B ((REG_ADDR_BASE + (0x100800 << 1)), 0xC0),   // UPLL0 (0x100800)
WREG_B ((REG_ADDR_BASE + (0x10080E << 1)), 0x01),   // Enable 384MHz clock
WREG   ((REG_ADDR_BASE + (0x100804 << 1)), 0x0110),

WREG_B ((REG_ADDR_BASE + (0x100820 << 1)), 0xC0),   // UPLL1 (0x100820)
...
WREG   ((REG_ADDR_BASE + (0x103808 << 1)), 0x040F), // UTMI2 (0x103800)
WREG   ((REG_ADDR_BASE + (0x103800 << 1)), 0x7F05),
...
WREG_B ((REG_ADDR_BASE + (0x113800 << 1)), 0x0A),   // Disable MAC initial suspend, Reset UHC
WREG_B ((REG_ADDR_BASE + (0x113800 << 1)), 0x28),   // Release UHC reset, enable UHC and OTG XIU function

                                                    // Module: utmi2 (0x103800)
WREG   ((REG_ADDR_BASE + (0x103822 << 1)), 0x2088), // PLL_TEST[30:28]: 3'b101 for IBIAS current select
WREG   ((REG_ADDR_BASE + (0x103820 << 1)), 0x8051), // PLL_TEST[15]: Bypass 480MHz clock divid
WREG   ((REG_ADDR_BASE + (0x103802 << 1)), 0x2084), // Enable CLK12_SEL bit <2> for select low voltage crystal clock
WREG   ((REG_ADDR_BASE + (0x103808 << 1)), 0x0426), // bit<7>: Power down UTMI port-0 bandgap current

WREG   ((REG_ADDR_BASE + (0x103800 << 1)), 0x6BC3), // reg_pdn: bit<15>, bit <2> ref_pdn  # Turn on reference voltage and regulator
{CHIPCFG_CMD_WAIT, 1}, // delay 1ms

WREG   ((REG_ADDR_BASE + (0x103800 << 1)), 0x69C3), // Turn on UPLL, reg_pdn: bit<9>
{CHIPCFG_CMD_WAIT, 2}, // delay 2ms

WREG   ((REG_ADDR_BASE + (0x103800 << 1)), 0x0001), // Turn all (including hs_current) use override mode
