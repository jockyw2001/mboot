...
_RV32_2(0x1206, 0x0428),   //jc_db: should be 0x3420? //refresh cycle=0x20 ,TURN_ON_SCRAMBLE=0x8420
#if (ENABLE_MEM800MHz)
...
#endif
#if (ENABLE_MEM1066MHz)
_RV32_2(0x120c, 0x7496),   //jc_db: should be 0x5486? //reg_tWL
#endif
...
_RV32_2(0x0d0e, 0x02a7),   // 2/2 reg_en_mask clr bit6 eg_dqsm_rst_sel
#endif
