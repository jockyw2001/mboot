...
_RV32_2(0x1206, 0x8446),   //jc_db: should be 0x3420? //refresh cycle=0x20 ,TURN_ON_SCRAMBLE=0x8420
_RV32_2(0x1208, 0x1cbb),   //jc_db: should be 0x1877? //reg_tRCD
_RV32_2(0x120a, 0x2766),   //jc_db: should be 0x1F46? //reg_tRRD
...
_RV32_2(0x1212, 0x4004),   //MR1 DDR3 ODT 120ohm //  _RV32_2(0x101212, 0x4040),   //MR1 DDR3 ODT 120ohm
_RV32_2(0x1214, 0x8018),   //MR2
_RV32_2(0x1216, 0xC000),   //MR3
