...
#include "script_clk_gen.h"
        ...
        {CHIPCFG_CMD_BASE, 0xBF00},
        {0x11C4, 0x0FFF},      // CSZ clock adjust
        {0x11C8, 0x0001},      // enable fast Mode
        ...
        {0x310C, 0x0004},      // 0x101843[2]: Fast sync disable #//0x101843[1]: Read request pack enable
        {CHIPCFG_CMD_BASE, 0xBF20},
        ...
        {0x3100, 0xB090},
        {CHIPCFG_CMD_BASE_8BITS, 0xBF20},
        {0x310C, 0x0101},      // 0x101843[0]: Write through enable when write hit
        {CHIPCFG_CMD_BASE, 0xBF20},
...
#define ENABLE_MEM1066MHz 0
...
#endif
#if ( MIU_INTERFACE == DDR2_INTERFACE_QFP_2L)
    #include "script_MIU_init_ddr2_216Pin_2L.h"
#elif ( MIU_INTERFACE == DDR2_INTERFACE_QFP_4L)
    #include "script_MIU_init_ddr2_216Pin_4L.h"
    ...
    #include "script_MIU_init_ddr3_128LQ.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_QFP_8BIT_MODE)
    #include "script_MIU_init_ddr3_8bit_216LQ.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_QFP_156)
    #include "script_MIU_init_ddr3_156LQ.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_QFP_156_8BIT_MODE)
    #include "script_MIU_init_ddr3_8bit_156LQ.h"
#elif ( MIU_INTERFACE == DDR2_INTERFACE_QFP_156)
    #include "script_MIU_init_ddr2_156Pin.h"
#elif ( MIU_INTERFACE == DDR2_INTERFACE_BGA)
    #include "script_MIU_init_ddr2_BGA.h"
#elif ( MIU_INTERFACE == DDR2_INTERFACE_236BGA)
    #include "script_MIU_init_ddr2_236BGA.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_236BGA)
    #include "script_MIU_init_ddr3_236BGA.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_BGA)
    #include "script_MIU_init_ddr3_BGA.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_KGB_BGA)
    #include "script_MIU_init_ddr3_KGB_BGA.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_KGC_BGA)
    #include "script_MIU_init_ddr3_KGC_BGA.h"
#else
