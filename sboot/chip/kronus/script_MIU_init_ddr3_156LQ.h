...
_RV32_2(0x120c, 0x96c8),   //jc_db: should be 0x5486? //reg_tWL
_RV32_2(0x120e, 0x4080),   //tRFC

_RV32_2(0x1210, 0x1c70),   //jc_db: should be 0x0e72? //MR0
//wriu -w 0x101212 0x4000   //MR1
_RV32_2(0x1212, 0x4042),   //MR1 DDR3 ODT 120ohm
_RV32_2(0x1214, 0x8018),   //MR2
_RV32_2(0x1216, 0xC000),   //MR3

_RV32_2(0x1228, 0x8000),   //pack_en is i'b1 when DDR3-16 mode
_RV32_2(0x122c, 0x30CB), //Balance moe:0x0B38 default; 0x1126 enable
//======MIU_ATOP initial======
{CHIPCFG_CMD_BASE, 0xbf22},
_RV32_2(0x0d00, 0x0281),   //miu_0_atop  start
_RV32_2(0x0d10, 0x0000),   //miu_0_atop  start
...
#if(ENABLE_MSTAR_DDR_128MB)
_RV32_2(0x0d38, 0x0155),    //0x2366  //2014-5-9
#else
_RV32_2(0x0d38, 0x2366),
#endif
//wriu -w 0x110d3a 0x0000   // mclk1x_skew cmd phase /dqsmask0 /mclk /dqsmask1 phase select
_RV32_2(0x0d3a, 0x0080),
_RV32_2(0x0d54, 0x0440), //Command driving
_RV32_2(0x0d5c, 0x4444),
_RV32_2(0x0d5e, 0x4444),
#if(ENABLE_MSTAR_DDR_128MB)
_RV32_2(0x0d74, 0x6666),    //0x3333  2014-5-9
#else
_RV32_2(0x0d74, 0x3333),
#endif
_RV32_2(0x0d02, 0x0000),
_RV32_2(0x0d3c, 0x1780),   //jc_db: should be 0x0200?
