...
{CHIPCFG_CMD_BASE, 0xbf20},
_RV32_2(0x122c, 0x1126), //Balance moe:0x0B38 default; 0x1126 enable
#else
...
#if !(ENABLE_MSTAR_KRONUS_BD_MST124I_D01A_S || ENABLE_MSTAR_KRONUS_BD_MST124H_D01A)
_RV32_2(0x0d00, 0x0401),   //  _RV32_2(0x110d00, 0x0201),   //miu_0_atop  start
#endif
