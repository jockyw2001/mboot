...
#if (ENABLE_MSTAR_DDR_256MB)
#elif (ENABLE_MSTAR_DDR_512MB)
#else
#error "Invalid MIU DRAM Size Selection"
#endif
#else
...
_RV32_2(0x1206, 0x8450),      //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
#if (ENABLE_MEM1300MHz)
...
_RV32_2(0x1208, 0x1CBB),      //reg_tRCD
_RV32_2(0x120a, 0x2766),      //reg_tRRD
#if (ENABLE_MSTAR_DDR_512MB)
_RV32_2(0x120c, 0xB6CA),      //reg_tWL
_RV32_2(0x120e, 0x40C0),      //tRFC
#else
_RV32_2(0x120c, 0x96CA),      //reg_tWL
...
_RV32_2(0x1204, 0x000B),      //if I64Mode =0x8b else =0x0b
#if (ENABLE_MSTAR_DDR_512MB_512MB)
_RV32_2(0x1206, 0x0430),      //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
#else
...
_RV32_2(0x1228, 0xb270),      //pack_en enable  & MIU0 ODT
...
_RV32_2(0x0d28, 0x000D),
_RV32_2(0x0d2a, 0x0535),
...
_RV32_2(0x0d38, 0x0045),
_RV32_2(0x0d3a, 0x0000),
_RV32_2(0x0d3c, 0x0077),
#if (ENABLE_MSTAR_DDR_512MB_512MB)
_RV32_2(0x0d38, 0x0044),
#elif(ENABLE_MSTAR_DDR_256MB)
_RV32_2(0x0d38, 0x0044),
#elif(ENABLE_MSTAR_DDR_512MB)
_RV32_2(0x0d38, 0x0044),
#else
_RV32_2(0x0d38, 0x1055),
#endif
_RV32_2(0x0d3a, 0x0000),
_RV32_2(0x0d3c, 0x0077),
...
_RV32_2(0x0d5c, 0x4444),    //set MIU0 Dringing
_RV32_2(0x0d5e, 0x4444),    //set MIU0 Dringing
...
_RV32_2(0x0d72, 0x8803),
_RV32_2(0x0d72, 0x8803),
_RV32_2(0x0d0e, 0x00a5),      // 2/2 reg_en_mask clr bit6 eg_dqsm_rst_sel
{CHIPCFG_CMD_BASE, 0xbf20},
_RV32_2(0x121e, 0x0c01),
...
//
#if (ENABLE_MEM1300MHz)
_RV32_2(0x0db6, 0x4001),      // mclk1x_clkph_ck0 / input div_1st/loop_div_1st
...
_RV32_2(0x0604, 0x000B),
#if (ENABLE_MSTAR_DDR_512MB_512MB)
_RV32_2(0x0606, 0x0430),      //refresh cycle=0x20 ,TURN_ON_SCRAMBLE=0x8420
#else
...
_RV32_2(0x0628, 0xb270),      //pack_en enable & MIU1 ODT
_RV32_2(0x062c, 0x71C1),      // Address Balance Mode
_RV32_2(0x0630, 0x0000),
{CHIPCFG_CMD_BASE, 0xbf22},
_RV32_2(0x0dd4, 0x0000),      //miu_0_atop  start
...
_RV32_2(0x0daa, 0x0458),    //set MIU ssc
_RV32_2(0x0dac, 0x0014),
_RV32_2(0x0dae, 0x0000),
#if (ENABLE_MEM1300MHz)
_RV32_2(0x0db8, 0x0054),
#endif
_RV32_2(0x0dba, 0x0000),
_RV32_2(0x0dbc, 0x0077),
#if (ENABLE_MEM1300MHz)
#if (ENABLE_MSTAR_DDR_512MB_512MB)
_RV32_2(0x0db8, 0x0043),
#else
_RV32_2(0x0db8, 0x0155),
#endif
#endif
_RV32_2(0x0dba, 0x0000),
_RV32_2(0x0dbc, 0x0077),
...
_RV32_2(0x0ddc, 0x4444),    //set MIU1 Dringing
_RV32_2(0x0dde, 0x4444),    //set MIU1 Dringing
...
#if (ENABLE_MSTAR_DDR_512MB_512MB)
_RV32_2(0x0dee, 0x0088),
#else
_RV32_2(0x0dee, 0x0089),
#endif
#if (ENABLE_MEM1300MHz)
_RV32_2(0x0df2, 0x8f03),
_RV32_2(0x0df2, 0x8f03),
#endif
_RV32_2(0x0d8e, 0x00a5),       // 2/2 reg_en_mask clr bit6 eg_dqsm_rst_sel
{CHIPCFG_CMD_BASE, 0xbf20},
_RV32_2(0x061e, 0x0c01),
