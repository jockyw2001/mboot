...
#if ( MIU_INTERFACE == DDR3_INTERFACE_QFP_256)
	#include "script_MIU_init_ddr3_256LQ.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_BGA_425_2L)
	#include "script_MIU_init_ddr3_425BGA_2L.h"
#elif ( MIU_INTERFACE == DDR3_INTERFACE_BGA_425_4L)
	#include "script_MIU_init_ddr3_425BGA_4L.h"
#else
