...
#define ENABLE_MEM1066MHz 0
    ...
    {CHIPCFG_CMD_BASE, 0xBF20},
    {CHIPCFG_CMD_IF, 0x3d80},
    {0x0200, 0x0200},
    #include "script_MIU_init_ddr2_ESMT.h"
    {CHIPCFG_CMD_DBG,  0x5007},
    {CHIPCFG_CMD_ENDIF, 0xFFFF},
    {CHIPCFG_CMD_IF, 0x3d80},
    {0x0000, 0x0200},
    #include "script_MIU_init_ddr2_Winbond.h"
    {CHIPCFG_CMD_DBG,  0x5008},
    {CHIPCFG_CMD_ENDIF, 0xFFFF},
#elif ( MIU_INTERFACE == DDR3_INTERFACE_QFP_128)
    #include "script_MIU_init_ddr3_Nanya.h"
#else
