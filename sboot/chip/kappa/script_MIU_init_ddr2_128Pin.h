...
_RV32_2(0x0d74, 0x0033),    //Trigger level
#else
_RV32_2(0x0d5c, 0x7777),    //Driver strength
_RV32_2(0x0d5e, 0x7777),    //Driver strength
_RV32_2(0x0d74, 0x0055),    //Trigger level
#endif
...
#else
_RV32_2(0x0d36, 0x4004),
#endif
_RV32_2(0x0d34, 0x0400),
#if ENABLE_MEM1066MHz
_RV32_2(0x0d30, 0xdf56),    //Clock generator frequency set
_RV32_2(0x0d32, 0x0033),    //MCLK Freq (miu0)
#else
_RV32_2(0x0d30, 0x1eb8),
_RV32_2(0x0d32, 0x0045),
#endif
_RV32_2(0x0d28, 0x0033),    //SSC enable (step)
_RV32_2(0x0d2a, 0x029a),    //SSC  period (span)
...
#endif
_RV32_2(0x1204, 0x048c),    //RD timing (miu0)
_RV32_2(0x1206, 0x0330),    //CSZ_Always_On
_RV32_2(0x1208, 0x1877),    //tRAS/tRP/tRCD
_RV32_2(0x120a, 0x1f46),    //tRC/tRTP/tRRD
_RV32_2(0x120c, 0x5486),    //tRTW/tWTR/tWR/tWL
#if ENABLE_MSTAR_DDR_64MB
_RV32_2(0x120e, 0x2038),   //tCCD/tRFC
#else
_RV32_2(0x120e, 0x2044),   //tCCD/tRFC
#endif
_RV32_2(0x1210, 0x0e72),   //MRS
_RV32_2(0x1212, 0x4004),   //EMRS 1
_RV32_2(0x1214, 0x8000),   //EMRS 2
_RV32_2(0x1216, 0xC000),   //MR3

//======MIU_ATOP initial======
{CHIPCFG_CMD_BASE, 0xbf22},
_RV32_2(0x0d54, 0x0000),
_RV32_2(0x0d00, 0x0019),   //miu_0_atop  start
#if ENABLE_MEM1066MHz
_RV32_2(0x0d38, 0x0044),    //write DQ phase
_RV32_2(0x0d3a, 0x6065),    //write CMD phase
#else
_RV32_2(0x0d38, 0x1155),
...
#else
_RV32_2(0x0d3c, 0x0033),
#endif
_RV32_2(0x0d3e, 0x1011),    //Write CLK/CMD/DQ skew(miu0)
_RV32_2(0x0d4c, 0x1111),
_RV32_2(0x0d0e, 0x00a9),
_RV32_2(0x0d0e, 0x00e9),
_RV32_2(0x0d0e, 0x00a9),
#if ENABLE_MEM1066MHz
#if ENABLE_MSTAR_DDR_64MB
_RV32_2(0x0d6e, 0x5577),
#else
_RV32_2(0x0d6e, 0x7686),    //Read DQS 0/1 phase (miu0)
#endif
#else
...
_RV32_2(0x0d00, 0x0019),
_RV32_2(0x0d00, 0x0011),
#if ENABLE_MEM1066MHz
_RV32_2(0x0d00, 0x0201),	//A-top ODT (miu0)
#else
...
// Pack setting
//---------------------------------
_RV32_2(0x1228, 0x409c),    //ODT mask/delay (miu0)
...
{CHIPCFG_CMD_BASE, 0xbf22},
_RV32_2(0x0d0e, 0x00e9),    //dqsm_rst = 1
{CHIPCFG_CMD_BASE, 0xbf20},
...
{CHIPCFG_CMD_BASE, 0xbf22},
_RV32_2(0x0d0e, 0x00a9),    //Read DQSM 0/1 delay (miu0)
{CHIPCFG_CMD_WAIT, 10}, //wait 10
