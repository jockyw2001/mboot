...
#else
_RV32_2(0x0d5c, 0xcccc),    //Driver strength
_RV32_2(0x0d5e, 0xcccc),    //Driver strength
#endif

#if ENABLE_MEM1300MHz
_RV32_2(0x0d74, 0x0044),    //Trigger level
#else
_RV32_2(0x0d74, 0x0022),    //Trigger level
#endif
...
_RV32_2(0x1206, 0x0c30),    //CSZ Always ON
...
_RV32_2(0x0d3a, 0x4053),    //write CMD phase
//_RV32_2(0x0d48, 0x0042),
_RV32_2(0x0d4a, 0x0002),
_RV32_2(0x0d52, 0x0066),
_RV32_2(0x0d6c, 0x5555),
_RV32_2(0x0d6e, 0x865b),    //Read DQS 0/1 phase (miu0)
