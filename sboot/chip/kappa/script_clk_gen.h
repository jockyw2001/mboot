...
//clk_spi
WREG(REG_ADDR_BASE + (0x100b2c << 1), 0x0010),  //clk_spi Switch to 54MHz
WREG(REG_ADDR_BASE + (0x100b2c << 1), 0x0030),  //Change clock from xtal to clk_spi
...
WREG(REG_ADDR_BASE + (0x10337c << 1), 0x0001),  // clk_ddr_syn = 432M (for MEMPLL  0: 216M, 1:432M)
...
//HDMI TX clock jitter patch
WREG(REG_ADDR_BASE + (0x113056 << 1), 0x0001),
WREG(REG_ADDR_BASE + (0x113058 << 1), 0x0007),
WREG(REG_ADDR_BASE + (0x11305c << 1), 0x0f9f),
WREG(REG_ADDR_BASE + (0x11305e << 1), 0x0000),
WREG(REG_ADDR_BASE + (0x113066 << 1), 0x0020),
