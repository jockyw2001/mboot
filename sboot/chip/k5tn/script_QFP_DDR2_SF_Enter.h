...
//******************************************************************************
//<MStar Software> 
{CHIPCFG_CMD_WAIT, 1}, //10_DDR3_SF_Enter, Enter Self-Refresh procedure start   // delay 1ms
...
_RV32_2(0x15e6, 0xfffe), //1028_mdy
...
{CHIPCFG_CMD_WAIT, 100},  // Enter Self-Refresh procedure end
