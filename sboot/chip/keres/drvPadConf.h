...
// Script Generated GPIO
    ...
    _RVM1(0x250c, PAD_SM0_GPIO_OUT, BIT12),
    _RVM1(0x250c, PAD_SM0_GPIO_OEN, BIT13),
    //reg_sm0_gpio_en=1
    //Reg[101e50]#8=1
    _RVM1(0x1e51, BIT0, BIT0),     
    //reg_pd_smc_pad=0
...
//---------------------------------------------------------------------
    ...
    #define I2CM0_MODE ((PADS_I2CM0_MODE == PAD_I2CM0_SDA) ? (BIT0) : \
                      ...
                      (PADS_I2CM0_MODE == PAD_FUART_CTS) ? (BIT1) : \
                      (PADS_I2CM0_MODE == PAD_FUART_RTS) ? (BIT1) : \
