...
#define _MapBase_nonPM_KRATOS (RIU_MAP + 0x200000)
#define _MapBase_PM_KRATOS    RIU_MAP
#else
#define _MapBase_nonPM_KRATOS 0xA0200000
#define _MapBase_PM_KRATOS   0xA0000000
#endif
...
#if (ENABLE_MSTAR_KRATOS_BD_FPGA==1)
    _END_OF_TBL2_
#else
//---------------------------------------------------------------------
// GPIO Configuartion
//---------------------------------------------------------------------
    ...
    //reg_ThirdUARTMode 
    //_RVM1(0x1e06, 0, BIT6~BIT4 ),   //reg[101e06]#6~#4 = 000b
    //reg_ForthUARTMode 
    //_RVM1(0x1e06, 0, BIT10~BIT8 ),   //reg[101e06]#10~#8 = 000b
    //reg_FastUartMode 
    //_RVM1(0x1e06, 0, BIT13~BIT11 ),   //reg[101e06]#13~#11 = 000b
    #endif
    ...
    #define PAD_TESTPIN_OEN (PAD_TESTPIN_IS_GPIO == GPIO_IN ? BITNA: 0)
    #define PAD_TESTPIN_OUT (PAD_TESTPIN_IS_GPIO == GPIO_OUT_HIGH ? BITNA: 0)
    _RVM1(0x, PAD_TESTPIN_OUT, BITNA),
    _RVM1(0x, PAD_TESTPIN_OEN, BITNA),
    //NA
    #endif
#endif
    ...
    _RVM1(0x2506, PAD_SM0_CLK_OUT, BIT4),
    _RVM1(0x2506, PAD_SM0_CLK_OEN, BIT5),
    //chip_config != 1
    //chip_config != 2
    //chip_config != 3
    //reg_allpad_in 
    ...
    _RVM1(0x2504, PAD_SM0_CD_OUT, BIT4),
    _RVM1(0x2504, PAD_SM0_CD_OEN, BIT5),
    //chip_config != 1
    //chip_config != 2
    //chip_config != 3
    //reg_allpad_in 
    ...
    //_RVM1(0x1e13, 0, BIT2~BIT0 ),   //reg[101e13]#2~#0 = 000b
    //reg_i2s_out_mode 
    //_RVM1(0x1e0b, 0, BIT5~BIT4 ),   //reg[101e0b]#5~#4 = 00b
    //reg_SecondUARTMode
    //_RVM1(0x1e06, 0, BIT2~BIT0 ),   //reg[101e06]#2~#0 = 000b
    ...
    #if(PAD_S_GPIO6_IS_GPIO != GPIO_NONE)
    #define PAD_S_GPIO6_OEN (PAD_S_GPIO6_IS_GPIO == GPIO_IN ? BIT5: 0)
    #define PAD_S_GPIO6_OUT (PAD_S_GPIO6_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
    _RVM1(0x25a8, PAD_S_GPIO6_OUT, BIT4),
    _RVM1(0x25a8, PAD_S_GPIO6_OEN, BIT5),
    //reg_allpad_in 
    //_RVM1(0x1ea0, 0, BIT15 ),   //reg[101ea0]#15 = 0b
    //reg_test_in_mode 
    //_RVM1(0x1e24, 0, BIT2~BIT0 ),   //reg[101e24]#2~#0 = 000b
    ...
    //_RVM1(0x1e13, 0, BIT2~BIT0 ),   //reg[101e13]#2~#0 = 000b
    //reg_ts0_mode
    //_RVM1(0x1e04, 0, BIT3~BIT0 ),   //reg[101e04]#3~#0 = 0000b
    #endif
    ...
    //_RVM1(0x1e04, 0, BIT3~BIT0 ),   //reg[101e04]#3~#0 = 0000b
    //reg_ts1_mode
    //_RVM1(0x1e04, 0, BIT6~BIT4 ),   //reg[101e04]#6~#4 = 0000b
    #endif
    ...
    //_RVM1(0x1e12, 0, BIT6~BIT4 ),   //reg[101e12]#6~#4 = 000b
    //reg_mcu_jtag_mode 
    //_RVM1(0x1eaa, 0, BIT3~BIT0 ),   //reg[101eaa]#3~#0 = 0000b
    //reg_SecondUARTMode
    //_RVM1(0x1e06, 0, BIT2~BIT0 ),   //reg[101e06]#2~#0 = 000b
    //reg_ThirdUARTMode 
    //_RVM1(0x1e06, 0, BIT6~BIT4 ),   //reg[101e06]#6~#4 = 000b
    ...
    #if(PAD_DISEQ_IN_IS_GPIO != GPIO_NONE)
    #define PAD_DISEQ_IN_OEN (PAD_DISEQ_IN_IS_GPIO == GPIO_IN ? BIT5: 0)
    #define PAD_DISEQ_IN_OUT (PAD_DISEQ_IN_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
    _RVM1(0x25b0, PAD_DISEQ_IN_OUT, BIT4),
    _RVM1(0x25b0, PAD_DISEQ_IN_OEN, BIT5),
    //reg_allpad_in 
    //_RVM1(0x1ea0, 0, BIT15 ),   //reg[101ea0]#15 = 0b
    //reg_test_in_mode 
    //_RVM1(0x1e24, 0, BIT2~BIT0 ),   //reg[101e24]#2~#0 = 000b
    ...
    //_RVM1(0x1e06, 0, BIT13~BIT11 ),   //reg[101e06]#13~#11 = 000b
    //reg_diseq_in_en
    //_RVM1(0x1e3a, 0, BIT2 ),   //reg[101e3a]#2 = 0b
    #endif

    #if(PAD_DISEQ_OUT_IS_GPIO != GPIO_NONE)
    #define PAD_DISEQ_OUT_OEN (PAD_DISEQ_OUT_IS_GPIO == GPIO_IN ? BIT5: 0)
    #define PAD_DISEQ_OUT_OUT (PAD_DISEQ_OUT_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
    _RVM1(0x25b2, PAD_DISEQ_OUT_OUT, BIT4),
    _RVM1(0x25b2, PAD_DISEQ_OUT_OEN, BIT5),
    //chip_config != 0
    //reg_allpad_in 
    //_RVM1(0x1ea0, 0, BIT15 ),   //reg[101ea0]#15 = 0b
    //reg_SecondUARTMode
    ...
    //_RVM1(0x1e06, 0, BIT13~BIT11 ),   //reg[101e06]#13~#11 = 000b
    //reg_diseq_out_en
    //_RVM1(0x1e3a, 0, BIT3 ),   //reg[101e3a]#3 = 0b
    #endif
...
//---------------------------------------------------------------------
    ...
    #define FAST_UART_MODE ((PAD_FAST_UART_MODE == PAD_MUX_MODE_1) ? (BIT4) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_2) ? (BIT5) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_3) ? (BIT5|BIT4) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_4) ? (BIT6) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_5) ? (BIT6|BIT4) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_6) ? (BIT6|BIT5) : \
                            (PAD_FAST_UART_MODE == PAD_MUX_MODE_7) ? (BIT6|BIT5|BIT4) : 0)

    _RVM1(0x1E07, FAST_UART_MODE, BITMASK(6:4)),
    ...
    #define DISEQ_IN_EN ((PAD_DISEQ_IN_EN_MODE == PAD_MUX_MODE_1) ? (BIT2) : 0)

    _RVM1(0x1E3A, DISEQ_IN_EN, BIT2),


    #define DISEQ_OUT_EN ((PAD_DISEQ_OUT_EN_MODE == PAD_MUX_MODE_1) ? (BIT3) : 0)

    _RVM1(0x1E3A, DISEQ_OUT_EN, BIT3),
