...
static void BootRom_MiuDdr3Dqs(MS_U8 u8MiuDev)
{
    ...
    if (u8MiuDev == 0)
    {
        MHal_MIU_WritReg16(MIU0_RIU_ARB, 0x74, 0x0c61);
    }
    else if (u8MiuDev == 1)
    {
        MHal_MIU_WritReg16(MIU1_RIU_ARB, 0x74, 0x0c61);
...
static void Miu_BistTest(MS_U8 u8MIU)
{
    ...
    MHal_MIU_WritReg16(MIU0_RIU_DTOP, 0xe4, u16Lo);

    MHal_MIU_WritReg16(MIU0_RIU_DTOP, 0xe6, u16Hi);
