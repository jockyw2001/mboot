...
#if ( MS_BOARD_TYPE_SEL == BD_MST221D_D01A_S) || \
      ( MS_BOARD_TYPE_SEL == BD_MST221D_D01A)

// disable YPbPr
WREG_B(REG_ADDR_BASE + (0x101a06 << 1), 0x00),

// disable RF
WREG(REG_ADDR_BASE + (0x1128a2 << 1), 0x0000),
WREG(REG_ADDR_BASE + (0x160be0 << 1), 0x0000),
WREG_B(REG_ADDR_BASE + (0x100b6c << 1), 0x01),
...
// disable LAN
//WREG_B(REG_ADDR_BASE + (0x0032b7 << 1), 0x17), // Power-down ADC	
...
//WREG_B(REG_ADDR_BASE + (0x0032cd << 1), 0xd9), // Power-down ADCPL	
WREG_B(REG_ADDR_BASE + (0x0032ea << 1), 0x60), // down PORST		
WREG(REG_ADDR_BASE + (0x0032ba << 1), 0xf503), // Power-on REF off
WREG(REG_ADDR_BASE + (0x0032ca << 1), 0x131a), // Power-on BGAP off

WREG(REG_ADDR_BASE + (0x0032fc << 1), 0x0102), // Power-down LDO	

//WREG_B(REG_ADDR_BASE + (0x0033c5 << 1), 0x40), // 100gat =1
