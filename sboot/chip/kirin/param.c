...
#if ( MS_BOARD_TYPE_SEL == BD_MST221C_D01A_S_15) || \
    ( MS_BOARD_TYPE_SEL == BD_MST221C_D01A_15)
    #if (ENABLE_MEM1866MHz)    
        #include "script_MIU_init_ddr3_1866_MCP15x15.h"
    #elif (ENABLE_MEM1600MHz)
        #include "script_MIU_init_ddr3_1600_MCP15x15.h"
    #else
        #error "not supported DDR configuration"
    #endif        
#elif ( MS_BOARD_TYPE_SEL == BD_MST221C_D02A_17)
        #include "script_MIU_init_ddr3_1866_MCP15x17.h"
