...
#define ENABLE_MIU1 0
    ...
    _RV32_2(0x1204, 0x0053),
#if (ENABLE_MEM1866MHz)
    _RV32_2(0x1206, 0x1571),
#elif (ENABLE_MEM1600MHz)
    _RV32_2(0x1206, 0x1560),
#elif (ENABLE_MEM1333MHz)
    _RV32_2(0x1206, 0x154f),
#else
    #error "Invalid DRAM Setting"
#endif
#else // 8X_MODE
...
#if defined(CONFIG_MSTAR_KANO_BD_MST231B_D01A_S)
    _RV32_2(0x0d3a, 0x0004),
#else
    _RV32_2(0x0d3a, 0x0008),
#endif
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x0d3c, 0x9122),
    _RV32_2(0x0d3e, 0x3011),
#else
    _RV32_2(0x0d3c, 0x9566),
    _RV32_2(0x0d3e, 0xb055),
#endif
    _RV32_2(0x0d48, 0x1177),
#if defined(CONFIG_MSTAR_KANO_BD_MST231A_D01A_S)
...
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x0db8, 0x1111),
    _RV32_2(0x0dba, 0x0111),
    _RV32_2(0x0dbc, 0x0111),
    _RV32_2(0x0dbe, 0x0111),
#else
    _RV32_2(0x0db8, 0x5555),
    _RV32_2(0x0dba, 0x0555),
    _RV32_2(0x0dbc, 0x0555),
    _RV32_2(0x0dbe, 0x0555),
#endif
    // TX DQ
...
//    _RV32_2(0x121e, 0x8c00),
   ...
   {CHIPCFG_CMD_BASE, 0x1f2c},
    ...
    _RV32_2(0x1636, 0x0400),
    _RV32_2(0x1634, 0x2004),
    _RV32_2(0x1630, 0x7b7c),
    _RV32_2(0x1632, 0x0029),
#else
    #error "Invalid DRAM Setting"
#endif
...
#endif
    _RV32_2(0x162e, 0x4321),
    _RV32_2(0x1638, 0x0077),
#if defined(CONFIG_MSTAR_KANO_BD_MST231A_D01A_S)
    _RV32_2(0x163a, 0x0008),
#elif defined(CONFIG_MSTAR_KANO_BD_MST231B_D01A_S)
    _RV32_2(0x163a, 0x4044),
#else
    _RV32_2(0x163a, 0x4048),
#endif
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x163c, 0x9122),
    _RV32_2(0x163e, 0x3011),
#else
    _RV32_2(0x163c, 0x9566),
    _RV32_2(0x163e, 0xb055),
#endif
    _RV32_2(0x1648, 0x4477),
    _RV32_2(0x164a, 0x7070),
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x164c, 0x0022),
    _RV32_2(0x164e, 0x0011),
#else
    _RV32_2(0x164c, 0x0066),
...
#if (ENABLE_MIU_4X_MODE)
    _RV32_2(0x16b8, 0x1111),
    _RV32_2(0x16ba, 0x0111),
    _RV32_2(0x16bc, 0x0111),
    _RV32_2(0x16be, 0x0111),
#else
    _RV32_2(0x16b8, 0x5555),
    _RV32_2(0x16ba, 0x0555),
    _RV32_2(0x16bc, 0x0555),
    _RV32_2(0x16be, 0x0555),
#endif
    // TX DQ
