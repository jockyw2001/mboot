...
#define ENABLE_MIU1 0
    ...
    _RV32_2(0x0d20, 0x0022), //reg_ddrpll_en_lfreq
    _RV32_2(0x0d30, 0xdf56),
    _RV32_2(0x0d32, 0x0033),
    // DDR LDO power down off
    _RV32_2(0x0d8a, 0x0003), //reg_ddrldo_idc = 1 for LPDDR3
    ...
    _RV32_2(0x1204, 0xb052),
    _RV32_2(0x1206, 0x4740),
    ...
    _RV32_2(0x0d3a, 0xd0d2),
    _RV32_2(0x0d3c, 0x9300),
    _RV32_2(0x0d3e, 0x1033),
    _RV32_2(0x0d48, 0x0077),
    _RV32_2(0x0d4a, 0xd0d0),
    _RV32_2(0x0d4c, 0x0000),
    _RV32_2(0x0d4e, 0x0011),
    _RV32_2(0x0d50, 0x1100),
    _RV32_2(0x0d52, 0x0077),
    _RV32_2(0x0d6c, 0x0808),
    _RV32_2(0x0d6e, 0x0808),

    _RV32_2(0x0da0, 0x0413),
    _RV32_2(0x0da2, 0x1503),
    _RV32_2(0x0da4, 0x1030),
    _RV32_2(0x0da6, 0x5110),
    _RV32_2(0x0da8, 0x2321),
    _RV32_2(0x0daa, 0x3110),
    _RV32_2(0x0dac, 0x7074),
    _RV32_2(0x0dae, 0x5656),
    ...
    _RV32_2(0x0dd6, 0x5444),
    _RV32_2(0x0dd8, 0x0055),
    _RV32_2(0x0de0, 0x4343),
    _RV32_2(0x0de2, 0x4343),
    _RV32_2(0x0de4, 0x4344),
    _RV32_2(0x0de6, 0x4444),
    _RV32_2(0x0de8, 0x0033),
    _RV32_2(0x0d94, 0x0807),
    _RV32_2(0x0d96, 0x0808),
    ...
    _RV32_2(0x0d70, 0x0800),
    // driving setting
    _RV32_2(0x0d58, 0x0f0f),
    _RV32_2(0x0d5a, 0xffff),
    _RV32_2(0x0d5c, 0xaaff),
    _RV32_2(0x0d5e, 0xaaff),
    // trig. lvl setting
   ...
   {CHIPCFG_CMD_BASE, 0x1f2c},
    ...
    _RV32_2(0x1620, 0x0022), //reg_ddrpll_en_lfreq
    _RV32_2(0x1630, 0xdf56),
    _RV32_2(0x1632, 0x0033),
    ...
    // MIU1 Initial Table
    {CHIPCFG_CMD_BASE, 0x1f20},
    _RV32_2(0x0602, 0x02a7),
    _RV32_2(0x0604, 0xb052),
    _RV32_2(0x0606, 0x4771),
    _RV32_2(0x0608, 0xe841),
    _RV32_2(0x060a, 0x3b7a),
    _RV32_2(0x060c, 0x67e9),
    _RV32_2(0x060e, 0x407a),
    _RV32_2(0x0610, 0x0000),
    _RV32_2(0x0612, 0x0183),
    _RV32_2(0x0614, 0x021c),
    _RV32_2(0x0616, 0x0302),
    _RV32_2(0x0628, 0x00e0),
   ...
   {CHIPCFG_CMD_BASE, 0x1f2c},
    ...
    // RX DQs
    _RV32_2(0x16a0, 0x1111),
    _RV32_2(0x16a2, 0x1111),
    _RV32_2(0x16a4, 0x1111),
    _RV32_2(0x16a6, 0x1111),
    ...
    _RV32_2(0x16d4, 0x5555),
    _RV32_2(0x16d6, 0x5555),
    _RV32_2(0x16d8, 0x0055),
    ...
    _RV32_2(0x1670, 0x0800),
    // driving setting
    _RV32_2(0x1658, 0x0f0f),
    _RV32_2(0x165a, 0xffff),
    _RV32_2(0x165c, 0xaaff),
    _RV32_2(0x165e, 0xaaff),
    // trig. lvl setting
    _RV32_2(0x1674, 0x0606),
    _RV32_2(0x1676, 0x0606),
    _RV32_2(0x161a, 0xc333),
