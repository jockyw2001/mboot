...
//---------------------------------------------------------------------
    ...
    //reg_spi_is_gpio[4]=1
    _RVM1(0x0e6a, BIT4, BIT4),   //Reg[000e6a]#4=1
    #endif
    ...
    _RVM1(0x0e6a, 0, BIT7|BIT6),   //Reg[000e6a]#7~#6=0
    //reg_pwm0_mode[1:0]=0
    ...
    //reg_miic_mode[1:0]=0
    _RVM1(0x0e50, 0, BIT7|BIT6),   //Reg[000e50]#7~#6=0
    #endif
    ...
    _RVM1(0x0e6b, 0, BIT2|BIT1),   //Reg[000e6b]#2~#1=0
    #endif
    ...
    _RVM1(0x0e38, 0, BIT3),   //Reg[000e38]#3=0
    #endif
    ...
    //reg_spi_is_gpio[3]=0
    _RVM1(0x0e6a, 0, BIT3),   //Reg[000e6a]#3=0
    ...
    //reg_mspi_mode=0
    _RVM1(0x0e51, 0, BIT7),   //Reg[000e51]#7=0
    #endif
    ...
    _RVM1(0x0e4f, 0, BIT7),   //Reg[000e4f]#7=0
    #endif
    ...
    //reg_gpio2d0_en=1
    _RVM1(0x0496, BIT7, BIT7),   //Reg[000496]#7=1
    #endif
    ...
    _RVM1(0x0f50, PAD_GT1_MDIO_OUT, BIT1),
    _RVM1(0x0f50, PAD_GT1_MDIO_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f4e, PAD_GT1_MDC_OUT, BIT1),
    _RVM1(0x0f4e, PAD_GT1_MDC_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f52, PAD_GT1_RX_CLK_OUT, BIT1),
    _RVM1(0x0f52, PAD_GT1_RX_CLK_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f54, PAD_GT1_RX_CTL_OUT, BIT1),
    _RVM1(0x0f54, PAD_GT1_RX_CTL_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f56, PAD_GT1_RX_D0_OUT, BIT1),
    _RVM1(0x0f56, PAD_GT1_RX_D0_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f58, PAD_GT1_RX_D1_OUT, BIT1),
    _RVM1(0x0f58, PAD_GT1_RX_D1_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f5a, PAD_GT1_RX_D2_OUT, BIT1),
    _RVM1(0x0f5a, PAD_GT1_RX_D2_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f5c, PAD_GT1_RX_D3_OUT, BIT1),
    _RVM1(0x0f5c, PAD_GT1_RX_D3_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f5e, PAD_GT1_TX_CLK_OUT, BIT1),
    _RVM1(0x0f5e, PAD_GT1_TX_CLK_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f60, PAD_GT1_TX_CTL_OUT, BIT1),
    _RVM1(0x0f60, PAD_GT1_TX_CTL_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f62, PAD_GT1_TX_D0_OUT, BIT1),
    _RVM1(0x0f62, PAD_GT1_TX_D0_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f64, PAD_GT1_TX_D1_OUT, BIT1),
    _RVM1(0x0f64, PAD_GT1_TX_D1_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f66, PAD_GT1_TX_D2_OUT, BIT1),
    _RVM1(0x0f66, PAD_GT1_TX_D2_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    _RVM1(0x0f68, PAD_GT1_TX_D3_OUT, BIT1),
    _RVM1(0x0f68, PAD_GT1_TX_D3_OEN, BIT0),
    //reg_gt0_is_gpio=1
    _RVM1(0x0e39, BIT0, BIT0),   //Reg[000e39]#0=1
    #endif
    ...
    //reg_sar_aisel[3]=0
    _RVM1(0x1422, 0, BIT3),   //Reg[001422]#3=0
    #endif
    ...
    //reg_sar_aisel[4]=0
    _RVM1(0x1422, 0, BIT4),   //Reg[001422]#4=0
    #endif
    ...
    _RVM1(0x259a, PAD_CI_RST_OUT, BIT4),
    _RVM1(0x259a, PAD_CI_RST_OEN, BIT5),
    //reg_allpad_in
    _RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
    //reg_ci_mode
    ...
    _RVM1(0x259c, PAD_CI_WAITZ_OUT, BIT4),
    _RVM1(0x259c, PAD_CI_WAITZ_OEN, BIT5),
    //reg_allpad_in
    _RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
    //reg_ci_mode
    _RVM1(0x1e0e, 0, BIT6),   //reg[101e0e]#6 = 0b
    ...
    _RVM1(0x259e, PAD_CI_IRQAZ_OUT, BIT4),
    _RVM1(0x259e, PAD_CI_IRQAZ_OEN, BIT5),
    //reg_allpad_in
    _RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
    //reg_ci_mode
    _RVM1(0x1e0e, 0, BIT6),   //reg[101e0e]#6 = 0b
    ...
    //reg_sm1_en 
    _RVM1(0x1e19, UNKNOWN, BIT),   //reg[101e19]#1
    //reg_i2cm4_mode
    _RVM1(0x1e13, 0, BIT5|BIT4),   //reg[101e13]#5 ~ #4 = 00b
    //reg_ci_mode
    _RVM1(0x1e0e, 0, BIT6),   //reg[101e0e]#6 = 0b
...
//---------------------------------------------------------------------
    ...
    #define SPDIF_OUT_MODE ((PADS_SPDIF_OUT_MODE == PAD_SPDIF_OUT) ? (BIT4) : \
                            (PADS_SPDIF_OUT_MODE == PAD_GPIO8) ? (BIT5) : 0)

    _RVM1(0x1E0A, SPDIF_OUT_MODE, BITMASK(5:4)), 

    #define SPDIF_IN_MODE ((PADS_SPDIF_IN_MODE == PAD_I2S_OUT_SD0) ? (BIT0) : \
                           (PADS_SPDIF_IN_MODE == PAD_GPIO9) ? (BIT1) : 0)
    ...
    #define I2S_TRX_MODE ((PADS_I2S_TRX_MODE == PAD_I2S_OUT_SD1) ? (BIT2) : 0)

    _RVM1(0x1E0B, I2S_TRX_MODE, BIT2),

    #define I2S_OUT_MODE ((PADS_I2S_OUT_MODE == PAD_I2S_OUT_SD0) ? (BIT4) : 0)

    _RVM1(0x1E0B, I2S_OUT_MODE, BIT4),
    ...
    #define SM0_OPEN ((PADS_SM0_OPEN == PAD_SM0_CLK) ? (BIT0) : 0)

    _RVM1(0x1E18, SM0_OPEN, BIT0),

    #define OCP0_EN ((PADS_OCP0_EN == PAD_SM0_VCC) ? (BIT0) : 0)
    ...
    #define SM0_EN ((PADS_SM0_EN == PAD_SM0_CLK) ? (BIT0) : 0)

    _RVM1(0x1E19, SM0_EN, BIT0),
#if 0
    #define SM0_C48_OFF ((PADS_SM0_C48_OFF == PAD_SM0_C4) ? (BIT0) : 0)

    _RVM1(0x1E19, SM0_C48_OFF, BIT0), // can't find register, need confirm
#endif
    #define SM1_OPEN ((PADS_SM1_OPEN == PAD_CI_D0) ? (BIT1) : 0)

    _RVM1(0x1E18, SM1_OPEN, BIT1),

    #define OCP1_EN ((PADS_OCP1_EN == PAD_CI_D2) ? (BIT1) : 0)

    _RVM1(0x1E1C, OCP1_EN, BIT1),
    
    #define SM1_C48 ((PADS_SM1_C48 == PAD_CI_D6) ? (BIT6) : \
                     (PADS_SM1_C48 == PAD_CI_D7) ? (BIT7) : 0)

    _RVM1(0x1E18, SM1_C48, BITMASK(7:6)),

    #define SM1_IO ((PADS_SM1_IO == PAD_CI_D4) ? (BIT5) : 0)

    _RVM1(0x1E19, SM1_IO, BIT5),

    #define SM1_EN ((PADS_SM1_EN == PAD_CI_D0) ? (BIT1) : 0)

    _RVM1(0x1E19, SM1_EN, BIT1),
#if 0
    #define SM1_C48_OFF ((PADS_SM1_C48_OFF == PAD_SM0_C4) ? (BIT0) : 0)

    _RVM1(0x1E19, SM1_C48_OFF, BIT0), // can't find register, need confirm
#endif
    #define TS0_MODE ((PADS_TS0_MODE == PAD_TS0_CLK) ? (BIT0) : 0)

    _RVM1(0x1E04, TS0_MODE, BIT0),

    #define TS1_MODE ((PADS_TS1_MODE == PAD_TS1_CLK) ? (BIT1) : 0)
    ...
    #define TS2_MODE ((PADS_TS2_MODE == PAD_TS2_CLK) ? (BIT3) : \
                      (PADS_TS2_MODE == PAD_TS2_SYNC) ? (BIT4) : \
                      (PADS_TS2_MODE == PAD_TS2_VLD) ? (BIT4|BIT3) : 0)

    _RVM1(0x1E04, TS2_MODE, BITMASK(4:3)),

    #define NAND_MODE ((PADS_NAND_MODE == PAD_EMMC_IO0) ? (BIT2) : 0)

    _RVM1(0x1E0F, NAND_MODE, BIT2),
    ...
    #define I2CM4_MODE ((PADS_I2CM4_MODE == PAD_CI_D0) ? (BIT4) : \
                        (PADS_I2CM4_MODE == PAD_GPIO4) ? (BIT5) : 0)

    _RVM1(0x1E13, I2CM4_MODE, BITMASK(5:4)),

    #define SECOND_UART_MODE ((PADS_SECOND_UART_MODE == PAD_I2CM0_SCL) ? (BIT0) : \
                              (PADS_SECOND_UART_MODE == PAD_TS0_D4) ? (BIT1) : \
                              (PADS_SECOND_UART_MODE == PAD_HSYNC_OUT) ? (BIT1|BIT0) : 0)

    _RVM1(0x1E06, SECOND_UART_MODE, BITMASK(1:0)),

    #define THIRD_UART_MODE ((PADS_THIRD_UART_MODE == PAD_I2CM1_SCL) ? (BIT4) : \
                             (PADS_THIRD_UART_MODE == PAD_TS0_D4) ? (BIT5) : \
    ...
    #define FOURTH_UART_MODE ((PADS_FOURTH_UART_MODE == PAD_GPIO0) ? (BIT0) : \
                              (PADS_FOURTH_UART_MODE == PAD_TS0_D4) ? (BIT1) : \
                              (PADS_FOURTH_UART_MODE == PAD_GPIO2) ? (BIT1|BIT0) : 0)

    _RVM1(0x1E07, FOURTH_UART_MODE, BITMASK(1:0)),

    #define FUART_MODE ((PADS_FUART_MODE == PAD_GPIO4) ? (BIT2) : \
                        (PADS_FUART_MODE == PAD_TS0_SYNC) ? (BIT3) : 0)

    _RVM1(0x1E13, FUART_MODE, BITMASK(3:2)),

    #define FUART_EMMC_MODE ((PADS_FUART_EMMC_MODE == PAD_EMMC_IO12) ? (BIT6) : 0)

    _RVM1(0x1E13, FUART_EMMC_MODE, BIT6),

    #define SD_CONFIG ((PADS_SD_CONFIG == PAD_SD_CLK) ? (BIT0) : \
                       (PADS_SD_CONFIG == PAD_EMMC_IO0) ? (BIT1) : \
                       (PADS_SD_CONFIG == PAD_SM0_CLK) ? (BIT1|BIT0) : 0)

    _RVM1(0x1E11, SD_CONFIG, BITMASK(1:0)),
    ...
    #define EMMC_CONFIG ((PADS_EMMC_CONFIG == PAD_EMMC_IO0) ? (BIT0) : 0)

    _RVM1(0x1E10, EMMC_CONFIG, BIT0),

    #define CI_MODE ((PADS_CI_MODE == PAD_CI_RST) ? (BIT6) : 0)

    _RVM1(0x1E0E, CI_MODE, BIT6),
