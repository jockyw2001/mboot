...
WREG_B((REG_ADDR_BASE + (0x110966 <<1)) , 0x19),
#endif
...
WREG((REG_ADDR_BASE + (0x121166 <<1 )) , 0x0007),
WREG((REG_ADDR_BASE + (0x121168 <<1 )) , 0x0445),
...
WREG ((REG_ADDR_BASE + (0x1604c0 <<1)) , 0x44e3),
WREG ((REG_ADDR_BASE + (0x1604c2 <<1)) , 0x0032),
