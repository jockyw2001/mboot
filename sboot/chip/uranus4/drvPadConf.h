...
#define _MapBase_nonPM_U4 (RIU_MAP + 0x200000)
#define _MapBase_PM_U4    RIU_MAP
#else
#define _MapBase_nonPM_U4 0xA0200000
#define _MapBase_PM_U4   0xA0000000
#endif
...
//---------------------------------------------------------------------
    ...
    #if (_TEMP_PM_ == 1)
        _RVM2(0x0E20, GPIO_PM_OUT, 0x1B81),
        _RVM2(0x0E1E, GPIO_PM_OEN, 0x1B81),
    #else
    #ifndef BD_ZDT300_V01
        _RVM2(0x0E20, GPIO_PM_OUT, 0x1BBF),
        _RVM2(0x0E1E, GPIO_PM_OEN, 0x1BBF),
    #else
        _RVM2(0x0E20, GPIO_PM_OUT, 0x1FBF),
        _RVM2(0x0E1E, GPIO_PM_OEN, 0x1FBF),
    #endif
    #endif
...
#define PAD_SM1_CLK_OUT (PAD_SM1_CLK_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2510, PAD_SM1_CLK_OUT, BIT4),
        _RVM1(0x2510, PAD_SM1_CLK_OEN, BIT5),
#endif
...
#define PAD_SM1_RST_OUT (PAD_SM1_RST_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2512, PAD_SM1_RST_OUT, BIT4),
        _RVM1(0x2512, PAD_SM1_RST_OEN, BIT5),
#endif
...
#define PAD_SM1_CD_OUT (PAD_SM1_CD_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2514, PAD_SM1_CD_OUT, BIT4),
        _RVM1(0x2514, PAD_SM1_CD_OEN, BIT5),
#endif
...
#define PAD_SM1_VCC_OUT (PAD_SM1_VCC_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2516, PAD_SM1_VCC_OUT, BIT4),
        _RVM1(0x2516, PAD_SM1_VCC_OEN, BIT5),
#endif
...
#define PAD_TS1_CLK_OUT (PAD_TS1_CLK_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        ...
        _RVM1(0x1e46, BIT1|BIT0, BIT1|BIT0),
#endif
...
#if(PAD_PF_A25_IS_GPIO != GPIO_NONE)
#define PAD_PF_A25_OEN (PAD_PF_A25_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A25_OUT (PAD_PF_A25_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x259c, PAD_PF_A25_OUT, BIT4),
        _RVM1(0x259c, PAD_PF_A25_OEN, BIT5),
#endif

#if(PAD_PF_A24_IS_GPIO != GPIO_NONE)
#define PAD_PF_A24_OEN (PAD_PF_A24_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A24_OUT (PAD_PF_A24_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x259e, PAD_PF_A24_OUT, BIT4),
        _RVM1(0x259e, PAD_PF_A24_OEN, BIT5),
#endif

#if(PAD_PF_A23_IS_GPIO != GPIO_NONE)
#define PAD_PF_A23_OEN (PAD_PF_A23_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A23_OUT (PAD_PF_A23_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25a0, PAD_PF_A23_OUT, BIT4),
        _RVM1(0x25a0, PAD_PF_A23_OEN, BIT5),
#endif

#if(PAD_PF_A22_IS_GPIO != GPIO_NONE)
#define PAD_PF_A22_OEN (PAD_PF_A22_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A22_OUT (PAD_PF_A22_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25a2, PAD_PF_A22_OUT, BIT4),
        _RVM1(0x25a2, PAD_PF_A22_OEN, BIT5),
#endif

#if(PAD_PF_A21_IS_GPIO != GPIO_NONE)
#define PAD_PF_A21_OEN (PAD_PF_A21_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A21_OUT (PAD_PF_A21_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25a4, PAD_PF_A21_OUT, BIT4),
        _RVM1(0x25a4, PAD_PF_A21_OEN, BIT5),
#endif

#if(PAD_PF_A20_IS_GPIO != GPIO_NONE)
#define PAD_PF_A20_OEN (PAD_PF_A20_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A20_OUT (PAD_PF_A20_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25a6, PAD_PF_A20_OUT, BIT4),
        _RVM1(0x25a6, PAD_PF_A20_OEN, BIT5),
#endif

#if(PAD_PF_A19_IS_GPIO != GPIO_NONE)
#define PAD_PF_A19_OEN (PAD_PF_A19_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A19_OUT (PAD_PF_A19_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25a8, PAD_PF_A19_OUT, BIT4),
        _RVM1(0x25a8, PAD_PF_A19_OEN, BIT5),
#endif

#if(PAD_PF_A18_IS_GPIO != GPIO_NONE)
#define PAD_PF_A18_OEN (PAD_PF_A18_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A18_OUT (PAD_PF_A18_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25aa, PAD_PF_A18_OUT, BIT4),
        _RVM1(0x25aa, PAD_PF_A18_OEN, BIT5),
#endif

#if(PAD_PF_A17_IS_GPIO != GPIO_NONE)
#define PAD_PF_A17_OEN (PAD_PF_A17_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A17_OUT (PAD_PF_A17_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25ac, PAD_PF_A17_OUT, BIT4),
        _RVM1(0x25ac, PAD_PF_A17_OEN, BIT5),
#endif

#if(PAD_PF_A16_IS_GPIO != GPIO_NONE)
#define PAD_PF_A16_OEN (PAD_PF_A16_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A16_OUT (PAD_PF_A16_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25ae, PAD_PF_A16_OUT, BIT4),
        _RVM1(0x25ae, PAD_PF_A16_OEN, BIT5),
#endif

#if(PAD_PF_A15_IS_GPIO != GPIO_NONE)
#define PAD_PF_A15_OEN (PAD_PF_A15_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A15_OUT (PAD_PF_A15_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25b0, PAD_PF_A15_OUT, BIT4),
        _RVM1(0x25b0, PAD_PF_A15_OEN, BIT5),
#endif

#if(PAD_PF_A14_IS_GPIO != GPIO_NONE)
#define PAD_PF_A14_OEN (PAD_PF_A14_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A14_OUT (PAD_PF_A14_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25b2, PAD_PF_A14_OUT, BIT4),
        _RVM1(0x25b2, PAD_PF_A14_OEN, BIT5),
#endif

#if(PAD_PF_A13_IS_GPIO != GPIO_NONE)
#define PAD_PF_A13_OEN (PAD_PF_A13_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A13_OUT (PAD_PF_A13_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25b4, PAD_PF_A13_OUT, BIT4),
        _RVM1(0x25b4, PAD_PF_A13_OEN, BIT5),
#endif

#if(PAD_PF_A12_IS_GPIO != GPIO_NONE)
#define PAD_PF_A12_OEN (PAD_PF_A12_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A12_OUT (PAD_PF_A12_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25b6, PAD_PF_A12_OUT, BIT4),
        _RVM1(0x25b6, PAD_PF_A12_OEN, BIT5),
#endif

#if(PAD_PF_A11_IS_GPIO != GPIO_NONE)
#define PAD_PF_A11_OEN (PAD_PF_A11_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A11_OUT (PAD_PF_A11_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25b8, PAD_PF_A11_OUT, BIT4),
        _RVM1(0x25b8, PAD_PF_A11_OEN, BIT5),
#endif

#if(PAD_PF_A10_IS_GPIO != GPIO_NONE)
#define PAD_PF_A10_OEN (PAD_PF_A10_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A10_OUT (PAD_PF_A10_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25ba, PAD_PF_A10_OUT, BIT4),
        _RVM1(0x25ba, PAD_PF_A10_OEN, BIT5),
#endif

#if(PAD_PF_A9_IS_GPIO != GPIO_NONE)
#define PAD_PF_A9_OEN (PAD_PF_A9_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A9_OUT (PAD_PF_A9_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25bc, PAD_PF_A9_OUT, BIT4),
        _RVM1(0x25bc, PAD_PF_A9_OEN, BIT5),
#endif

#if(PAD_PF_A8_IS_GPIO != GPIO_NONE)
#define PAD_PF_A8_OEN (PAD_PF_A8_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A8_OUT (PAD_PF_A8_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25be, PAD_PF_A8_OUT, BIT4),
        _RVM1(0x25be, PAD_PF_A8_OEN, BIT5),
#endif

#if(PAD_PF_A7_IS_GPIO != GPIO_NONE)
#define PAD_PF_A7_OEN (PAD_PF_A7_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A7_OUT (PAD_PF_A7_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25c0, PAD_PF_A7_OUT, BIT4),
        _RVM1(0x25c0, PAD_PF_A7_OEN, BIT5),
#endif

#if(PAD_PF_A6_IS_GPIO != GPIO_NONE)
#define PAD_PF_A6_OEN (PAD_PF_A6_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A6_OUT (PAD_PF_A6_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25c2, PAD_PF_A6_OUT, BIT4),
        _RVM1(0x25c2, PAD_PF_A6_OEN, BIT5),
#endif

#if(PAD_PF_A5_IS_GPIO != GPIO_NONE)
#define PAD_PF_A5_OEN (PAD_PF_A5_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A5_OUT (PAD_PF_A5_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25c4, PAD_PF_A5_OUT, BIT4),
        _RVM1(0x25c4, PAD_PF_A5_OEN, BIT5),
#endif

#if(PAD_PF_A4_IS_GPIO != GPIO_NONE)
#define PAD_PF_A4_OEN (PAD_PF_A4_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A4_OUT (PAD_PF_A4_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25c6, PAD_PF_A4_OUT, BIT4),
        _RVM1(0x25c6, PAD_PF_A4_OEN, BIT5),
#endif

#if(PAD_PF_A3_IS_GPIO != GPIO_NONE)
#define PAD_PF_A3_OEN (PAD_PF_A3_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A3_OUT (PAD_PF_A3_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25c8, PAD_PF_A3_OUT, BIT4),
        _RVM1(0x25c8, PAD_PF_A3_OEN, BIT5),
#endif

#if(PAD_PF_A2_IS_GPIO != GPIO_NONE)
#define PAD_PF_A2_OEN (PAD_PF_A2_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A2_OUT (PAD_PF_A2_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25ca, PAD_PF_A2_OUT, BIT4),
        _RVM1(0x25ca, PAD_PF_A2_OEN, BIT5),
#endif

#if(PAD_PF_A1_IS_GPIO != GPIO_NONE)
#define PAD_PF_A1_OEN (PAD_PF_A1_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A1_OUT (PAD_PF_A1_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25cc, PAD_PF_A1_OUT, BIT4),
        _RVM1(0x25cc, PAD_PF_A1_OEN, BIT5),
#endif

#if(PAD_PF_A0_IS_GPIO != GPIO_NONE)
#define PAD_PF_A0_OEN (PAD_PF_A0_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_A0_OUT (PAD_PF_A0_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25ce, PAD_PF_A0_OUT, BIT4),
        _RVM1(0x25ce, PAD_PF_A0_OEN, BIT5),
#endif

#if(PAD_PF_CE0Z_IS_GPIO != GPIO_NONE)
#define PAD_PF_CE0Z_OEN (PAD_PF_CE0Z_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_CE0Z_OUT (PAD_PF_CE0Z_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25d0, PAD_PF_CE0Z_OUT, BIT4),
        _RVM1(0x25d0, PAD_PF_CE0Z_OEN, BIT5),
#endif

#if(PAD_PF_OEZ_IS_GPIO != GPIO_NONE)
#define PAD_PF_OEZ_OEN (PAD_PF_OEZ_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_OEZ_OUT (PAD_PF_OEZ_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25d2, PAD_PF_OEZ_OUT, BIT4),
        _RVM1(0x25d2, PAD_PF_OEZ_OEN, BIT5),
#endif

#if(PAD_PF_WEZ_IS_GPIO != GPIO_NONE)
#define PAD_PF_WEZ_OEN (PAD_PF_WEZ_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_PF_WEZ_OUT (PAD_PF_WEZ_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x25d4, PAD_PF_WEZ_OUT, BIT4),
        _RVM1(0x25d4, PAD_PF_WEZ_OEN, BIT5),
#endif

#if(PAD_RF_AGC_IS_GPIO != GPIO_NONE)
#define PAD_RF_AGC_OEN (PAD_RF_AGC_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_RF_AGC_OUT (PAD_RF_AGC_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2600, PAD_RF_AGC_OUT, BIT4),
        _RVM1(0x2600, PAD_RF_AGC_OEN, BIT5),
#endif

#if(PAD_IF_AGC_IS_GPIO != GPIO_NONE)
#define PAD_IF_AGC_OEN (PAD_IF_AGC_IS_GPIO == GPIO_IN ? BIT5: 0)
#define PAD_IF_AGC_OUT (PAD_IF_AGC_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2602, PAD_IF_AGC_OUT, BIT4),
        _RVM1(0x2602, PAD_IF_AGC_OEN, BIT5),
#endif
...
#define PAD_ET_CRS_OUT (PAD_ET_CRS_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        ...
        _RVM1(0x1e47, BIT5|BIT4, BIT5|BIT4),
#endif
...
#define PAD_I2S_OUT_SD3_OUT (PAD_I2S_OUT_SD3_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x262e, PAD_I2S_OUT_SD3_OUT, BIT4),
        _RVM1(0x262e, PAD_I2S_OUT_SD3_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_SD2_OUT (PAD_I2S_OUT_SD2_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2630, PAD_I2S_OUT_SD2_OUT, BIT4),
        _RVM1(0x2630, PAD_I2S_OUT_SD2_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_SD1_OUT (PAD_I2S_OUT_SD1_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2632, PAD_I2S_OUT_SD1_OUT, BIT4),
        _RVM1(0x2632, PAD_I2S_OUT_SD1_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_WS_OUT (PAD_I2S_OUT_WS_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2634, PAD_I2S_OUT_WS_OUT, BIT4),
        _RVM1(0x2634, PAD_I2S_OUT_WS_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_BCK_OUT (PAD_I2S_OUT_BCK_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2636, PAD_I2S_OUT_BCK_OUT, BIT4),
        _RVM1(0x2636, PAD_I2S_OUT_BCK_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_SD0_OUT (PAD_I2S_OUT_SD0_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x2638, PAD_I2S_OUT_SD0_OUT, BIT4),
        _RVM1(0x2638, PAD_I2S_OUT_SD0_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
#define PAD_I2S_OUT_MCK_OUT (PAD_I2S_OUT_MCK_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
        _RVM1(0x263a, PAD_I2S_OUT_MCK_OUT, BIT4),
        _RVM1(0x263a, PAD_I2S_OUT_MCK_OEN, BIT5),
        _RVM1(0x1e47, BIT0, BIT0),
#endif
...
//---------------------------------------------------------------------
    ...
    #define I2S_IN_MODE ((PADS_I2S_IN_MODE == PAD_SM1_RST ) ? (BIT0) : \
                         (PADS_I2S_IN_MODE == PAD_I2S_OUT_SD1) ? (BIT1) : \
                         (PADS_I2S_IN_MODE == PAD_TS1_CLK) ? (BIT1|BIT0) : 0)
    ...
    #define I2S_OUT_MODE ((PADS_I2S_OUT_MODE == PAD_SM1_RST  ) ? (BIT5) : \
                         (PADS_I2S_OUT_MODE == PAD_I2S_OUT_SD1) ? (BIT6) : \
                         (PADS_I2S_OUT_MODE == PAD_TS1_CLK) ? (BIT6|BIT5) : 0)

    _RVM1(0x1E0B, I2S_OUT_MODE, BITMASK(6:5)),

    #define MPIF_MODE ((PADS_MPIF_MODE == PAD_TS1_CLK) ? (BIT4) : \
                       (PADS_MPIF_MODE == PAD_ET_TXD1) ? (BIT5) : \
                       (PADS_MPIF_MODE == PAD_I2S_OUT_SD1) ? (BIT5|BIT4) : \
    ...
    #define SDIO_MODE ((PADS_SDIO_MODE == PAD_TS1_CLK) ? (BIT4) : \
                       (PADS_SDIO_MODE == PAD_ET_TXD1) ? (BIT5) : \
                       (PADS_SDIO_MODE == PAD_I2S_OUT_SD1) ? (BIT5|BIT4) : \
    ...
    #define THIRD_UART_MODE ((PADS_THIRD_UART_MODE == PAD_TS1_D7) ? (BIT4) : \
                           ...
                           (PADS_THIRD_UART_MODE == PAD_PF_A3) ? (BIT5) : \
