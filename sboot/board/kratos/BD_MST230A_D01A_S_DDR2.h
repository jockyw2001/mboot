...
#define BOARD_NAME                  "BD_MST230A_D01A_S_DDR2"
...
#define PAD_TS0_MODE               PAD_MUX_MODE_UNKNOWN
...
#define PAD_PWM0_IS_GPIO            GPIO_OUT_HIGH // Scart_P16_GPIO, Low: 0~0.4V: Composite, High: 1~3V: RGB
#define PAD_PWM1_IS_GPIO            GPIO_OUT_LOW  // Scart_P8_6V_GPIO, High 16:9, Low  4:3
#define PAD_PWM2_IS_GPIO            GPIO_OUT_LOW  // Scart_P8_0V_GPIO, High: RGB no output signal, Low: RGB output signal
#define PAD_TM_GPIO0_IS_GPIO        GPIO_OUT_HIGH // DualLED_Red Standby mode, High: Operation mode, Low: Standby mode
#define PAD_TM_GPIO1_IS_GPIO        GPIO_OUT_LOW  // DualLED_Green Operation mode, Low: Operation mode, High: Standby mode
//#define PAD_TM_GPIO1_IS_GPIO        GPIO_NONE     // FP_CLK
//#define PAD_TM_GPIO0_IS_GPIO        GPIO_NONE     // FP_STB
//#define PAD_S_GPIO6_IS_GPIO         GPIO_NONE     // FP_DOUT
...
#define PAD_SAR1_IS_GPIO            GPIO_OUT_LOW  // Tuner reset, Low: Enable reset tuner, High: Disable reset tun
#define PAD_SAR2_IS_GPIO            GPIO_IN       // USB Over Current Detect, High: Operation mode, Low: USB power short
#define PAD_SAR3_IS_GPIO            GPIO_IN       // Power cut off detection, 1V: operation mode, 0.8V: power cut off state
