...
// KRITI_TODO // refine the pad/gpio
#define BOARD_NAME                  "BD_MST230A_D01A_DDR3"
...
#define PAD_MUX_MODE_UNKNOWN       0
#define PAD_MUX_MODE_1             1
#define PAD_MUX_MODE_2             2
#define PAD_MUX_MODE_3             3
#define PAD_MUX_MODE_4             4
#define PAD_MUX_MODE_5             5
#define PAD_MUX_MODE_6             6
#define PAD_MUX_MODE_7             7
#define PAD_MUX_MODE_8             8
#define PAD_MUX_MODE_9             9

#define PAD_SM0_OPEN_MODE          PAD_MUX_MODE_UNKNOWN
#define PAD_OCP0_EN_MODE           PAD_MUX_MODE_UNKNOWN
#define PAD_SM0_EN_MODE            PAD_MUX_MODE_1
#define PAD_I2CM0_MODE             PAD_MUX_MODE_1
#define PAD_I2CM1_MODE             PAD_MUX_MODE_1
#define PAD_I2CM2_MODE             PAD_MUX_MODE_UNKNOWN
#define PAD_TS0_MODE               PAD_MUX_MODE_4
#define PAD_TS1_MODE               PAD_MUX_MODE_UNKNOWN
#define PAD_SPDIF_OUT_MODE         PAD_MUX_MODE_1
#define PAD_SPDIF_IN_MODE          PAD_MUX_MODE_UNKNOWN
#define PAD_I2S_IN_MODE            PAD_MUX_MODE_UNKNOWN
#define PAD_I2S_OUT_MUTE_MODE      PAD_MUX_MODE_UNKNOWN
#define PAD_I2S_OUT_MODE           PAD_MUX_MODE_UNKNOWN
#define PAD_MCU_JTAG_MODE          PAD_MUX_MODE_UNKNOWN
#define PAD_SECOND_UART_MODE       PAD_MUX_MODE_UNKNOWN
#define PAD_THIRD_UART_MODE        PAD_MUX_MODE_UNKNOWN
#define PAD_FOURTH_UART_MODE       PAD_MUX_MODE_UNKNOWN
#define PAD_FAST_UART_MODE         PAD_MUX_MODE_UNKNOWN
#define PAD_HSYNC_EN_MODE          PAD_MUX_MODE_UNKNOWN
#define PAD_VSYNC_EN_MODE          PAD_MUX_MODE_UNKNOWN
#define PAD_DISEQ_IN_EN_MODE       PAD_MUX_MODE_UNKNOWN
#define PAD_DISEQ_OUT_EN_MODE      PAD_MUX_MODE_UNKNOWN
#define PAD_RF_AGC_EN_MODE         PAD_MUX_MODE_UNKNOWN
#define PAD_IF_AGC_EN_MODE         PAD_MUX_MODE_UNKNOWN
#define PAD_LED_MODE               PAD_MUX_MODE_1

//------GPIO setting(default GPIO pin level)------------------------------------
#define PAD_PWR_CTRL_IS_GPIO        GPIO_OUT_HIGH // System power control, High: Enable system power, Low: Disable system power
#define PAD_PWM0_IS_GPIO            GPIO_OUT_HIGH // VCR_ABSENCE, High: RGB no output signal, Low: RGB output signal
#define PAD_PWM1_IS_GPIO            GPIO_OUT_LOW  // DVB_RATION, High 16:9, Low  4:3
#define PAD_PWM2_IS_GPIO            GPIO_OUT_LOW  // RGB/CVBS, Low: 0~0.4V: Composite, High: 1~3V: RGB
#define PAD_TM_GPIO0_IS_GPIO        GPIO_OUT_LOW  // DualLED_Green Operation mode, Low: Operation mode, High: Standby mode
#define PAD_TM_GPIO1_IS_GPIO        GPIO_OUT_HIGH // DualLED_Red Standby mode, High: Operation mode, Low: Standby mode
#define PAD_S_GPIO6_IS_GPIO         GPIO_IN       // System Standby Control Buttom, Low: Change mode
#define PAD_TS0_SYNC_IS_GPIO        GPIO_NONE     // FP_CLK
#define PAD_TS0_VLD_IS_GPIO         GPIO_NONE     // FP_STB
#define PAD_TS0_D0_IS_GPIO          GPIO_NONE     // FP_DOUT
#define PAD_TS0_D1_IS_GPIO          GPIO_IN       // USB Over Current Detect, High: Operation mode, Low: USB power short
#define PAD_I2CM1_SDA_IS_GPIO       GPIO_NONE     // LNB I2C SDA
#define PAD_I2CM1_SCL_IS_GPIO       GPIO_NONE     // LNB I2C SCL
#define PAD_I2CM0_SCL_IS_GPIO       GPIO_NONE     // Tuner I2C SCL
#define PAD_I2CM0_SDA_IS_GPIO       GPIO_NONE     // Tuner I2C SDA
#define PAD_DISEQ_IN_IS_GPIO        GPIO_IN       // LNB DiSEQC Input
#define PAD_DISEQ_OUT_IS_GPIO       GPIO_OUT_LOW  // LNB DiSEQC Output
#define PAD_SAR0_IS_GPIO            GPIO_OUT_HIGH // Tuner power management control, High: Enable exernal front-end power, Low: Disable exernal front-end power
#define PAD_SAR1_IS_GPIO            GPIO_IN       // Antenna Over Current Protection, 3.3V: Antenna power good, Under 2V: Antenna power short
#define PAD_SAR2_IS_GPIO            GPIO_OUT_LOW  // Tuner reset, Low: Enable reset tuner, High: Disable reset tuner
#define PAD_TS0_D2_IS_GPIO          GPIO_OUT_LOW  // USB1 Enable, Low: USB power enable, High: USB power disable
#define PAD_SAR3_IS_GPIO            GPIO_OUT_LOW  // USB0 Enable, Low: USB power enable, High: USB power disable
#define PAD_ET_LINK_LED_IS_GPIO     GPIO_NONE     // Ethernet Link LED
#define PAD_ET_SPEED_LED_IS_GPIO    GPIO_NONE     // Ethernet Speed/Activity LED
#define GPIO_FE_RST                 PAD_SAR2

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7S02_1.h"
...
#define AUDIO_PATH_BTSC1            AUDIO_PATH_NULL
#define AUDIO_PATH_BTSC2            AUDIO_PATH_NULL
...
#define AUDIO_OUTPUT_BTSC1          AUDIO_NULL_OUTPUT
#define AUDIO_OUTPUT_BTSC2          AUDIO_NULL_OUTPUT
...
#ifndef MEMORY_MAP
#define MEMORY_MAP                      MMAP_128MB  // 1024 1024  ??TBC
#endif
