...
// Kratos
#define BD_KRATOS_FPGA                 0x0A90
#define BD_MST230A_D01A_DDR2           0x0A91
#define BD_MST230A_D01A_DDR3           0x0A92
#define BD_MST230A_D01A_S_DDR2         0x0A93
#define BD_MST230A_D01A_S_DDR3         0x0A94

#ifndef MS_BOARD_TYPE_SEL
#if defined (CONFIG_MSTAR_KRATOS_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_KRATOS_FPGA
    #define MIU_INTERFACE           DDR2_INTERFACE_FPGA
#elif defined (CONFIG_MSTAR_KRATOS_BD_MST230A_D01A_DDR2)
    #define MS_BOARD_TYPE_SEL       BD_MST230A_D01A_DDR2
    #define MIU_INTERFACE           DDR2_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KRATOS_BD_MST230A_D01A_DDR3)
    #define MS_BOARD_TYPE_SEL       BD_MST230A_D01A_DDR3
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KRATOS_BD_MST230A_D01A_S_DDR2)
    #define MS_BOARD_TYPE_SEL       BD_MST230A_D01A_S_DDR2
    #define MIU_INTERFACE           DDR2_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KRATOS_BD_MST230A_D01A_S_DDR3)
    #define MS_BOARD_TYPE_SEL       BD_MST230A_D01A_S_DDR3
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#else
...
#if  (MS_BOARD_TYPE_SEL == BD_KRATOS_FPGA)
    #include "BD_KRATOS_FPGA.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST230A_D01A_DDR2)
    #include "BD_MST230A_D01A_DDR2.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST230A_D01A_DDR3)
    #include "BD_MST230A_D01A_DDR3.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST230A_D01A_S_DDR2)
    #include "BD_MST230A_D01A_S_DDR2.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST230A_D01A_S_DDR3)
    #include "BD_MST230A_D01A_S_DDR3.h"
#else
