...
#if (CONFIG_Third_UART_Mode_2 || CONFIG_Fourth_UART_Mode_2)
#define DRVPAD_CI_MODE                 PADMUX_MDOE_DEFAULT
#else
#define DRVPAD_CI_MODE                 PADMUX_MDOE1
#endif
...
#define PAD_EJ_TDO_IS_GPIO      GPIO_IN       // SCART_PIN8_CTL0
