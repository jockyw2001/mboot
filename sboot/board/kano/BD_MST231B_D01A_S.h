...
#define BOARD_NAME                  "BD_MST231B_D01A_S"
...
// None PM
#define PAD_GPIO0_IS_GPIO GPIO_OUT_LOW // EMMC_IO_NMOS
#define PAD_GPIO1_IS_GPIO GPIO_OUT_LOW  // USB30_EN_0
#define PAD_GPIO2_IS_GPIO GPIO_OUT_HIGH // USB20_EN
#define PAD_GPIO3_IS_GPIO GPIO_OUT_LOW // CTRL_SDIO3_POW
#define PAD_GPIO4_IS_GPIO GPIO_OUT_HIGH // PCM_PWR_CTL
#define PAD_GPIO5_IS_GPIO GPIO_OUT_LOW // HDMITX_POW_CTRL ; PRSTN
#define PAD_GPIO6_IS_GPIO GPIO_OUT_LOW // GPIO_3.3V_SDIO
#define PAD_GPIO7_IS_GPIO GPIO_OUT_LOW // GPIO_1.8V_SDIO
#define PAD_GPIO8_IS_GPIO GPIO_OUT_LOW // FE1_RST
#define PAD_GPIO9_IS_GPIO GPIO_OUT_LOW // FE2_RST
#define PAD_VID0_IS_GPIO GPIO_OUT_LOW // SCL
#define PAD_VID1_IS_GPIO GPIO_OUT_LOW // SDA
#define PAD_VSYNC_OUT_IS_GPIO GPIO_OUT_HIGH // V_SYNC ; EDID_SEL/UART_RX1
#define PAD_HSYNC_OUT_IS_GPIO GPIO_OUT_HIGH // H_SYNC ; SM1_VCCSEL/UART_TX1
// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_IN // System Standby
#define PAD_SAR_GPIO1_IS_GPIO GPIO_IN // LED_CTL1 ; SDIO_CDZ
#define PAD_SAR_GPIO2_IS_GPIO GPIO_OUT_LOW // HDMI CTL (bypass mode)
#define PAD_SAR_GPIO3_IS_GPIO GPIO_OUT_LOW // SDIO_IO_NMOS ; BT_DIS
#define PAD_SAR_GPIO4_IS_GPIO GPIO_OUT_HIGH // LED_CTL0 ; WL_DISn
#define PAD_SAR_GPIO5_IS_GPIO GPIO_IN // PWR CUT	
#define PAD_PM_GPIO0_IS_GPIO GPIO_OUT_HIGH // PHY_RST ; PM_PWM_0
#define PAD_PM_GPIO1_IS_GPIO GPIO_IN // RF4CE_Wakeup ; PCIE_WAKEUP
#define PAD_PM_GPIO2_IS_GPIO GPIO_OUT_HIGH // RF4CE_INT
#define PAD_PM_GPIO3_IS_GPIO GPIO_OUT_LOW // CTRL_PCIE_POW ; LNB_INT_2
...
#define PAD_PM_GPIO8_IS_GPIO GPIO_IN // USB_OCP
#define PAD_PM_GPIO9_IS_GPIO GPIO_IN // CHIP_CONFIG[0] ; DAC_GPIO0
#define PAD_PM_GPIO10_IS_GPIO GPIO_IN // CHIP_CONFIG[1] ; DAC_GPIO1
#define PAD_PM_GPIO11_IS_GPIO GPIO_OUT_HIGH // LNB_INT_1
#define PAD_PM_GPIO12_IS_GPIO GPIO_IN // CHIP_CONFIG[2] ; FB_GPIO
#define PAD_PM_GPIO13_IS_GPIO GPIO_OUT_LOW // Core_VID_0 ; LNB_INT_2
#define PAD_PM_GPIO14_IS_GPIO GPIO_OUT_LOW // Core_VID_1 ; RST_RF4CE
#define PAD_PM_GPIO15_IS_GPIO GPIO_OUT_HIGH // SDIO_CDZ
