...
#define BOARD_NAME                  "BD_MST231C_D01A_S"
...
#define PADS_PM5_IS_IRIN            Unknown_pads
#define PADS_SM0_OPEN               Unknown_pads
#define PADS_OCP0_EN                Unknown_pads
#define PADS_SM0_C48                Unknown_pads
#define PADS_SM0_C48_OFF            Unknown_pads
#define PADS_SM0_EN                 PAD_SM0_CLK
#define PADS_SM0_IO                 PAD_SM0_IO
#define PADS_SM1_OPEN               Unknown_pads
#define PADS_OCP1_EN                Unknown_pads
#define PADS_SM1_C48                Unknown_pads
#define PADS_SM1_C48_OFF            Unknown_pads
#define PADS_SM1_EN                 Unknown_pads
#define PADS_I2CM0_MODE             PAD_I2CM0_SCL
#define PADS_I2CM1_MODE             PAD_I2CM1_SCL
#define PADS_I2CM2_MODE             Unknown_pads
#define PADS_I2CM3_MODE             Unknown_pads
#define PADS_I2CM4_MODE             Unknown_pads
#define PADS_TS0_MODE               PAD_TS0_CLK
#define PADS_TS1_MODE               PAD_TS1_CLK
#define PADS_TS2_MODE               PAD_TS2_VLD
#define PADS_TS_OUT_MODE            Unknown_pads
#define PADS_NAND_MODE              Unknown_pads
#define PADS_NAND_CS1_EN            Unknown_pads
#define PADS_CI_MODE                PAD_CI_RST
...
#define PADS_SPDIF_IN_MODE          PAD_I2S_OUT_SD0
#define PADS_I2S_IN_MODE            Unknown_pads
#define PADS_I2S_TRX_MODE           Unknown_pads
#define PADS_I2S_OUT_MODE           PAD_I2S_OUT_SD0
#define PADS_I2S_OUT_MODE_2         PAD_I2S_OUT_SD3
#define PADS_I2S_OUT_MUTE_MODE      PAD_I2S_OUT_MUTE
#define PADS_SDIO_MODE              PAD_SDIO_IO0
#define PADS_SD_CONFIG              PAD_SD_CLK
...
#define PADS_FUART_MODE             Unknown_pads
#define PADS_FUART_EMMC_MODE        Unknown_pads
...
#define PADS_EMMC_RSTN_EN           Unknown_pads
#define PADS_EMMC_CONFIG            PAD_EMMC_IO0

//------GPIO setting(default GPIO pin level)------------------------------------
// None PM
#define PAD_GPIO0_IS_GPIO GPIO_OUT_HIGH         // EMMC_IO_NMOS
#define PAD_GPIO1_IS_GPIO GPIO_OUT_HIGH         // USB30_EN_0
#define PAD_GPIO2_IS_GPIO GPIO_OUT_HIGH         // USB20_EN
#define PAD_GPIO3_IS_GPIO GPIO_OUT_LOW          // CTRL_SDIO3_POW
#define PAD_GPIO4_IS_GPIO GPIO_OUT_HIGH         // RGB/CVBS - Low: CVBS, High: RGB
                                                // FAST UART CTS

#define PAD_GPIO5_IS_GPIO GPIO_OUT_LOW          // HDMITX_POW_CTRL
                                                // FAST UART RTS
                                                // PRSTN

#define PAD_GPIO6_IS_GPIO GPIO_OUT_LOW          // GPIO_3.3V_CTRL
#define PAD_GPIO7_IS_GPIO GPIO_OUT_LOW          // GPIO_1.8V_CTRL
#define PAD_GPIO8_IS_GPIO GPIO_OUT_LOW          // SCART_PIN8_CTL0
                                                // SPDIF OUT

#define PAD_GPIO9_IS_GPIO GPIO_OUT_LOW          // SCART_PIN8_CTL1
#define PAD_VSYNC_OUT_IS_GPIO GPIO_OUT_HIGH     // RST_RF4CE
                                                // EDID_SEL
                                                // SDIO_NMOS
#define PAD_HSYNC_OUT_IS_GPIO GPIO_OUT_HIGH     // LED_WL;
                                                // INT_RF4CE

// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_IN           // System Standby
                                                // current Detection 0
#define PAD_SAR_GPIO1_IS_GPIO GPIO_OUT          // Green LED_CTL
                                                // SDIO_CDZ
                                                // current detection 1
#define PAD_SAR_GPIO2_IS_GPIO GPIO_OUT_LOW      // HDMI CTL (bypass mode)
#define PAD_SAR_GPIO3_IS_GPIO GPIO_OUT_HIGH     // FE RST
                                                // BT_DIS
#define PAD_SAR_GPIO4_IS_GPIO GPIO_OUT_HIGH     // Red LED_CTL0
                                                // WL_DISn
#define PAD_SAR_GPIO5_IS_GPIO GPIO_IN           // PWR CUT

#define PAD_VID0_IS_GPIO GPIO_OUT_LOW           // VID0 (CPU PWR SCL)
#define PAD_VID1_IS_GPIO GPIO_OUT_LOW           // VID1 (CPU PWR SDA)

#define PAD_PM_GPIO0_IS_GPIO GPIO_OUT_HIGH      // PHY_RST
                                                // PM_PWM_0
                                                // DBUS/SBUS RST
                                                // For K7 BGA21x21 is SPI_Holdz

#define PAD_PM_GPIO1_IS_GPIO GPIO_IN            // PCIE_WAKEUP
                                                // RF4CE_Wakeup
                                                // For K7 BGA21x21 is SPI_RSTZ

#define PAD_PM_GPIO2_IS_GPIO GPIO_OUT_HIGH      // Front Panel DATA

#define PAD_PM_GPIO3_IS_GPIO GPIO_OUT_HIGH      // CTRL_PCIE_POW
                                                // TSIOE  TSIOE is only for K6 BGA 21x21
                                                // DBUS ALE
...
#define PAD_PM_GPIO6_IS_GPIO GPIO_OUT_HIGH      // Audio Mute.
                                                // ANT PWR CTRL Audio Mute is only for K7 BGA 21x21

#define PAD_PM_GPIO7_IS_GPIO GPIO_IN            // USB3_OCP

#define PAD_PM_GPIO8_IS_GPIO GPIO_OUT_HIGH      // Front Panel  CLK
                                                // CORE PWR VID0
...
#define PAD_PM_GPIO14_IS_GPIO GPIO_OUT_HIGH     // Front Panel GPIO
                                                // CORE PWR VID1
...
#define REG_USB30_PORT2_GPIO_CONTROL            0x1402E6
#define REG_USB30_PORT2_GPIO_BANK               0x1025
#define REG_USB30_PORT2_GPIO_OFFSET             0xB2 //bit0~bit7 offset addr
#define REG_USB30_PORT2_GPIO_BIT                0x5  //bit8~bit10 bit count
#define REG_USB30_PORT2_GPIO_LOW_ACTIVE         0x0  //Turn on 5V  ( 0:  GPIO High   1: GPIO Low) active
//=============================================================================

//------Chip Type---------------------------------------------------------------
#include "chip/MSA8Z15A.h"
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_BGA_16BIT
