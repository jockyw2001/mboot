...
#define PAD_I2S_OUT_SDO_IS_GPIO GPIO_OUT_HIGH // USB 0 EN
#define PAD_I2S_OUT_BCK_IS_GPIO GPIO_OUT_HIGH // USB 1 EN
#define PAD_SAR0_IS_GPIO        GPIO_OUT_LOW // SAR0, DISP_DATA-GPIO
#define PAD_SAR1_IS_GPIO        GPIO_OUT_LOW // SAR1, DISP_CLK-GPIO
#define PAD_SAR2_IS_GPIO        GPIO_OUT_LOW // SAR2, DISP_STB-GPIO
...
#define PAD_PM_GPIO9_IS_GPIO     GPIO_OUT_LOW    // CI_PWR_CTL
...
#define GPIO_DEMOD_RST           BALL_F20 // MCP Windermere RST

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7X47.h"
