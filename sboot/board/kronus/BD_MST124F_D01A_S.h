...
#define BOARD_NAME                  "BD_MST124F_D01A_S"
...
#define PADS_I2CM0_MODE             PAD_SM0_IO  //PAD_I2CM0_SDA//Unknown_pads
...
#define PADS_NAND_MODE              PAD_CI_A5
...
//#define PAD_SPDIF_OUT_IS_GPIO       GPIO_OUT_LOW  // SPDIF OUT
#define PAD_HDMI_SDA_IS_GPIO        GPIO_OUT_HIGH // LED
#define PAD_S_GPIO4_IS_GPIO         GPIO_OUT_LOW  // Frondend Reset
#define PAD_SPDIF_OUT2_IS_GPIO      GPIO_OUT_HIGH // USB 2 Power Enable
#define PAD_HSYNC_OUT_IS_GPIO       GPIO_OUT_HIGH // LED
#define PAD_TS1_D6_IS_GPIO          GPIO_IN       // USB overcurrent INT
#define PAD_TS1_D7_IS_GPIO          GPIO_OUT_HIGH // USB Power Enable
#define PAD_SAR0_IS_GPIO            GPIO_IN       // RF AGC IN
#define PAD_SAR1_IS_GPIO            GPIO_IN       // AC-off INT.
#define PAD_SAR2_IS_GPIO            GPIO_OUT_LOW  // Audio Mute
#define PAD_SAR3_IS_GPIO            GPIO_IN       // FP
#define PAD_GPIO_PM0_IS_GPIO        GPIO_OUT_HIGH // SPI WP
#define PAD_GPIO_PM1_IS_GPIO        GPIO_IN       // FP.
#define PAD_GPIO_PM2_IS_GPIO        GPIO_IN       // FP.
#define PAD_GPIO_PM3_IS_GPIO        GPIO_OUT_HIGH // FP.
#define PAD_GPIO_PM4_IS_GPIO        GPIO_OUT_HIGH // PD Control
#define PAD_GPIO_PM5_IS_GPIO        GPIO_IN       // FP.
#define PAD_GPIO_PM6_IS_GPIO        GPIO_OUT_HIGH // SCART signal - Scart_P8.
#define PAD_GPIO_PM7_IS_GPIO        GPIO_OUT_LOW  // SCART signal - On_STBY#
#define PAD_GPIO_PM9_IS_GPIO        GPIO_OUT_HIGH // SCART signal - Scart_P16

#define BALL_B5_IS_GPIO GPIO_OUT_HIGH //enable SPDIF


//------Chip Type---------------------------------------------------------------
#include "chip/MSD5017.h"
...
#define  MIU_INTERFACE                  DDR2_INTERFACE_236BGA
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO              9999
