...
#define BOARD_NAME                  "BD_MST124G_D01A"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 PIN_81
...
#define PIN_104_IS_GPIO            GPIO_INs   // HDMI HPD
#define PIN_91_IS_GPIO             GPIO_OUT_HIGH // eth reset
#define PIN_103_IS_GPIO            GPIO_OUT_HIGH   // SPDIF from optical
#define PIN_84_IS_GPIO             GPIO_OUT_HIGH // flash WP0
#define PIN_49_IS_GPIO             GPIO_OUT_HIGH // USB2 EN
#define PIN_70_IS_GPIO             GPIO_OUT_HIGH // Front-end reset
#define PIN_85_IS_GPIO             GPIO_OUT_HIGH // PD control
#define PIN_77_IS_GPIO             GPIO_OUT_HIGH // Audio Mute
//------Chip Type---------------------------------------------------------------
#include "chip/MSD7C11.h"
...
#else
#define  MIU_INTERFACE                  DDR3_INTERFACE_QFP_156_8BIT_MODE//DDR3_INTERFACE_BGA
#endif
...
//------DRAM Config---------------------------------------------------------------
#define DRAM_TYPE                       DDR_III
#define DRAM_BUS                        DRAM_BUS_16
#define DDRPLL_FREQ                     DDRLLL_FREQ_1600
#define DDRII_ODT
