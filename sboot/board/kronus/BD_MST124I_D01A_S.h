...
#define BOARD_NAME                  "BD_MST124I_D01A_S"
...
#define PAD_GPIO_PM4_IS_GPIO        GPIO_OUT_HIGH // System power control
#define PAD_GPIO_PM1_IS_GPIO        GPIO_OUT_HIGH  // Front-End demodulator reset
#define PAD_GPIO_PM0_IS_GPIO        GPIO_OUT_HIGH // SPI flash write protect
#define PAD_GPIO_PM7_IS_GPIO        GPIO_IN       // USB Over Current Detect
#define PAD_GPIO_PM6_IS_GPIO        GPIO_OUT_LOW  // USB Power Enable
#define PAD_GPIO_PM2_IS_GPIO        GPIO_OUT_LOW  // ANT_PWR_CTRL => Loopthrough ON®É, High
#define PAD_GPIO_PM5_IS_GPIO        GPIO_IN       // ANT_OCP
#define PAD_GPIO_PM3_IS_GPIO        GPIO_OUT_LOW  // MUTE_AUDIO_AMP
#define PAD_SAR0_IS_GPIO            GPIO_IN       // Power cut off detection
#define PAD_SAR3_IS_GPIO            GPIO_OUT_LOW  // FP_STB
#define PAD_SAR2_IS_GPIO            GPIO_OUT_LOW  // FP_DOUT
#define PAD_SAR1_IS_GPIO            GPIO_OUT_LOW  // FP_CLK
#define PAD_HSYNC_OUT_IS_GPIO       GPIO_IN       // HDMI_HPD


//------Chip Type---------------------------------------------------------------
#include "chip/MSD502x.h"
...
#define  MIU_INTERFACE                  DDR3_INTERFACE_236BGA
