...
#define BOARD_NAME                  "BD_MST163A_D01A_S"
...
#define PAD_GPIO_PM0_IS_GPIO         GPIO_OUT_HIGH // SPI WP0
#define PAD_S_GPIO4_IS_GPIO          GPIO_OUT_HIGH // Frontend RST
#define PAD_S_GPIO2_IS_GPIO          GPIO_OUT_LOW // USB port 1 Power En
...
#define PAD_SAR2_IS_GPIO             GPIO_OUT_HIGH// Audio Mute
#define PAD_SPDIF_OUT_IS_GPIO        GPIO_OUT_HIGH   // SPDIF from optical
#define PAD_SAR1_IS_GPIO             GPIO_IN //AC power cut off interrupt
#define PAD_SAR0_IS_GPIO             GPIO_IN //System Standby control
#define PAD_S_GPIO0_IS_GPIO          GPIO_OUT_LOW //LED Green
#define PAD_SAR3_IS_GPIO             GPIO_OUT_HIGH //LED  Green

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7S12.h"
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_KGB_BGA //DDR2_INTERFACE_BGA
