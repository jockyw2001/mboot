...
#define BOARD_NAME                  "BD_MST124C_D01A_S"
...
#define PIN_68_IS_GPIO              GPIO_OUT_HIGH   // default setting for USB enable
#define PIN_69_IS_GPIO              GPIO_IN         // default setting for front end reset

//#define PIN_89_IS_GPIO              GPIO_OUT_HIGH   //89	SAR1	SCART - Scart_P8.	AC-off INT, FP, Key.	Output	High
//#define PIN_90_IS_GPIO              GPIO_OUT_LOW    //90	SAR2	SCART - ON_STBY#.	AU_MUTE, FP, Key.	Output	Low
//#define PIN_91_IS_GPIO              GPIO_OUT_HIGH   //91	SAR3	SCART - Scart_P16.	FP, Key.	Output	High
