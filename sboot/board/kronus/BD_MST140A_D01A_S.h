...
#define BOARD_NAME                  "BD_MST140A_D01A_S"
...
#define PIN_122_IS_GPIO            GPIO_OUT_HIGH // flash WP0
#define PIN_125_IS_GPIO            GPIO_OUT_HIGH // PD control (Power on control)
#define PIN_124_IS_GPIO            GPIO_OUT_HIGH // USB2 EN
#define PIN_112_IS_GPIO            GPIO_IN       // USB2 POWER_INT
#define PIN_109_IS_GPIO            GPIO_OUT_HIGH // Front-end reset
//------Chip Type---------------------------------------------------------------
#include "chip/MSD7S11.h"
