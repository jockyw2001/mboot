...
#define BOARD_NAME                  "BD_MST124SZ"


//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 PIN_166
...
#define PADS_SPDIF_OUT_MODE         PAD_TS1_D6
...
//#define PIN_221_IS_GPIO             GPIO_OUT_HIGH
//#define PIN_220_IS_GPIO             GPIO_OUT_HIGH
//#define PIN_219_IS_GPIO             GPIO_OUT_HIGH
//#define PIN_218_IS_GPIO             GPIO_OUT_HIGH
//#define PIN_223_IS_GPIO             GPIO_OUT_HIGH
//#define PIN_222_IS_GPIO             GPIO_OUT_HIGH
#define PIN_202_IS_GPIO             GPIO_OUT_HIGH
#define PIN_196_IS_GPIO             GPIO_OUT_HIGH
#define PIN_123_IS_GPIO             GPIO_OUT_HIGH
#define PIN_165_IS_GPIO             GPIO_OUT_LOW
#define PIN_194_IS_GPIO             GPIO_OUT_HIGH
#define PIN_124_IS_GPIO             GPIO_OUT_LOW
#define PIN_185_IS_GPIO             GPIO_IN
#define PIN_206_IS_GPIO             GPIO_IN
#define PIN_199_IS_GPIO             GPIO_IN
#define PIN_118_IS_GPIO             GPIO_IN//PAD_TS1_CLK
#define PIN_179_IS_GPIO             GPIO_OUT_HIGH//PAD_CEC
#define PIN_126_IS_GPIO             GPIO_OUT_HIGH//PAD_TS1_D6
#define PIN_127_IS_GPIO             GPIO_OUT_HIGH//PAD_TS1_VLD
#define PIN_121_IS_GPIO             GPIO_OUT_HIGH//PAD_TS1_D5
#define PIN_120_IS_GPIO             GPIO_OUT_LOW//PAD_TS1_D6


//#define PIN_128_IS_GPIO             GPIO_OUT_HIGH//PAD_TS1_VSYNC
#define PIN_128_IS_GPIO             GPIO_OUT_HIGH//PAD_TS1_VSYNC if using  MSD7C19.h
                                                      //default : high to low
#define PIN_157_IS_GPIO             GPIO_OUT_HIGH//PAD_SAR0
#define PIN_158_IS_GPIO             GPIO_OUT_HIGH
#define PIN_159_IS_GPIO             GPIO_OUT_HIGH
#define PIN_160_IS_GPIO             GPIO_OUT_HIGH
#define PIN_183_IS_GPIO             GPIO_OUT_HIGH
#define PIN_184_IS_GPIO             GPIO_OUT_HIGH
#define PIN_195_IS_GPIO             GPIO_OUT_HIGH // USB Port 2 Power En
                                                  // Also in 124A Demo
//#define PIN_159_IS_GPIO             GPIO_OUT_LOW  // Audio Mute
                                                  // Pin 178 in 124A Demo
#define PAD_GPIO_PM9_IS_GPIO        GPIO_OUT_HIGH //pm9
#define PIN_169_IS_GPIO             GPIO_OUT_HIGH//PM0
#define PIN_171_IS_GPIO             GPIO_OUT_HIGH//PM0
//#define PIN_72_IS_GPIO             GPIO_OUT_LOW   //PAD_TS1_VSYNC if using  MSD7818.h

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7C19.h"
...
#endif
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP_128
