...
#define BOARD_NAME                  "BD_SS2000_DT0A"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 PIN_100
...
#define PADS_TS1_MODE               PAD_TS1_CLK //PAD_TS1_D7
...
#define PIN_79_IS_GPIO              GPIO_IN          //79	GPIO4	CH_SW_UP
#define PIN_80_IS_GPIO              GPIO_IN          //80	GPIO3	CH_SW_DOWN
#define PIN_86_IS_GPIO              GPIO_OUT_HIGH    //86	EJ_TMS	AUDIO_MUTE
#define PIN_87_IS_GPIO              GPIO_OUT_HIGH    //87
#define PIN_89_IS_GPIO              GPIO_IN          //89	SAR1	       PWR_SW_INT
#define PIN_90_IS_GPIO              GPIO_OUT_LOW    //90	SAR2	SCART - ON_STBY#.	AU_MUTE, FP, Key.	Output	Low
#define PIN_91_IS_GPIO              GPIO_IN   //91
#define PIN_96_IS_GPIO              GPIO_OUT_HIGH   //96	PM_GPIO9	FE RST.		Output	Low to High
#define PIN_101_IS_GPIO             GPIO_OUT_HIGH   //101	PM_GPIO0	Flash WP.		Output	High
#define PIN_102_IS_GPIO             GPIO_OUT_HIGH   //102	PM_GPIO4	PD controll.		Output	High
#define PIN_104_IS_GPIO             GPIO_OUT_HIGH          //104
//#define PIN_108_IS_GPIO                     GPIO_OUT_HIGH    //108	SPDIF	SPDIF output.		Output
#define PIN_109_IS_GPIO             GPIO_IN          //109	HSYNC	HDMI HPD.		Input
...
#endif
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP_128 //DDR3_INTERFACE_BGA
