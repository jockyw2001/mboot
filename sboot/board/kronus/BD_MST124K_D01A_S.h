...
// KRONUS_TODO // refine the pad/gpio
#define BOARD_NAME                  "BD_MST124K_D01A_S"
...
#define PIN_FLASH_WP0               PAD_GPIO_PM0
#define PIN_FLASH_WP1               0

#define Unknown_pads                0
#define PADS_PM5_IS_IRIN            0//QFP156 MODE
...
#define PADS_I2CM0_MODE             PAD_I2CM0_SDA//Unknown_pads
#define PADS_I2CM1_MODE             Unknown_pads
#define PADS_TS0_MODE               PAD_TS0_CLK
#define PADS_TS1_MODE               PAD_TS1_CLK//Unknown_pads //PAD_TS1_D7
#define PADS_TS2_MODE               Unknown_pads
#define PADS_NAND_MODE              PAD_S_GPIO4
#define PADS_CI_MODE                PAD_CI_A14
...
#define PADS_ET_MODE                PAD_ET_TXD1
...
//die
#define PAD_AGC_UP_IS_GPIO           GPIO_IN       //RFAGC
#define PAD_SPDIF_OUT2_IS_GPIO       GPIO_OUT_LOW  // USB Port 2 Power En
#define PAD_HSYNC_OUT_IS_GPIO        GPIO_IN       //USB_P2 over current detect
#define PAD_VSYNC_OUT_IS_GPIO        GPIO_OUT_LOW  //HDMI Hotplug Detect
#define PAD_S_GPIO0_IS_GPIO          GPIO_OUT_LOW  //Scart_P16_GPIO
#define PAD_S_GPIO1_IS_GPIO          GPIO_IN       //USB_P1 over current detect
#define PAD_S_GPIO2_IS_GPIO          GPIO_OUT_LOW  //USB_P1 power enable
#define PAD_S_GPIO3_IS_GPIO          GPIO_OUT_HIGH //PCMCIA power enable
#define PAD_S_GPIO4_IS_GPIO          GPIO_OUT_HIGH  //FE RST
//pm
#define PAD_SAR0_IS_GPIO             GPIO_OUT_HIGH // DISP_LED-CTRL
#define PAD_SAR1_IS_GPIO             GPIO_IN       // AC power cut off interrupt
#define PAD_SAR2_IS_GPIO             GPIO_OUT_LOW  // Audio Mute. 
#define PAD_SAR3_IS_GPIO             GPIO_OUT_HIGH // Dual LED Display - red
#define PAD_GPIO_PM0_IS_GPIO         GPIO_OUT_HIGH // FLASH - WP.
#define PAD_GPIO_PM1_IS_GPIO         GPIO_IN       // System Standby control
#define PAD_GPIO_PM2_IS_GPIO         GPIO_OUT_HIGH // DISP_CLK-GPIO
#define PAD_GPIO_PM3_IS_GPIO         GPIO_OUT_HIGH // DISP_DATA-GPIO
#define PAD_GPIO_PM4_IS_GPIO         GPIO_OUT_HIGH // Power On controll.
#define PAD_GPIO_PM5_IS_GPIO         GPIO_OUT_HIGH // DISP_STB-GPIO
#define PAD_GPIO_PM6_IS_GPIO         GPIO_OUT_HIGH // PM6_dual_LED_green
#define PAD_GPIO_PM7_IS_GPIO         GPIO_OUT_HIGH // SCAR Pin8_0V_GPIO
#define PAD_GPIO_PM8_IS_GPIO         GPIO_OUT_LOW  // SCART Pin8_6V_GPIO
#define PAD_GPIO_PM9_IS_GPIO         GPIO_OUT_HIGH // Demodulator Reset


//------Chip Type---------------------------------------------------------------
#include "chip/MSD7C16.h"
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_KGC_BGA //DDR2_INTERFACE_BGA
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO          109 // GPIO 0 ~ 12

// ----- KGB Enable Greenwich demod clock --------------------------------------
#define ENABLE_GREENWICH_CLK         1
