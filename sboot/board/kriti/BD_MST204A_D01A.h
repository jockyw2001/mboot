...
#define BOARD_NAME                  "BD_MST204A_D01A"
...
#define PIN_65_IS_GPIO              GPIO_OUT_HIGH   // SPI WP0
#define PIN_81_IS_GPIO              GPIO_OUT_HIGH   // Frontend RST
#define PIN_82_IS_GPIO              GPIO_OUT_LOW    // USB_ PWR_EN
#define PIN_93_IS_GPIO              GPIO_IN   		// USB_PWR-OCD
#define PIN_1_IS_GPIO             GPIO_OUT_HIGH   // SPDIF from optical
#define PIN_38_IS_GPIO              GPIO_IN         // PWM0 for Power consumption
#define PIN_39_IS_GPIO              GPIO_IN         // PWM1 for Power consumption
#define PIN_41_IS_GPIO              GPIO_IN         // PWM2 for Power consumption
#define PIN_55_IS_GPIO              GPIO_OUT_LOW         // PAD_T_GPIO1
#define PIN_53_IS_GPIO              GPIO_OUT_HIGH         // PAD_T_GPIO2

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7T0X.h"
...
#define AUDIO_PATH_SPDIF            AUDIO_PATH_2
...
#define AUDIO_PATH_HDMI             AUDIO_PATH_NULL
...
#if ENABLE_MSTAR_KRITI_BD_FPGA
#define  MIU_INTERFACE                  DDR2_INTERFACE_FPGA
#elif ENABLE_MSTAR_KRITI_BD_MST204A_D01A_S_DDR2
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP_128
#elif ENABLE_MSTAR_KRITI_BD_MST204A_D01A_S_DDR3
#define  MIU_INTERFACE                  DDR3_INTERFACE_QFP_128
#elif ENABLE_MSTAR_KRITI_BD_MST204A_D01A_DDR2
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP_128
#elif ENABLE_MSTAR_KRITI_BD_MST204A_D01A_DDR3
#define  MIU_INTERFACE                  DDR3_INTERFACE_QFP_128
#else
#warning WrongMIUConfig
#endif
