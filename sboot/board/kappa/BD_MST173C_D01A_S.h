...
// KAPPA_TODO // refine the pad/gpio
#define BOARD_NAME                  "BD_MST173C_D01A_S"
...
#define PIN_90_IS_GPIO              GPIO_OUT_HIGH   // SPI WP0
#define PIN_117_IS_GPIO             GPIO_OUT_HIGH   // Frontend RST
#define PIN_1_IS_GPIO               GPIO_OUT_HIGH   // SPDIF from optical
#define PIN_77_IS_GPIO              GPIO_IN         // PWM0 for Power consumption
#define PIN_78_IS_GPIO              GPIO_IN         // PWM1 for Power consumption
#define PIN_79_IS_GPIO              GPIO_IN         // PWM2 for Power consumption

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7803.h"
...
#if ENABLE_DDR2_INTERFACE_FPGA
#define  MIU_INTERFACE                  DDR2_INTERFACE_FPGA
#elif ENABLE_DDR2_INTERFACE_QFP_128
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP_128
#elif ENABLE_DDR3_INTERFACE_QFP_156
#define  MIU_INTERFACE                  DDR3_INTERFACE_QFP_156
#elif ENABLE_DDR3_INTERFACE_QFP_128
