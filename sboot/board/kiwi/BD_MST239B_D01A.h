...
#define BOARD_NAME                  "BD_MST239B_D01A"
...
#define PAD_I2CM1_MODE             PAD_MUX_MODE_UNKNOWN
#define PAD_I2CM2_MODE             PAD_MUX_MODE_UNKNOWN
#define PAD_TS0_MODE               PAD_MUX_MODE_1
...
#define PAD_CH34_DBG_MODE          PAD_MUX_MODE_UNKNOWN
...
#define PAD_PWM0_IS_GPIO            GPIO_OUT_LOW // VCR_ABSENCE, High: RGB no output signal, Low: RGB output signal
#define PAD_PWM1_IS_GPIO            GPIO_OUT_HIGH  // DVB_RATION, High 16:9, Low  4:3
#define PAD_PWM2_IS_GPIO            GPIO_OUT_LOW  // RGB/CVBS, Low: 0~0.4V: Composite, High: 1~3V: RGB
#define PAD_TM_GPIO0_IS_GPIO        GPIO_OUT_HIGH  // DualLED_Green Operation mode, Low: Operation mode, High: Standby mode
#define PAD_TM_GPIO1_IS_GPIO        GPIO_OUT_LOW // DualLED_Red Standby mode, High: Operation mode, Low: Standby mode
#define PAD_S_GPIO6_IS_GPIO         GPIO_NONE       // System Standby Control Buttom, Low: Change mode
...
#define PAD_TS0_D1_IS_GPIO          GPIO_NONE       // USB Over Current Detect, High: Operation mode, Low: USB power short
#define PAD_I2CM1_SDA_IS_GPIO       GPIO_OUT_HIGH    // LNB I2C SDA
#define PAD_I2CM1_SCL_IS_GPIO       GPIO_OUT_LOW     // LNB I2C SCL
#define PAD_I2CM0_SCL_IS_GPIO       GPIO_OUT_HIGH     // Tuner I2C SCL
#define PAD_I2CM0_SDA_IS_GPIO       GPIO_OUT_HIGH     // Tuner I2C SDA
#define PAD_DISEQ_IN_IS_GPIO        GPIO_NONE       // LNB DiSEQC Input
#define PAD_DISEQ_OUT_IS_GPIO       GPIO_NONE  // LNB DiSEQC Output
#define PAD_SAR0_IS_GPIO            GPIO_IN // Tuner power management control, High: Enable exernal front-end power, Low: Disable exernal front-end power
#define PAD_SAR1_IS_GPIO            GPIO_OUT_HIGH   // Antenna Over Current Protection, 3.3V: Antenna power good, Under 2V: Antenna power short
#define PAD_SAR2_IS_GPIO            GPIO_IN  // Tuner reset, Low: Enable reset tuner, High: Disable reset tuner
#define PAD_TS0_D2_IS_GPIO          GPIO_NONE  // USB1 Enable, Low: USB power enable, High: USB power disable
#define PAD_SAR3_IS_GPIO            GPIO_IN  // USB0 Enable, Low: USB power enable, High: USB power disable
#define PAD_ET_LINK_LED_IS_GPIO     GPIO_OUT_HIGH     // Ethernet Link LED
#define PAD_ET_SPEED_LED_IS_GPIO    GPIO_OUT_HIGH     // Ethernet Speed/Activity LED
#define GPIO_FE_RST                 PAD_PWM2

//------Chip Type---------------------------------------------------------------
#include "chip/MSA3B171.h"
