...
// Kiwi
#define BD_KIWI_FPGA                     0x0A70
#define BD_MST239A_D01A                  0x0A71
#define BD_MST239A_D01A_S_DDR2_DDR3_NOR  0x0A72
#define BD_MST239A_D01A_S_NAND           0x0A73

#ifndef MS_BOARD_TYPE_SEL
#if defined (CONFIG_MSTAR_KIWI_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_KIWI_FPGA
    #define MIU_INTERFACE           DDR2_INTERFACE_FPGA
#elif defined (CONFIG_MSTAR_KIWI_BD_MST239A_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST239A_D01A
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KIWI_BD_MST239B_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST239B_D01A
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KIWI_BD_MST239A_D01A_S_DDR2_DDR3_NOR)
    #define MS_BOARD_TYPE_SEL       BD_MST239A_D01A_S_DDR2_DDR3_NOR
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#elif defined (CONFIG_MSTAR_KIWI_BD_MST239A_D01A_S_NAND)
    #define MS_BOARD_TYPE_SEL       BD_MST239A_D01A_S_NAND
    #define MIU_INTERFACE           DDR3_INTERFACE_QFP_128
#else
...
#if  (MS_BOARD_TYPE_SEL == BD_KIWI_FPGA)
    #include "BD_KIWI_FPGA.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST239A_D01A)
    #include "BD_MST239A_D01A.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST239B_D01A)
    #include "BD_MST239B_D01A.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST239A_D01A_S_DDR2_DDR3_NOR)
    #include "BD_MST239A_D01A_S_DDR2_DDR3_NOR.h"
#elif  (MS_BOARD_TYPE_SEL == BD_MST239A_D01A_S_NAND)
    #include "BD_MST239A_D01A_S_NAND.h"
#else
...
#elif defined(CONFIG_EMBEDDED_DVBC_DEMOD)
...
#elif defined(CONFIG_TUNER_MXL608)
...
// support MSPI load code
#define SYSBSP_CHIPTOP_OFFSET		0x1e00
#define SYSBSP_TS_MODE_OFFSET		(SYSBSP_CHIPTOP_OFFSET+(0x02*2))    //reg_ts0_mode
#define SYSBSP_TS0_MODE_SHIFT		0x0
#define SYSBSP_TS0_MODE_MASK		0x7
#define SYSBSP_TS_MODE_1P			0x1
#define SYSBSP_TS_MODE_MSPI			0x2
