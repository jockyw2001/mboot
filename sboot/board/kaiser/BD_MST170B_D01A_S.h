...
#define BOARD_NAME                  "BD_MST170B_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_A21
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_B21
...
#define PADS_TS3_MODE               Unknown_pads
...
#define BALL_AB23_IS_GPIO    GPIO_OUT_LOW    // Video buffer(SEL0)
#define BALL_AA23_IS_GPIO    GPIO_OUT_LOW    // Video buffer(SEL1)
#define BALL_E10_IS_GPIO     GPIO_OUT_HIGH   //USB2_EN
#define BALL_Y23_IS_GPIO     GPIO_OUT_LOW    //SM0_VCCSEL2 for 1.8V
#define BALL_AA25_IS_GPIO    GPIO_OUT_LOW    //SM1_VCCSEL2 for 1.8V
#define BALL_Y24_IS_GPIO     GPIO_OUT_LOW    //SM0_VCCSEL
#define BALL_V22_IS_GPIO     GPIO_OUT_LOW    //SM1_VCCSEL
#define BALL_E21_IS_GPIO     GPIO_OUT_LOW    //VSYNC
#define BALL_D21_IS_GPIO     GPIO_OUT_LOW    //HSYNC
#define BALL_F25_IS_GPIO     GPIO_IN         //For Tuner/CCIR656
#define BALL_F23_IS_GPIO     GPIO_IN         //
#define BALL_W24_IS_GPIO     GPIO_IN         //VGA_OUT/I2S
#define BALL_W23_IS_GPIO     GPIO_IN         //

#define BALL_B24_IS_GPIO     GPIO_IN         //System Standby
#define BALL_B23_IS_GPIO     GPIO_IN         //PWR CUT
#define BALL_E14_IS_GPIO     GPIO_OUT_LOW    //HDMI CTL (bypass mode)
#define BALL_D13_IS_GPIO     GPIO_OUT_LOW    //LED_CTL0
#define BALL_E19_IS_GPIO     GPIO_OUT_HIGH    //Front end Reset
#define BALL_E16_IS_GPIO     GPIO_OUT_LOW    //CPU_VID_0
#define BALL_B21_IS_GPIO     GPIO_OUT_LOW    //SPI FLASH WPNZ
#define BALL_D16_IS_GPIO     GPIO_OUT_LOW    //VID_0
#define BALL_D18_IS_GPIO     GPIO_OUT_HIGH   //Power Down control.
#define BALL_B25_IS_GPIO     GPIO_OUT_LOW    //CPU_VID_1
#define BALL_C19_IS_GPIO     GPIO_IN         //SD_CDZ(Reserve for SPI_CSZ1)
#define BALL_E22_IS_GPIO     GPIO_OUT_LOW    //SDIO_WPN
#define BALL_C11_IS_GPIO     GPIO_IN         //HDMI TX HPD
#define BALL_L3_IS_GPIO      GPIO_IN         //SDIO_CDZ
#define BALL_D5_IS_GPIO      GPIO_OUT_HIGH   //Audio Mute.
#define BALL_D19_IS_GPIO     GPIO_OUT_LOW    //GPHY_RST
#define BALL_D14_IS_GPIO     GPIO_OUT_LOW    //VID_1

#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7887.h"
