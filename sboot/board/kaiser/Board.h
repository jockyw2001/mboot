...
#define DDR3_MIU0_32_MIU1_32                    5
#define DDR3_MIU0_32_MIU1_32_4GB                6
#define DDR3_MIU0_32_MIU1_32_TMODE              7
#define DDR3_MIU0_32_MIU1_32_TMODE_2LAYER       8
...
#define BD_KAISER_FPGA                  0x0770
#define BD_MST170A_D01A_S               0x0771
#define BD_MST170A_D01A                 0x0772
#define BD_MST170B_D01A_S               0x0773
#define BD_D3C_L4D_V01                  0x0774
#define BD_D3B_L2S_V01                  0x0775
#define BD_MST170A_D02A                 0x0776
#define BD_MP3050_SR1                   0x0777
#define BD_MP3050_SR2                   0x0778
#define BD_MST187A_D01A                 0x0779
#define BD_MST170A_D01A_SZ              0x077a
#define BD_MST187C_D01A                 0x077b
#define BD_MST187C_D01A_S               0x077c
#define BD_MST187D_D01A_S               0x077d
#define BD_MST187D_D01A                 0x077e
...
#if defined (CONFIG_MSTAR_KAISER_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_KAISER_FPGA
#elif defined (CONFIG_MSTAR_KAISER_BD_MST170A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST170A_D01A_S
#elif defined (CONFIG_MSTAR_KAISER_BD_MST170A_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST170A_D01A
#elif defined (CONFIG_MSTAR_KAISER_BD_MST170A_D01A_SZ)
    #define MS_BOARD_TYPE_SEL       BD_MST170A_D01A_SZ
#elif defined (CONFIG_MSTAR_KAISER_BD_MST170B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST170B_D01A_S
#elif defined (CONFIG_MSTAR_KAISER_BD_MST170A_D02A)
    #define MS_BOARD_TYPE_SEL       BD_MST170A_D02A
#elif defined (CONFIG_MSTAR_KAISER_BD_D3C_L4D_V01)
    #define MS_BOARD_TYPE_SEL       BD_D3C_L4D_V01
#elif defined (CONFIG_MSTAR_KAISER_BD_D3B_L2S_V01)
    #define MS_BOARD_TYPE_SEL       BD_D3B_L2S_V01
#elif defined (CONFIG_MSTAR_KAISER_BD_MP3050_SR1)
    #define MS_BOARD_TYPE_SEL       BD_MP3050_SR1
#elif defined (CONFIG_MSTAR_KAISER_BD_MP3050_SR2)
    #define MS_BOARD_TYPE_SEL       BD_MP3050_SR2
#elif defined (CONFIG_MSTAR_KAISER_BD_MST187A_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST187A_D01A
#elif defined (CONFIG_MSTAR_KAISER_BD_MST187C_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST187C_D01A
#elif defined (CONFIG_MSTAR_KAISER_BD_MST187D_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST187D_D01A_S
#elif defined (CONFIG_MSTAR_KAISER_BD_MST187C_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST187C_D01A_S
#elif defined (CONFIG_MSTAR_KAISER_BD_MST187D_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST187D_D01A
#else
    #error "Kaiser BOARD define not found"
#endif
#endif
//-------------------------------------------------------
...
#if (MS_BOARD_TYPE_SEL == BD_KAISER_FPGA)
    #include "BD_KAISER_FPGA.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST170A_D01A_S)
    #include "BD_MST170A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST170A_D01A)
    #include "BD_MST170A_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST170B_D01A_S)
    #include "BD_MST170B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST170A_D02A)
    #include "BD_MST170A_D02A.h"
#elif (MS_BOARD_TYPE_SEL == BD_D3C_L4D_V01)
    #include "BD_D3C_L4D_V01.h"
#elif (MS_BOARD_TYPE_SEL == BD_D3B_L2S_V01)
    #include "BD_D3B_L2S_V01.h"
#elif (MS_BOARD_TYPE_SEL == BD_MP3050_SR1)
    #include "BD_MP3050_SR1.h"
#elif (MS_BOARD_TYPE_SEL == BD_MP3050_SR2)
    #include "BD_MP3050_SR2.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST170A_D01A_SZ)
    #include "BD_MST170A_D01A_SZ.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST187A_D01A)
    #include "BD_MST187A_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST187C_D01A)
    #include "BD_MST187C_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST187C_D01A_S)
    #include "BD_MST187C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST187D_D01A_S)
    #include "BD_MST187D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST187D_D01A)
    #include "BD_MST187D_D01A.h"
#else
