...
#define BOARD_NAME                  "BD_KAISER_FPGA"
...
#define PADS_TS0_MODE               Unknown_pads
...
#define BALL_A3_IS_GPIO     GPIO_OUT_HIGH
#define BALL_D4_IS_GPIO     GPIO_OUT_HIGH
#define BALL_W9_IS_GPIO     GPIO_OUT_LOW
#define BALL_D8_IS_GPIO     GPIO_OUT_HIGH
#define BALL_Y9_IS_GPIO     GPIO_OUT_LOW
#define BALL_H6_IS_GPIO     GPIO_OUT_HIGH
#define BALL_AA10_IS_GPIO   GPIO_OUT_LOW
#define BALL_Y10_IS_GPIO    GPIO_OUT_LOW
#define BALL_AB22_IS_GPIO   GPIO_OUT_HIGH
#define BALL_AC1_IS_GPIO    GPIO_OUT_HIGH
#define BALL_AE4_IS_GPIO    GPIO_IN
#define BALL_AD4_IS_GPIO    GPIO_IN
#define BALL_Y22_IS_GPIO    GPIO_IN
#define BALL_AA22_IS_GPIO   GPIO_IN


//------Chip Type---------------------------------------------------------------
#include "chip/MSD_FPGA.h"
...
#define I2C_DEV_HDCPKEY             ((E_I2C_BUS_SYS << 8) | 0xA0)
...
#ifdef ATSC_SYSTEM
#define INPUT_SCART_VIDEO_COUNT         2
#else
#define INPUT_SCART_VIDEO_COUNT         2
#endif
...
#define INPUT_AV_YMUX               INPUT_PORT_YMUX_CVBS4
#define INPUT_AV2_YMUX              INPUT_PORT_YMUX_CVBS5
#define INPUT_AV3_YMUX              INPUT_PORT_NONE_PORT
#define INPUT_SV_YMUX               INPUT_PORT_YMUX_CVBS2   //INPUT_PORT_NONE_PORT
#define INPUT_SV_CMUX               INPUT_PORT_CMUX_CVBS3   //INPUT_PORT_NONE_PORT
...
#define INPUT_SCART2_YMUX           INPUT_PORT_YMUX_CVBS5
#define INPUT_SCART2_RGBMUX         INPUT_PORT_ANALOG2
...
#define AUDIO_SOURCE_SV             AUDIO_AUIN1_INPUT
#define AUDIO_SOURCE_SV2            AUDIO_AUIN3_INPUT
#define AUDIO_SOURCE_SCART          AUDIO_AUIN3_INPUT
#define AUDIO_SOURCE_SCART2         AUDIO_AUIN4_INPUT
...
#define EXT_RF_AGC_ON()                 //mdrv_gpio_set_high( BALL_AC1 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                //mdrv_gpio_set_low( BALL_AC1 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_AB10 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_AB10 )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_AA10 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_AA10 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_Y9 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_Y9 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_AB22 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_AB22 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_Y10 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_Y10 )
