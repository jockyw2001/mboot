...
#define BOARD_NAME                  "BD_MST187A_D01A"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_B24
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_C24
...
#define PADS_SM0_EN                 MUX_MODE_1
#define PADS_SM1_OPEN               Unknown_pads
#define PADS_SM1_C48                Unknown_pads
#define PADS_SM1_EN                 MUX_MODE_1
#define PADS_I2CM0_MODE             MUX_MODE_1
#define PADS_I2CM1_MODE             MUX_MODE_1
#define PADS_TS0_MODE               MUX_MODE_1
#define PADS_TS1_MODE               MUX_MODE_1
#define PADS_TS2_MODE               MUX_MODE_1
#define PADS_TS3_MODE               MUX_MODE_1
#define PADS_NAND_MODE              MUX_MODE_2
#define PADS_CI_MODE                MUX_MODE_1
#define PADS_CCIR_OUT_MODE          Unknown_pads
#define PADS_CCIR_IN_MODE           Unknown_pads
#define PADS_PANEL_IF_MODE          Unknown_pads
#define PADS_SPDIF_OUT_MODE         MUX_MODE_1
#define PADS_SPDIF_IN_MODE          Unknown_pads
#define PADS_I2S_IN_MODE            Unknown_pads
#define PADS_I2S_OUT_MUTE_MODE      Unknown_pads
#define PADS_I2S_OUT_MODE           MUX_MODE_2
#define PADS_MPIF_MODE              Unknown_pads
...
#define PADS_EMMC_MODE              Unknown_pads
#define PADS_SD_MODE                Unknown_pads
#define PADS_CI1_MODE               Unknown_pads
#define PADS_MSPI_MODE              Unknown_pads
#define PADS_MSPI2PMGPIO_MODE       Unknown_pads

//------GPIO setting(default GPIO pin level)------------------------------------
#if 1
#define BALL_AF24_IS_GPIO    GPIO_OUT_LOW     // Video buffer(SEL0)
#define BALL_AG24_IS_GPIO    GPIO_OUT_LOW     //  Video buffer(SEL1)
#define BALL_H23_IS_GPIO     GPIO_OUT_HIGH    // SM0_VCCSEL2 for 1.8V
#define BALL_K23_IS_GPIO     GPIO_OUT_HIGH    // CI power enable.
#define BALL_K24_IS_GPIO     GPIO_OUT_HIGH    // CI2 power enable.
#define BALL_AH19_IS_GPIO    GPIO_OUT_HIGH     // SM0_VCCSEL
#define BALL_J23_IS_GPIO     GPIO_OUT_HIGH     // SM1_VCCSEL
#define BALL_F25_IS_GPIO     GPIO_OUT_HIGH    // VSYNC
#define BALL_E25_IS_GPIO     GPIO_OUT_HIGH    // VSYNC

#define BALL_B26_IS_GPIO     GPIO_IN         // System Standby
#define BALL_C25_IS_GPIO     GPIO_IN         // PWR_CUT_OFF_INT
#define BALL_E17_IS_GPIO     GPIO_OUT_LOW    // HDMI CTL (bypass mode)
#define BALL_F16_IS_GPIO     GPIO_OUT_LOW    // LED_CTL0
#define BALL_F26_IS_GPIO     GPIO_OUT_HIGH    // Front end Reset
#define BALL_D22_IS_GPIO     GPIO_OUT_HIGH   // Front end 2 Reset/WKUP
#define BALL_A24_IS_GPIO     GPIO_OUT_HIGH   // SPI FLASH WPNZ
#define BALL_D23_IS_GPIO     GPIO_OUT_HIGH   // VID_0/MSPI_CLK
#define BALL_E26_IS_GPIO     GPIO_OUT_HIGH   // Power Down control.
#define BALL_E23_IS_GPIO     GPIO_OUT_HIGH   // MSPI_SDI
#define BALL_L25_IS_GPIO     GPIO_IN         // SD_CDZ
#define BALL_D24_IS_GPIO     GPIO_OUT_HIGH   // MSPI_SDO
#define BALL_E11_IS_GPIO     GPIO_IN         // HDMI TX HPD
#define BALL_A2_IS_GPIO      GPIO_IN         // SDIO_CDZ
#define BALL_E6_IS_GPIO      GPIO_OUT_HIGH   // Audio Mute.
#define BALL_E24_IS_GPIO     GPIO_OUT_HIGH   // RF4CE_RST
#define BALL_E22_IS_GPIO     GPIO_OUT_HIGH   // VID_1
#define BALL_F22_IS_GPIO     GPIO_OUT_LOW // CPU_VID_1

#define BALL_E19_IS_GPIO     GPIO_OUT_LOW   // Front panel LED - Green.
#define BALL_E20_IS_GPIO     GPIO_OUT_LOW   // DISP DATA.
#define BALL_F21_IS_GPIO     GPIO_OUT_LOW   // DISP CLK.
#define BALL_D20_IS_GPIO     GPIO_OUT_LOW   // DISP STB.

#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7C89.h"
...
#define AUDIO_PATH_BTSC1            AUDIO_T3_PATH_AUOUT0
...
#define TS_CLK_INV                      1
#define TS_PARALLEL_OUTPUT              1
#define FRONTEND_DEMOD_TYPE             EMBEDDED_DVBT_DEMOD //ZARLINK_ZL10353_DEMODE
...
#ifndef MEMORY_MAP
#define MEMORY_MAP                      MMAP_256_256MB  // 1024 1024  ??TBC
#endif

#define MIU_INTERFACE                   DDR3_INTERFACE_BGA   //DDR3_INTERFACE_BGA / DDR2_INTERFACE_BGA
#define MIU_DRAM_FREQ                   1866 //800 / 1066 / 1333 / 1600 / 1866

#define MIU1_INTERFACE                  DDR3_INTERFACE_BGA   //DDR3_INTERFACE_BGA / DDR2_INTERFACE_BGA
#define MIU1_DRAM_FREQ                  1866 //800 / 1066 / 1333 / 1600/ 1866

#define MIU_CONFIG                      DDR3_MIU0_32_MIU1_32
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO              148

// ----- TS Input setting-------------------------------------------------------
#define ENABLE_FOUR_SERIAL_TS_IN 1
#define TS_CLK_IN_REG 0x1EE7
#define TS_CLK_IN_SERIAL_IN_MODE 0x0
#define TS_IN_FOUR_SERIAL_IN_MODE_MASK (BIT3|BIT4)
//note: offset: 16 bit,0x73  Bit: 11 12
//Bit:8~10 is read only, Bit:13~15 is reserved

// ----- BOARD_WITH_VANCLEEF_MCP --------------------------------------------------------
#define VANCLEEF_MCP_ENABLE             DISABLE
