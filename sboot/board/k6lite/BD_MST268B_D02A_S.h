...
#define BOARD_NAME                  "BD_MST268B_D02A_S"
...
#define PAD_GPIO3_IS_GPIO GPIO_OUT_HIGH // I2S_OUT
...
#define PAD_VSYNC_OUT_IS_GPIO GPIO_NONE // DAC_GPIO0 (SCART pin8_6V control)
#define PAD_HSYNC_OUT_IS_GPIO GPIO_NONE // DAC_GPIO1  (SCART pin8_0V control)
// PM
...
#define PAD_PM_GPIO0_IS_GPIO GPIO_NONE // DISP_CLK-GPIO/Core_VID_0
...
#define PAD_PM_GPIO14_IS_GPIO GPIO_NONE // DISP_STB-GPIO/Core_VID_1
#define PAD_PM_GPIO15_IS_GPIO GPIO_OUT_HIGH // LED_RED-EN_GPIO
#define PAD_VID0_IS_GPIO GPIO_NONE // SCL
#define PAD_VID1_IS_GPIO GPIO_NONE // SDA
...
#endif
#define  MIU_INTERFACE                  DDR4_INTERFACE_FBGA
