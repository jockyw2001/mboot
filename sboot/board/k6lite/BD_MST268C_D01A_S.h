...
#define BOARD_NAME                  "BD_MST268C_D01A_S"
...
#define PADS_SPDIF_OUT_MODE         PADMUX_MDOE_DEFAULT
...
#define PADS_I2S_IN_MODE            PADMUX_MDOE1
...
// None PM
#define PAD_GPIO0_IS_GPIO GPIO_NONE // UART_TX3
#define PAD_GPIO1_IS_GPIO GPIO_NONE // UART_RX3
#define PAD_GPIO2_IS_GPIO GPIO_NONE // NONE
#define PAD_GPIO3_IS_GPIO GPIO_OUT_IN // USB_OCP  (USB over current detection)
#define PAD_GPIO4_IS_GPIO GPIO_OUT_HIGH  // USB20_EN (USB power enable)
#define PAD_GPIO5_IS_GPIO GPIO_NONE // NONE
#define PAD_GPIO6_IS_GPIO GPIO_OUT_LOW // SATA_LED
#define PAD_GPIO7_IS_GPIO GPIO_NONE // NONE
#define PAD_GPIO8_IS_GPIO GPIO_NONE // I2S_OUT_MCK
#define PAD_GPIO9_IS_GPIO GPIO_NONE // NONE
#define PAD_VSYNC_OUT_IS_GPIO GPIO_NONE // HSYNC_OUT
#define PAD_HSYNC_OUT_IS_GPIO GPIO_NONE // VSYNC_OUT
// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_IN // SYS_Standby
#define PAD_SAR_GPIO1_IS_GPIO GPIO_OUT_HIGH // GPHY_RST
#define PAD_SAR_GPIO2_IS_GPIO GPIO_NONE // NONE
#define PAD_SAR_GPIO5_IS_GPIO GPIO_IN // PWR CUT  (power cut detection)
#define PAD_PM_GPIO0_IS_GPIO GPIO_NONE // NONE
#define PAD_PM_GPIO1_IS_GPIO GPIO_NONE // NONE
#define PAD_PM_GPIO2_IS_GPIO GPIO_IN // RTC_INT
#define PAD_PM_GPIO3_IS_GPIO GPIO_NONE // NONE
#define PAD_PM_GPIO4_IS_GPIO GPIO_NONE // NONE
#define PAD_PM_GPIO6_IS_GPIO GPIO_OUT_HIGH // LED_CTL1 (LED control)
#define PAD_PM_GPIO8_IS_GPIO GPIO_OUT_LOW // LED_CTL0 (LED control)
#define PAD_PM_GPIO9_IS_GPIO GPIO_IN // CHIP_CONFIG[0]
#define PAD_PM_GPIO10_IS_GPIO GPIO_IN // CHIP_CONFIG[1]
#define PAD_PM_GPIO11_IS_GPIO GPIO_OUT_HIGH // PD_CTL (power down control)
#define PAD_PM_GPIO12_IS_GPIO GPIO_IN // CHIP_CONFIG[2]
#define PAD_PM_GPIO13_IS_GPIO GPIO_IN // OTP_CONFIG
#define PAD_PM_GPIO14_IS_GPIO GPIO_NONE // Core_VID_1
#define PAD_PM_GPIO15_IS_GPIO GPIO_NONE // Core_VID_0
#define PAD_VID0_IS_GPIO GPIO_NONE // VID0/SCL
#define PAD_VID1_IS_GPIO GPIO_NONE // VID1/SDA
//PM_GPIO14 : Low
//PM_GPIO15 : High
#define VID_GPIO_SETUP   {CHIPCFG_CMD_BASE_8BITS, 0x1f00}, \
                         {0x0f1c<<1, 0x0003}, \
                         {((0x0e50<<1)+1),0x0008}, \
                         {0x0f1e<<1, 0x0203},
