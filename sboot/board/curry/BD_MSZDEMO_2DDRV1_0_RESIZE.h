...
#define BOARD_NAME                  "BD_MSZDEMO_2DDRV1_0"
...
#define PADS_EJ_MODE                Unknown_pads
#if (CONFIG_MSTAR_SD_DETECT == 1)
#define PADS_SM0_OPEN               SD_MODE
#else
#define PADS_SM0_OPEN               PAD_GT0_RX_CLK
#endif
...
#define PADS_TS0_MODE               PAD_TS_SYNC
#define PADS_TS1_MODE               Unknown_pads
#define PADS_TS2_MODE               Unknown_pads
#define PADS_TS_OUT_MODE            Unknown_pads
#define PADS_NAND_MODE              Unknown_pads
#define PADS_SPDIF_OUT_MODE         PAD_GPIO2
#define PADS_SPDIF_IN_MODE          Unknown_pads
#define PADS_I2S_OUT_MODE           Unknown_pads
#define PADS_I2S_OUT_MODE_2         Unknown_pads
#define PADS_I2S_OUT_MUTE_MODE      Unknown_pads
#define PADS_SDIO_MODE              Unknown_pads
#define PADS_SD_CONFIG0             Unknown_pads
#define PADS_SD_CONFIG1             Unknown_pads
...
#define PADS_EMMC_CONFIG            Unknown_pads
#define PADS_MSPI1_MODE1            Unknown_pads
#define PADS_MSPI1_MODE2            Unknown_pads
#define PADS_MSPI2_MODE2            Unknown_pads
#define PADS_PWM0_MODE              Unknown_pads
#define PADS_PWM1_MODE              Unknown_pads
#define PADS_HDMITX_DDC_MODE        PAD_HDMITX_SCL

//------GPIO setting(default GPIO pin level)------------------------------------
// None PM
#define PAD_GPIO4_IS_GPIO     GPIO_OUT_HIGH // Audio mute: No Mute=H, Mute=L
#define PAD_I2CM1_SCL_IS_GPIO GPIO_OUT_HIGH // FB_RST: Front end Reset
#define PAD_I2CM1_SDA_IS_GPIO GPIO_OUT_HIGH // LNB_CTL: Tuner antenna power control, Enable=H

// PM
#define PAD_SAR_GPIO0_IS_GPIO GPIO_IN       // System Standby
#define PAD_SAR_GPIO1_IS_GPIO GPIO_OUT_LOW  // BT_RST: BT module reset
#define PAD_SAR_GPIO2_IS_GPIO GPIO_OUT_HIGH  // WIFI_RST: WiFi module reset
#define PAD_SAR_GPIO3_IS_GPIO GPIO_OUT_HIGH // CORE_CTLZ1: Control resistor Switch for core power control with DVFS
#define PAD_SAR_GPIO4_IS_GPIO GPIO_OUT_LOW  // LED0_CTL:  LED0_CTL ON=H, OFF=L   // SZDEMO_BOARD
#define PAD_PM_GPIO0_IS_GPIO GPIO_OUT_HIGH  // USB1_EN: Chip config[0] USB1 power Enable, Enable=H
#define PAD_PM_GPIO3_IS_GPIO GPIO_OUT_HIGH  // USB0_EN: Chip config[1] USB0 power Enable, Enable=H
#define PAD_PM_GPIO4_IS_GPIO GPIO_OUT_HIGH  // PD_CTL: Power Down control. Power Down=L

//------Chip Type---------------------------------------------------------------
#include "chip/MSO9380AK.h"
...
#define AUDIO_PATH_LINEOUT          AUDIO_T3_PATH_I2S
#define AUDIO_PATH_SIFOUT           AUDIO_T3_PATH_AUOUT3
#define AUDIO_PATH_SCART1           AUDIO_T3_PATH_AUOUT3
#define AUDIO_PATH_SCART2           AUDIO_T3_PATH_AUOUT3
...
#define AUDIO_OUTPUT_LINEOUT       AUDIO_I2S_OUTPUT
#define AUDIO_OUTPUT_SIFOUT        AUDIO_AUOUT3_OUTPUT
#define AUDIO_OUTPUT_SCART1        AUDIO_AUOUT3_OUTPUT
#define AUDIO_OUTPUT_SCART2        AUDIO_AUOUT3_OUTPUT
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_14x14_RESIZE
...
#define CpuCorePWRHigh()                 *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) = *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) | 0x0002;  \
                                         *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) = *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) & ~0x0001; \
                                         *(volatile MS_U16 *)(0xBF200000 + (0x1ea0 << 1)) = *(volatile MS_U16 *)(0xBF200000 + (0x1ea0 << 1)) & ~0x8000;

#define CpuCorePWRLow()                  *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) = *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) & ~0x0002; \
                                         *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) = *(volatile MS_U16 *)(0xBF000000 + (0x0f04 << 1)) & ~0x0001; \
                                         *(volatile MS_U16 *)(0xBF200000 + (0x1ea0 << 1)) = *(volatile MS_U16 *)(0xBF200000 + (0x1ea0 << 1)) & ~0x8000;
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO              14// GPIO 0 ~ 12

// ----- DVFS RELATED --------------------------------------------------------
#ifdef CONFIG_MSTAR_VID_ENABLE
#define VID_CPU_SIDD_CRITERIA 84  // 20.89mA * 4
#define VID_CPU_OSC_CRITERIA 400 // 12.5 MHz * 32
#define VID_CORE_SIDD_CRITERIA 120 // 14.95mA * 8
#define VID_CORE_OSC_CRITERIA 361  // 11.28MHz * 32
#endif

#ifdef CONFIG_MSTAR_DVFS_ENABLE
#define CONFIG_CHIP_PACKAGE 0
#define CONFIG_MSTAR_DVFS_TEMPERATURE_LOWER_BOUND 115
