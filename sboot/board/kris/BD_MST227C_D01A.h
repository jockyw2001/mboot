...
#define BOARD_NAME                  "BD_MST227C_D01A"
...
#define PAD_I2S_OUT_MCK_IS_GPIO GPIO_IN       // USB0 OCD 
#define PAD_I2S_OUT_BCK_IS_GPIO GPIO_OUT_HIGH // USB 1 EN 
#define PAD_I2S_OUT_WS_IS_GPIO  GPIO_OUT_HIGH // SCART_PIN8_CTL1
#define PAD_GPIO0_IS_GPIO       GPIO_IN       // SCART_PIN8_CTL0
#define PAD_GPIO1_IS_GPIO       GPIO_OUT_LOW  //RGB/CVBS  L:CVBS ; H:RGB
...
#define PAD_PM_GPIO2_IS_GPIO    GPIO_OUT_HIGH // VID 0 / Core PWR level setting
