...
#define BOARD_NAME                  "BD_MST227B_D01A_S"
...
#define PADS_I2CM0_MODE             PAD_I2CM0_SDA
...
#define PADS_NAND_MODE              PAD_GPIO3
...
#define PADS_LED_MODE               PAD_PM_GPIO15

//------GPIO setting(default GPIO pin level)------------------------------------
//#define PAD_I2S_OUT_MCK_IS_GPIO GPIO_IN          //ej
#define PAD_I2S_OUT_BCK_IS_GPIO GPIO_OUT_HIGH // USB1 EN
//#define PAD_I2S_OUT_MUTE_IS_GPIO GPIO_IN        // ej
#define PAD_I2S_OUT_WS_IS_GPIO   GPIO_IN      //USB 1 OCD
//#define PAD_I2S_OUT_SDO_IS_GPIO GPIO_IN          //ej
#define PAD_GPIO0_IS_GPIO       GPIO_OUT_HIGH // SCART_PIN8_CTL0
#define PAD_GPIO1_IS_GPIO       GPIO_OUT_LOW  // RGB/CVBS
#define PAD_CI_D3_IS_GPIO       GPIO_OUT_HIGH // USB0 EN
#define PAD_CI_D4_IS_GPIO       GPIO_IN       // 
#define PAD_CI_D5_IS_GPIO       GPIO_OUT_HIGH // LED CTL 0
#define PAD_CI_D6_IS_GPIO       GPIO_OUT_HIGH // LED CTL 1
#define PAD_CI_D7_IS_GPIO       GPIO_OUT_HIGH //SCART_PIN8_CTL1
#define PAD_CI_CEZ_IS_GPIO      GPIO_IN       //??
#define PAD_CI_CDZ_IS_GPIO      GPIO_IN       //??

#define PAD_SAR_GPIO0_IS_GPIO   GPIO_OUT_LOW  // SAR0, Front Panel DATA
#define PAD_SAR_GPIO1_IS_GPIO   GPIO_OUT_LOW  // SAR1, Front Panel  CLK
#define PAD_SAR_GPIO2_IS_GPIO   GPIO_OUT_LOW  // SAR2, Front Panel GPIO
#define PAD_SAR_GPIO3_IS_GPIO   GPIO_IN       // SAR2, Front Panel GPIO
#define PAD_PM_GPIO2_IS_GPIO    GPIO_OUT_HIGH // VID 0
#define PAD_PM_GPIO3_IS_GPIO    GPIO_OUT_LOW  // Front Panel RED LED
#define PAD_PM_GPIO4_IS_GPIO    GPIO_OUT_HIGH // PD_CTL, High:bootup Low:standby
#define PAD_PM_GPIO6_IS_GPIO    GPIO_IN        // SYS Standby
#define PAD_PM_GPIO7_IS_GPIO    GPIO_OUT_HIGH // LNB_IRQ
...
//#define PAD_PM_GPIO15_IS_GPIO   GPIO_OUT_LOW  //EPHY LED
//#define PAD_PM_GPIO16_IS_GPIO   GPIO_OUT_LOW  //EPHY LED

//------Chip Type---------------------------------------------------------------
#include "chip/MSD7SX5.h"
