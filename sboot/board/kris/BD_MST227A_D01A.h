...
#define BOARD_NAME                  "BD_MST227A_D01A"
...
#define PAD_I2S_OUT_MCK_IS_GPIO  GPIO_IN        // USB 0 OCD
#define PAD_I2S_OUT_BCK_IS_GPIO  GPIO_OUT_HIGH  // USB1 EN
#define PAD_I2S_OUT_MUTE_IS_GPIO GPIO_OUT_HIGH  // SCART_PIN8_CTL1
#define PAD_I2S_OUT_WS_IS_GPIO   GPIO_IN        // USB 1 OCD
#define PAD_I2S_OUT_SDO_IS_GPIO  GPIO_OUT_HIGH  // USB0 EN
#define PAD_GPIO0_IS_GPIO        GPIO_OUT_HIGH  //L:4:3 ; H:16:9
#define PAD_GPIO1_IS_GPIO        GPIO_OUT_LOW   //L:CVBS ; H:RGB

#define PAD_SAR_GPIO0_IS_GPIO   GPIO_OUT_LOW    // SAR0, DISP_DATA-GPIO
#define PAD_SAR_GPIO1_IS_GPIO   GPIO_OUT_LOW    // SAR1, DISP_CLK-GPIO
#define PAD_SAR_GPIO2_IS_GPIO   GPIO_OUT_LOW    // SAR2, DISP_STB-GPIO
#define PAD_SAR_GPIO3_IS_GPIO   GPIO_IN         // SAR3, PWR CUT

#define PAD_PM_GPIO0_IS_GPIO    GPIO_OUT_LOW    // Front Panel GREEN LED
#define PAD_PM_GPIO1_IS_GPIO    GPIO_OUT_LOW    // Front Panel RED LED
#define PAD_PM_GPIO2_IS_GPIO    GPIO_OUT_HIGH   // core pwr setting
#define PAD_PM_GPIO3_IS_GPIO    GPIO_OUT_HIGH   // core pwr setting
#define PAD_PM_GPIO4_IS_GPIO    GPIO_OUT_HIGH   // PD_CTL, High:bootup Low:standby
#define PAD_PM_GPIO5_IS_GPIO    GPIO_IN         // SYS Standby

#define PAD_PM_GPIO6_IS_GPIO    GPIO_OUT_HIGH   // LNB_IRQ
#define PAD_PM_GPIO7_IS_GPIO    GPIO_OUT_HIGH   //CI_PWR_CTL
...
//ePHY use PAD_PM_GPIO12 to control LED0 but the LED is connected to PAD_PM_GPIO15 on the PCB. Do SW patch.
//#define PAD_PM_GPIO15_IS_GPIO    GPIO_OUT_LOW
//------Chip Type---------------------------------------------------------------
#include "chip/MSD7SX7.h"
