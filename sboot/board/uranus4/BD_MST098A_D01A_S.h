...
#define BOARD_NAME                  "BD_MST098A_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 PIN_162
#define PIN_SPI_CZ2                 PIN_166
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               0
#define PIN_FLASH_WP1               0

// bonding type --> which function(pad mux) in the tmux excel file
...
#define PADS_HSYNC_EN               PAD_HSYNC_OUT
#define PADS_VSYNC_EN               PAD_VSYNC_OUT
//------GPIO setting(default GPIO pin level)------------------------------------
//#define PIN_5_IS_GPIO               GPIO_OUT_HIGH
//#define PIN_6_IS_GPIO               GPIO_OUT_HIGH
//#define PIN_7_IS_GPIO               GPIO_OUT_HIGH
//#define PIN_8_IS_GPIO               GPIO_OUT_HIGH
#define PIN_101_IS_GPIO             GPIO_OUT_LOW
//efine PIN_4_IS_GPIO               GPIO_OUT_HIGH
#define PIN_102_IS_GPIO             GPIO_OUT_LOW
#define PIN_103_IS_GPIO             GPIO_OUT_LOW
#define PIN_176_IS_GPIO             GPIO_OUT_HIGH
#define PIN_131_IS_GPIO             GPIO_OUT_HIGH
#define PIN_15_IS_GPIO              GPIO_OUT_LOW
#define PIN_175_IS_GPIO             GPIO_OUT_HIGH
#define PIN_165_IS_GPIO             GPIO_OUT_HIGH
#define PIN_156_IS_GPIO             GPIO_IN
//------Chip Type---------------------------------------------------------------
#include "chip/MSD5040S.h"
...
#endif
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP   //DDR3_INTERFACE_BGA
