...
#define BD_MST098F_D01A         0x0A59
#define BD_MST098F_D01B         0x0A5A
#define BD_MST128A_D01A         0x0A5B

#ifndef MS_BOARD_TYPE_SEL
#if defined (CONFIG_MSTAR_TITANIA_BD_MST098A_D01A_S)
...
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST098F_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST098F_D01A
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST098F_D01B)
    #define MS_BOARD_TYPE_SEL       BD_MST098F_D01B
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST128A_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST128A_D01A
#else
...
#if (MS_BOARD_TYPE_SEL == BD_MST098A_D01A_S)
...
#elif (MS_BOARD_TYPE_SEL == BD_MST098F_D01A)
    #include "BD_MST098F_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST098F_D01B)
    #include "BD_MST098F_D01B.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST128A_D01A)
    #include "BD_MST128A_D01A.h"
#else
