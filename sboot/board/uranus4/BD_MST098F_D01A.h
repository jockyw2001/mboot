...
#define BOARD_NAME                  "BD_MST098F_D01A"
...
#define BALL_K21_IS_GPIO            GPIO_IN       // USB Over current
#define BALL_K20_IS_GPIO            GPIO_IN       // Keypad IN
#define BALL_J19_IS_GPIO            GPIO_IN       // Keypad IN
#define BALL_H19_IS_GPIO            GPIO_IN       // Power cut detect 1=poweron 0=poweroff
#define BALL_E20_IS_GPIO            GPIO_OUT_HIGH // USB Power enable
#define BALL_D16_IS_GPIO            GPIO_OUT_LOW  // HIGH to reset Ethernet PHY
#define BALL_N21_IS_GPIO            GPIO_OUT_LOW  // HIGH to reset Ethernet ADC
#define BALL_F15_IS_GPIO            GPIO_OUT_LOW  // LED Red
#define BALL_E14_IS_GPIO            GPIO_OUT_HIGH // LED Green
