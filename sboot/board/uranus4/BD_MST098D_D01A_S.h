...
#define BOARD_NAME                  "BD_MST098D_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_B20
#define PIN_SPI_CZ2                 BALL_D20
...
#define PADS_I2S_OUT_MODE           PAD_I2S_OUT_SD1
#define PADS_MPIF_MODE              PAD_I2S_OUT_SD1
...
#define BALL_F15_IS_GPIO            GPIO_OUT_LOW
#define BALL_F19_IS_GPIO            GPIO_OUT_LOW
#define BALL_E17_IS_GPIO            GPIO_OUT_LOW
#define BALL_D16_IS_GPIO            GPIO_OUT_LOW
#define BALL_E16_IS_GPIO            GPIO_OUT_LOW
#define BALL_E18_IS_GPIO            GPIO_OUT_LOW
#define BALL_G9_IS_GPIO             GPIO_OUT_LOW
#define BALL_F9_IS_GPIO             GPIO_OUT_LOW
#define BALL_T12_IS_GPIO            GPIO_OUT_HIGH
#define BALL_K20_IS_GPIO            GPIO_OUT_HIGH
#define BALL_G21_IS_GPIO            GPIO_OUT_HIGH
#define BALL_B6_IS_GPIO             GPIO_OUT_LOW
#define BALL_C6_IS_GPIO             GPIO_OUT_LOW
#define BALL_K21_IS_GPIO            GPIO_OUT_HIGH
#define BALL_E20_IS_GPIO            GPIO_OUT_HIGH
#define BALL_H20_IS_GPIO            GPIO_OUT_HIGH
#define BALL_J19_IS_GPIO            GPIO_IN
#define BALL_U12_IS_GPIO            GPIO_IN
#define BALL_H19_IS_GPIO            GPIO_IN
#define BALL_E13_IS_GPIO            GPIO_OUT_LOW
#define BALL_E15_IS_GPIO            GPIO_OUT_LOW

//------Chip Type---------------------------------------------------------------
#include "chip/MSD5042T.h"
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO              9 // GPIO 0 ~ 12
