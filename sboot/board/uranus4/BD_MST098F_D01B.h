...
#define BOARD_NAME                  "BD_MST098F_D01B"
...
#define PADS_NAND_MODE              Unknown_pads //PAD_S_GPIO4  //PAD_CI_A5
#define PADS_CI_MODE                Unknown_pads //PAD_CI_A14
...
#define BALL_A2_IS_GPIO             GPIO_OUT_LOW  // Audio Mute
#define BALL_D17_IS_GPIO            GPIO_IN       // USB Over current
//#define BALL_K20_IS_GPIO            GPIO_IN       // Keypad IN
#define BALL_J19_IS_GPIO            GPIO_IN       // Keypad IN
#define BALL_K20_IS_GPIO            GPIO_IN       // Power cut detect 1=poweron 0=poweroff
#define BALL_D16_IS_GPIO            GPIO_OUT_HIGH // USB Power enable
#define BALL_D18_IS_GPIO            GPIO_OUT_LOW  // HIGH to reset Ethernet PHY
#define BALL_N21_IS_GPIO            GPIO_OUT_LOW  // HIGH to reset Ethernet ADC
#define BALL_T21_IS_GPIO            GPIO_OUT_LOW  // LED Red
#define BALL_T20_IS_GPIO            GPIO_OUT_HIGH // LED Green
#define BALL_E13_IS_GPIO            GPIO_IN       // HDMI HPD
//------Chip Type---------------------------------------------------------------
