...
#define PAD_TS0_D3_IS_GPIO      GPIO_OUT_LOW  // LED_CTRL_0
#define PAD_PM_GPIO4_IS_GPIO    GPIO_OUT_HIGH // PD_CTL, High:bootup Low:standby
#define PAD_PM_GPIO11_IS_GPIO   GPIO_OUT_HIGH  // Frontend RST
#define PAD_PM_GPIO12_IS_GPIO   GPIO_OUT_HIGH  // Tuner RST
#define PAD_PM_GPIO16_IS_GPIO   GPIO_OUT_HIGH  // VID

//------Chip Type---------------------------------------------------------------
#include "chip/MSD5C29B.h"
