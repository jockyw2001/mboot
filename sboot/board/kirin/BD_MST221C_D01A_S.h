...
#define BOARD_NAME                  "BD_MST200C_D01A_S"
...
#define PAD_FUART_TX_IS_GPIO    GPIO_OUT_HIGH // USB0 EN
#define PAD_FUART_RX_IS_GPIO    GPIO_IN       // USB0 OCD
#define PAD_PM_GPIO10_IS_GPIO   GPIO_OUT_HIGH // USB1 EN
#define PAD_PM_GPIO4_IS_GPIO    GPIO_OUT_HIGH // PD_CTL, High:bootup Low:standby
#define PAD_PM_GPIO9_IS_GPIO    GPIO_OUT_HIGH  // Frontend RST
#define PAD_SAR0_IS_GPIO        GPIO_OUT_LOW // GREEN LED CTL
#define PAD_PM_GPIO13_IS_GPIO   GPIO_OUT_LOW // RED LED CTL
#define PAD_PM_GPIO14_IS_GPIO    GPIO_OUT_HIGH // Tuner RST
#define PAD_PM_GPIO6_IS_GPIO    GPIO_OUT_HIGH  // Frontend RST
