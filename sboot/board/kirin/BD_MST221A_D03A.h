...
#define BOARD_NAME                  "BD_MST221A_D03A"
...
#define PADS_TS0_MODE               PAD_TS0_D5
#define PADS_TS1_MODE               PAD_TS1_D5
...
#define PAD_I2S_OUT_MCK_IS_GPIO GPIO_OUT_HIGH // USB0 EN
#define PAD_I2S_OUT_BCK_IS_GPIO GPIO_IN       // USB0 OCD
#define PAD_GPIO0_IS_GPIO       GPIO_OUT_HIGH // USB1 EN
#define PAD_GPIO1_IS_GPIO       GPIO_IN       // USB1 OCD

#define PAD_SAR_GPIO0_IS_GPIO   GPIO_OUT_LOW  // Front Panel DATA
#define PAD_SAR_GPIO1_IS_GPIO   GPIO_OUT_LOW  // Front Panel CLK
#define PAD_SAR_GPIO2_IS_GPIO   GPIO_OUT_LOW  // Front STB-Key
#define PAD_SAR_GPIO3_IS_GPIO   GPIO_IN       // SYS_Standby

#define PAD_PM_GPIO0_IS_GPIO    GPIO_OUT_HIGH // LED_RED-EN_GPIO
#define PAD_PM_GPIO1_IS_GPIO    GPIO_OUT_HIGH // LED_GreenEN_GPIO
#define PAD_PM_GPIO2_IS_GPIO    GPIO_OUT_HIGH // VID_0
#define PAD_PM_GPIO3_IS_GPIO    GPIO_OUT_HIGH // VID_1
#define PAD_PM_GPIO4_IS_GPIO    GPIO_OUT_HIGH // PD controll.
#define PAD_PM_GPIO5_IS_GPIO    GPIO_OUT_HIGH // FE_RST
#define PAD_PM_GPIO8_IS_GPIO    GPIO_OUT_HIGH // SMC_5V_CTL
#define PAD_PM_GPIO9_IS_GPIO    GPIO_IN
#define PAD_PM_GPIO10_IS_GPIO   GPIO_IN
#define PAD_PM_GPIO12_IS_GPIO   GPIO_IN  
#define PAD_PM_GPIO13_IS_GPIO   GPIO_IN  
//------Chip Type---------------------------------------------------------------
