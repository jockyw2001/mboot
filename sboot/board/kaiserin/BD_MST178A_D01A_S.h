...
#define BOARD_NAME                  "BD_MST178A_D01A_S"
...
#define PAD_GPIO_PM2_IS_GPIO GPIO_OUT_HIGH   // LED0 control
#define PAD_GPIO_PM3_IS_GPIO GPIO_OUT_HIGH   // LED1 control
#define PAD_GPIO_PM5_IS_GPIO GPIO_OUT_HIGH   // USB2 EN
