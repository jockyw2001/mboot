...
#define PADS_SM1_EN                 PAD_SM1_CD
#define PADS_I2CM0_MODE             Unknown_pads
#define PADS_I2CM1_MODE             Unknown_pads
#define PADS_TS0_MODE               1
#define PADS_TS1_MODE               1 //Unknown_pads //PAD_TS1_D7
#define PADS_TS2_MODE               Unknown_pads
#define PADS_NAND_MODE              PAD_NF_REZ
...
#define PADS_I2S_OUT_MODE           PAD_I2S_OUT_BCK
#define PADS_MPIF_MODE              PAD_CI_D3
#define PADS_SDIO_MODE              Unknown_pads
#define PADS_ET_MODE                PAD_PF_A14
...
#if 0
#define BALL_A3_IS_GPIO     GPIO_OUT_LOW    // SM0_VCCSEL
#define BALL_A2_IS_GPIO     GPIO_OUT_HIGH   // Pin8_6V_GPIO30
#define BALL_B3_IS_GPIO     GPIO_OUT_LOW    // Pin8_0V_GPIO33
#define BALL_B1_IS_GPIO     GPIO_OUT_LOW    // FB_GPIO
#define BALL_K20_IS_GPIO    GPIO_OUT_HIGH   // FB_RST
#define BALL_H20_IS_GPIO    GPIO_IN         // USB1_PWR_OCD_PM0
#define BALL_D16_IS_GPIO    GPIO_OUT_LOW    // RST_PHY
#define BALL_E16_IS_GPIO    GPIO_IN         // TUNER_BD_MPIF_INT
#define BALL_E15_IS_GPIO    GPIO_IN         // PWR_CUT_OFF_INT
#define BALL_F15_IS_GPIO    GPIO_OUT_LOW    // LED
#define BALL_E14_IS_GPIO    GPIO_OUT_LOW    // LED
#define BALL_T12_IS_GPIO    GPIO_OUT_LOW    // USB2SATA_RST_GPIO161
#define BALL_D18_IS_GPIO    GPIO_OUT_HIGH   // USB1_PWR_EN
#define BALL_D17_IS_GPIO    GPIO_OUT_HIGH   // USB2_PWR_EN
#define BALL_D20_IS_GPIO	GPIO_OUT_HIGH   // WP #
#endif
#define PAD_SAR2_IS_GPIO    GPIO_OUT_HIGH //2nd tuner reset pin
#define PAD_SAR3_IS_GPIO    GPIO_OUT_HIGH
#define BALL_T18_IS_GPIO    GPIO_OUT_HIGH
#define PAD_GPIO_PM6_IS_GPIO       GPIO_OUT_LOW
#define PAD_GPIO_PM4_IS_GPIO       GPIO_OUT_HIGH

//------Chip Type---------------------------------------------------------------
#include "chip/MSD5C52.h"
...
#endif
#define  MIU_INTERFACE                  DDR3_INTERFACE_BGA_425_2L
