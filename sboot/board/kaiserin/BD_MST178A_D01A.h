...
#define BOARD_NAME                  "BD_MST178A_D01A"
...
// die domain
#define PAD_S_GPIO4_IS_GPIO      GPIO_OUT_HIGH   // LED0 control
#define PAD_TS2_CLK_IS_GPIO      GPIO_IN         // Tuner buffer control
#define PAD_TS2_SYNC_IS_GPIO     GPIO_IN         // USB1 PWR Int
#define PAD_TS2_VLD_IS_GPIO      GPIO_OUT_HIGH   // USB1 Enable

// nodie domain
#define PAD_SAR0_IS_GPIO         GPIO_IN         // PWR_CUT
#define PAD_SAR3_IS_GPIO         GPIO_OUT_HIGH   // SPI flash WPNZ
#define PAD_GPIO_PM0_IS_GPIO     GPIO_OUT_HIGH   // SAR_RSSI for GH Low to High
#define PAD_GPIO_PM5_IS_GPIO     GPIO_OUT_HIGH   // USB2 Enable
#define PAD_GPIO_PM9_IS_GPIO     GPIO_OUT_HIGH   // LED1 control
#define PAD_GPIO_PM10_IS_GPIO    GPIO_OUT_HIGH   // Audio Mute
...
// ----- K2G Enable Greenwich demod clock --------------------------------------
