...
#define BOARD_NAME                  "BD_MST266C_D01A_S"


//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 PAD_SPI_CZ_QFP
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PAD_SPI_WPN_QFP
...
#define DRVPAD_NAND_MODE               PADMUX_MDOE_DEFAULT
...
#endif
#define DRVPAD_SM0_EN                  PADMUX_MDOE3
...
#define DRVPAD_DISEQC_MODE             PADMUX_MDOE2
//------Patch regs ---------------------------------------------------------
#define REG_LED_HW_MODE                3
#define REG_LED_MODE                   REG_LED_HW_MODE

//------GPIO setting(default GPIO pin level)------------------------------------
#define PAD_EJ_TDO_IS_GPIO          GPIO_OUT_HIGH  // DualLED_Green Operation mode, Low: Operation mode, High: Standby mode
#define PAD_EJ_TDI_IS_GPIO          GPIO_OUT_LOW   // DualLED_Red Standby mode, High: Operation mode, Low: Standby mode
#define PAD_I2CM1_SDA_IS_GPIO       GPIO_OUT_HIGH  // LNB I2C SDA
#define PAD_I2CM1_SCL_IS_GPIO       GPIO_OUT_HIGH  // LNB I2C SCL
#define PAD_I2CM0_SCL_IS_GPIO       GPIO_OUT_HIGH  // Tuner I2C SCL
#define PAD_I2CM0_SDA_IS_GPIO       GPIO_OUT_HIGH  // Tuner I2C SDA
#define PAD_SAR_GPIO0_IS_GPIO       GPIO_IN        // System Standby Control Buttom => Low: Change mode High: Operation mode
#define PAD_SAR_GPIO1_IS_GPIO       GPIO_OUT_LOW   // Tuner reset => Low: Enable reset tuner High: Disable reset tuner
#define PAD_SAR_GPIO2_IS_GPIO       GPIO_OUT_LOW   // USB Power Enable => High: Disable USB power Low: Enable USB power
#define PAD_VPLUG_DET_IS_GPIO       GPIO_IN        // Power cut off detection => 1V: operation mode 0.8V: power cut off state
#define PAD_PM_GPIO7_IS_GPIO        GPIO_IN        // LNB DiSEQC Input
#define PAD_PM_GPIO8_IS_GPIO        GPIO_OUT_LOW   // LNB DiSEQC Output
#define PAD_PM_GPIO9_IS_GPIO        GPIO_OUT_HIGH  // RGB/CVBS  =>Low:0~0.4V:Composite   High:1~3V: RGB
#define PAD_PM_GPIO10_IS_GPIO       GPIO_OUT_HIGH  // SCART_Pin8_0V   SCART_Pin8_6V
#define PAD_PM_GPIO12_IS_GPIO       GPIO_OUT_LOW   // SCART_Pin8_0V   SCART_Pin8_6V 1,0:No signal 0,1:6V => 16:9  0,0:12V => 4:3
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO              PAD_HDMI_HPD_QFP // GPIO 0 ~ 12
