...
#define BOARD_NAME                  "BD_MST266B_D01A"
...
#define DRVPAD_I2CM1_MODE              PADMUX_MDOE_DEFAULT
...
#define PAD_T_GPIO3_IS_GPIO         GPIO_OUT_HIGH  // RGB/CVBS  =>Low:0~0.4V:Composite   High:1~3V: RGB
#define PAD_T_GPIO4_IS_GPIO         GPIO_OUT_LOW   // VCR_ABSENCE, High:SCART Output OFF, Low: SCART Output On
#define PAD_I2CM1_SDA_IS_GPIO       GPIO_OUT_LOW   // Tuner Reset => Low: Enable reset tuner  High: Disable reset tuner
...
#define PAD_SAR_GPIO1_IS_GPIO       GPIO_OUT_HIGH  // Antenna power management control => High: Enable Antenna  power  Low: Disable Antenna  power
#define PAD_SAR_GPIO2_IS_GPIO       GPIO_IN        // Antenna Over Current Protection => 3.3V: Antenna power good Under 2V: Antenna power short
...
#define PAD_PM_GPIO0_IS_GPIO        GPIO_OUT_HIGH  // System power control, High: Enable system power, Low: Disable system power


//------Chip Type---------------------------------------------------------------
#include "chip/MSA3B271.h"
