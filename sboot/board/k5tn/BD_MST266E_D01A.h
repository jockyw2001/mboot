...
#define BOARD_NAME                  "BD_MST266E_D01A"
...
#define DRVPAD_DISEQC_MODE             PADMUX_MDOE_DEFAULT
//------Patch regs ---------------------------------------------------------
#define REG_LED_HW_MODE                3
#define REG_LED_MODE                   REG_LED_HW_MODE

//------GPIO setting(default GPIO pin level)------------------------------------
#define PAD_EJ_TDO_IS_GPIO          GPIO_OUT_HIGH  // Antenna power management control => High: Enable Antenna power Low: Disable Antenna  power
#define PAD_I2CM1_SDA_IS_GPIO       GPIO_OUT_LOW   // Tuner Reset => Low: Enable reset tuner  High: Disable reset tuner
#define PAD_I2CM1_SCL_IS_GPIO       GPIO_OUT_LOW   // USB Power Enable => High: Disable USB power Low: Enable USB power
...
#define PAD_SAR_GPIO1_IS_GPIO       GPIO_IN        // USB Over Current Detect => High: Operation mode Low: USB power short
...
#define PAD_PM_GPIO9_IS_GPIO        GPIO_OUT_LOW   // DVB_RATION => High: DVB 16:9 Low: DVB 4:3
