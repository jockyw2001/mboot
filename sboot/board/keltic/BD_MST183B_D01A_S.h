...
#define BOARD_NAME                  "BD_MST183B_D01A_S"


//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_PAD_PM_SPI_CZ
...
#define BALL_PAD_GPIO5_IS_GPIO     GPIO_OUT_LOW  // GPIO5 , FE RESET , LOW2HIGH
#define BALL_PAD_PM_GPIO15_IS_GPIO GPIO_OUT_LOW // USB Power  , GPIO103, PM_GPIO15, Low Active
#define BALL_PAD_PM_GPIO18_IS_GPIO GPIO_IN      // USB OCD
#define BALL_PAD_PM_GPIO4_IS_GPIO  GPIO_OUT_HIGH // PWR CTRL 
#define BALL_PAD_SAR_GPIO0_IS_GPIO GPIO_IN // Input AC Detect 
#define BALL_PAD_SAR_GPIO1_IS_GPIO GPIO_IN // Input Power Reset SAR_GPIO1_SYS-STB_CTRL
#define PAD_GPIO_PM6_IS_GPIO GPIO_OUT_HIGH // for PM6 as GPIO Usage 
#define PAD_SM0_GPIO_IS_GPIO GPIO_OUT_LOW // 8024 3.3v
#define BALL_PAD_PM_PWM0_IS_GPIO GPIO_OUT_HIGH // for spi WP 
//------Chip Type---------------------------------------------------------------
#include "chip/MSD5XX7.h"
