...
#define BOARD_NAME                  "BD_MST183A_D01A_S"
...
#define PIN_24_IS_GPIO GPIO_OUT_HIGH  // PWR_CTRL, Output , High 
#define PIN_97_IS_GPIO GPIO_IN        // SAR_GPIO1_SYS-STB_CTRL, Input Power Reset 
#define PIN_96_IS_GPIO GPIO_IN        // CUTOFF_PWR-INT Input , AC detect
#define PIN_64_IS_GPIO GPIO_OUT_LOW   // GPIO4 , FE RESET , LOW2HIGH
#define PIN_110_IS_GPIO GPIO_IN       // USB OCD   , GPIO106 , PM_GPIO_18 Input 
#define PIN_111_IS_GPIO GPIO_OUT_LOW  // USB Power  , GPIO107 , PM_GPIO19 Low active
#define PAD_GPIO_PM6_IS_GPIO GPIO_OUT_HIGH // for PM6 as GPIO Usage 
#define PAD_SM0_GPIO_IS_GPIO GPIO_OUT_LOW // 8024 3.3v
#define PIN_75_IS_GPIO GPIO_OUT_HIGH // spi wp

//------Chip Type---------------------------------------------------------------
#if defined CONFIG_MSD5XX5
#include "chip/MSD5XX5.h"
#elif defined CONFIG_MSD5XX3
#include "chip/MSD5XX3.h"
#elif defined CONFIG_MSD5XX1
#include "chip/MSD5XX1.h"
#else
#error "No Surport CHIP"
#endif
...
#endif
#define  MIU_INTERFACE                  DDR2_INTERFACE_QFP
