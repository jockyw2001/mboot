...
#define MHal_RIU_WritReg16(u32reg, u16val ) *((volatile MS_U16*)(MS_U32)(REG_ADDR_BASE+ ((u32reg) << 1))) = (u16val)
#define MHal_RIU_WritReg8(u32reg, u16val ) *((volatile MS_U8*)(MS_U32)(REG_ADDR_BASE+ ((u32reg) << 1))) = (u16val)
...
{
    unsigned long long u64val1;
    unsigned long long u64val2;
    unsigned long long u64Interval;

    u64Interval = 12000 * msec; // clock is running @ 12MHz

    asm volatile("mrrc p15, 0, %0, %R0, c14" : "=r" (u64val1));

    while (1) {
        asm volatile("mrrc p15, 0, %0, %R0, c14" : "=r" (u64val2));
...
void __teeloader__ enable_cache(void)
{ 
...
{
    #if defined(CONFIG_MSTAR_KANO)||defined(CONFIG_MSTAR_CURRY)||defined(CONFIG_MSTAR_K6)||defined(CONFIG_MSTAR_K6LITE)||defined(CONFIG_MSTAR_K7U)
...
void LDR_Entry_SPI(void)
{
...
#if !defined(CONFIG_MSTAR_NS_UBOOT_LDR2) || !(defined(CONFIG_MSTAR_K6LITE)||defined(CONFIG_MSTAR_K7U)) || defined(CONFIG_MSTAR_NS_UBOOT_BRINGUP) || defined(CONFIG_TEE_LOADER)
    enable_cache();
#endif

    //Note: src, dst, end should be 16-byte aligned.
    src = (MS_U32*)_ld_APP_load_start;
    dst = (MS_U32*)(MS_U32)(*(src));
    end = (MS_U32*)((MS_U32)src + *(src+3));
    pfEntry = (PF_AP_Entry)((MS_U32)dst + *(src+1));

    UBOOT_ENTRY = (MS_U32)pfEntry;
    ...
    if (1)
    {
        ...
        MS_U32 u64ptr = (MS_U32)_ld_APP_load_start;
...
PF_AP_Entry BOOT_NAND_2nd(MS_U32* U64ld_APP_load_start)
{
...
void LDR_Entry_EMMC(void)
{
    ...
    pfEntry              = U64MIUPos + *(MS_U32*)(pu8_RamBuf+4) ;
    UBOOT_ENTRY          = (MS_U32)pfEntry;
...
void InitUTMIPLL (void)
{
    ...
    u8TempData = *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x210e<<1)+1));
    u8TempData &= (~0x44);
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x210e<<1)+1)) = u8TempData;
    ...
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x1021A0 << 1) + 1)) = 0x0;
    ...
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x210e<<1)+1)) = u8TempData;
    ...
    u8TempData = *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x2302<<1)+1));
    u8TempData &= (~0x44);
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x2302<<1)+1)) = u8TempData;
    ...
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x1023A0 << 1) + 1)) = 0x0;
    MHal_RIU_WritReg8(0x102212, 0xF4);

    u8TempData = *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x230e<<1)+1));
    u8TempData &= (~0x4);
    *(volatile MS_U8 *)(MS_U32)(0x1f200000 + ((0x230e<<1)+1)) = u8TempData;
...
#if defined(CONFIG_MSTAR_K6)|| defined(CONFIG_MSTAR_K6LITE)|| defined(CONFIG_MSTAR_K7U) // different project might has different fcie/sdio bank address
...
void InitSDIOGPIO(void)
{
    ...
    *(volatile MS_U16*)( 0x1F000000 + (0x111F00<<1) + (0x0C<<2) ) = 0x0000;
...
#if defined(CONFIG_MSTAR_KANO)||defined(CONFIG_MSTAR_CURRY)||defined(CONFIG_MSTAR_K6LITE)
    ...
    #define VID_CPU_SIDD_CRITERIA 143  // 35.84mA * 4
    #define VID_CPU_OSC_CRITERIA 400 // 12.5 MHz * 32
    #define VID_CORE_SIDD_CRITERIA 147 // 18.4mA * 8
...
void BOOTROM_C_InitVID(void)
{
    ...
    // iverlin_TBD: need to check later
    return;
#endif
...
#elif defined(CONFIG_MSTAR_K6LITE)
        // Because it doens't decide chip type to adjust power, so setup SS type default
        // Set CPU Power Type for SS Corner Chip
        u16temp = *(volatile MS_U16*)(0x1f000000 + (0x100500 << 1) + (0x06 << 1));
        u16temp &= ~(0x3 << 4);
        *(volatile MS_U16*)(0x1f000000 + (0x100500 << 1) + (0x06 << 1)) = u16temp;
...
{
#ifndef CONFIG_TEE_LOADER
#if defined(CONFIG_MSTAR_KANO) || defined(CONFIG_MSTAR_K6) || defined(CONFIG_MSTAR_K6LITE) ||  defined(CONFIG_MSTAR_K7U)
    // For OTP code usage, setup jump address and magic number for Core1,2,3
    MS_U32 u64SecondaryCore_Entry = (MS_U32)Bootram_SecondaryCore;
