...
#define ISP_READ(addr)                      READ_WORD(0x1f001000 + ((addr)<<2))
#define ISP_WRITE(addr, val)                WRITE_WORD(0x1f001000 + ((addr)<<2), (val))
#define ISP_WRITE_MASK(addr, val, mask)     WRITE_WORD_MASK(0x1f001000 + ((addr)<<2), (val), (mask))
