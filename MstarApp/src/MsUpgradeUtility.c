...
#if ENABLE_MODULE_USB || (ENABLE_MODULE_OAD == 1) || (ENABLE_MODULE_NETUPDATE == 1 || (CONFIG_RESCUE_ENV))
...
#if (ENABLE_MODULE_USB || CONFIG_URSA_6M40 || CONFIG_UPGRADE_URSA)
